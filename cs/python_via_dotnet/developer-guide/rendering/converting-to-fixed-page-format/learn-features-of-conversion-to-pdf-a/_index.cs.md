...
description: "Převést na PDF/A-1, PDF/A-2, PDF/A-4 a PDF/UA pomocí Python. Vyberte si nejlepší PDF standard převést dokument pomocí Python via .NET."
type: docs
weight: 25
...
V této sekci zvážíme hlavní problémy, které mohou nastat při práci s dokumenty v různých standardech PDF a popíšeme možnosti jejich řešení.
...
- PDF/A-2 eliminuje některá omezení PDF/A-1, jako je podpora efektů transparentnosti a vrstvy nebo vkládání písem OpenType
- PDF/A-4 předpokládá revidované úrovně konformance: pravidelná shoda PDF/A-4 odpovídá úrovni U předchozí verze a úroveň A se odstraní
- Obsah PDF/UA-1 by měl být označen a standardizován podle ISO 32000-1: 2008

PDF/ A ISO-standardizovaná verze PDF určená k archivaci a dlouhodobému ukládání elektronických dokumentů. Zároveň je PDF/UA další ISO standardizovaná verze PDF určená k zajištění dostupnosti pro osoby se zdravotním postižením, které používají asistenční technologii. Pro upřesnění úrovně dodržování norem PDF použijte [PdfSaveOptions.compliance](https://reference.aspose.com/words/python-net/aspose.words.saving/pdfsaveoptions/compliance/) majetek. Vzhledem k podmínkám skladování musí dokument PDF/A vložit všechna písma a zakázat šifrování, zatímco PDF/UA musí vložit pouze všechna písma.
