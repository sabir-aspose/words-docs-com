---
title: Práce s chytrými Umění Studené renderování
...
* Je-li přítomen předdenderovaný výkres, ale je chybný, je nutné provést explicitně SmartArt zobrazování za studena voláním [update_smart_art_drawing](https://reference.aspose.com/words/python-net/aspose.words.drawing/shape/update_smart_art_drawing/) metoda.
