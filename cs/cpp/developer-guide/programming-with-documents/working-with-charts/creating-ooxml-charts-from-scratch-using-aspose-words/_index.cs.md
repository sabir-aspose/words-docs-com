---
title: Vytváření OOXML grafů od nuly
second_title: Aspose.Words pro C++
articleTitle: Vytváření OOXML grafů od nuly
linktitle: Vytváření OOXML grafů od nuly
description: "Jak vytvořit různé grafy v dokumentu pomocí C++."
type: docs
weight: 10
ai_search_scope: words_cpp
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
ai_search_fast_endpoint: "https://docsearch.api.aspose.cloud/search"
url: /cs/cpp/creating-ooxml-charts-from-scratch-using-aspose-words/
timestamp: 2024-01-27-14-07-04
---

## Vytváření OOXML grafů od nuly pomocí Aspose.Words

Aspose.Words poskytuje metodu `InsertChart`, která byla přidána do třídy `DocumentBuilder`. Podívejme se tedy, jak vložit jednoduchý sloupcový graf do dokumentu pomocí metody `DocumentBuilder->InsertChart`:

### Jak vložit sloupcový graf

Příklad kódu uvedený níže ukazuje, jak vložit sloupcový graf.
...
Kód vytváří následující výsledek:
...
Příklad kódu uvedený níže ukazuje, jak vložit bodový graf.
...
### Jak vložit plošný graf

Příklad kódu uvedený níže ukazuje, jak vložit plošný graf.
...
### Jak vložit bublinový Graf

Příklad kódu uvedený níže ukazuje, jak vložit bublinový graf.
