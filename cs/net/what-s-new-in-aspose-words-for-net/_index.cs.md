...
Ukládání do formátů HTML a SVG bylo vylepšeno přidáním vlastností **IdPrefix** a **RemoveJavaScriptFromLinks** do obou [HtmlFixedSaveOptions](https://reference.aspose.com/words/net/aspose.words.saving/ htmlfixedsaveoptions/) a [SvgSaveOptions](https://reference.aspose.com/words/net/aspose.words.saving/svgsaveoptions/).
