...
Jako alternativu k předregistrování pomlček slovníků, je možné zaregistrovat pouze požadované pomlčky slovníky? podle požadavku? Aby toho bylo dosaženo, [IHyphenationCallback](https://reference.aspose.com/words/net/aspose.words/ihyphenationcallback/) rozhraní a použití statického zpětného volání [Callback](https://reference.aspose.com/words/net/aspose.words/hyphenation/callback/).
