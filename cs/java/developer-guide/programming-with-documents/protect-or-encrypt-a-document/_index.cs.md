...
|  -------------------------------  |  ------------------------------  |  ------------------------------------------------------------  |
|  Pouze pro čtení |  "Nastavení dokumentu pouze pro čtení" |  Vždy otevírat pouze pro čtení (File → Info → Protect Document)<br/>Alternativní funkce: "Heslo ke změně" (Uložit jako → Nástroje → Obecné možnosti → Heslo) |
