...
- **ResourceFolderAlias** 的優先權較低於 **FontsFolderAlias** 和 **ImagesFolderAlias**。 如果 **ResourceFolderAlias** 沒有提供，則會使用 **ResourceFolder** 屬性的值來建立資源 URI。 如果 **ResourceFolderAlias** 被設定為點 "，資源 URI 只會包含檔案名稱而不指定路徑。
