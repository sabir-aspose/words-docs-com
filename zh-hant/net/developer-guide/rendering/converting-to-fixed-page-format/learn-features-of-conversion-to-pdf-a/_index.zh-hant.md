...
* [Convert a Document to PDF](/words/zh-hant/net/convert-a-document-to-pdf/)
...
* [How to set up ActualText entry for text](https://helpx.adobe.com/acrobat/using/create-verify-pdf-accessibility.html), 為簡寫詞彙、公式或非 Unicode 符號添加實際文字節
