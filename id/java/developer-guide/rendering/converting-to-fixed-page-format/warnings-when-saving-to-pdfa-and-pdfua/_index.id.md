...
description: "PDF/A dan PDF/UA memberlakukan persyaratan aksesibilitas yang terkait dengan konten dokumen. Saat menyimpan ke PDF/A atau PDF/UA di Java dan masalah tersebut melanggar kepatuhan, peringatan akan dikeluarkan."
type: docs
weight: 29
...
Semua peringatan terdiri dari [WarningType](https://reference.aspose.com/words/java/com.aspose.words/warningtype/)**.MinorFormattingLoss** dan [WarningSource](https://reference.aspose.com/words/java/com.aspose.words/warningsource/) **.Pdf**. Berikut adalah daftar nilai peringatan Deskripsi baru:
