...
description: "Einführung in die Arbeit mit Steuerzeichen in Aspose.Words für Java."
type: docs
weight: 400
...
Die [ControlChar](https://reference.aspose.com/words/java/com.aspose.words/controlchar/) -Klasse ist ein Repository für die Konstanten, die Steuerzeichen darstellen, die häufig in Dokumenten vorkommen. Es bietet sowohl Zeichen- als auch Zeichenfolgenversionen derselben Konstanten. Beispielsweise haben Zeichenfolge [LineBreak](https://reference.aspose.com/words/java/com.aspose.words/controlchar/#LINE-BREAK) und Zeichen [LineBreakChar](https://reference.aspose.com/words/java/com.aspose.words/controlchar/#LINE-BREAK_CHAR) denselben Wert.

{{% alert color="primary" %}}

Verwenden Sie diese Klasse immer dann, wenn Sie mit Steuerzeichen umgehen möchten.
