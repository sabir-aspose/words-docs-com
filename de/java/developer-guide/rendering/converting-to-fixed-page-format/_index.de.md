...
- Ein Metadatei-Player ([MetafileRenderingOptions](https://reference.aspose.com/words/java/com.aspose.words/fixedpagesaveoptions/). Weitere Einzelheiten finden Sie in der [Umgang mit Windows Metadaten](/words/de/java/handling-windows-metafiles/) Beitrag.
