---
title: TrueType-Schriftarten auf Linux in Java installieren
second_title: Aspose.Words für Java
articleTitle: TrueType Schriftarten auf Linux installieren
linktitle: TrueType Schriftarten auf Linux installieren
description: "Aspose.Words für Java ermöglicht das Rendern eines mit Microsoft Word erstellten Dokuments auf einem Linux-Computer mit der besten Genauigkeit."
type: docs
weight: 20
...
- Verwenden Sie auf openSUSE Yast2 → Softwareverwaltung, um das *fetchmsttfonts*-Paket zu suchen und zu installieren.
...
- [Liberation Schriften](https://github.com/liberationfonts) als Alternative zu Standard- Windows -Schriftarten
