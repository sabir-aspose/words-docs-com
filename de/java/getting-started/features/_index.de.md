...
description: "Aspose.Words für Java bietet Anwendern eine Vielzahl von Funktionen, von der einfachen Konvertierung und Änderung von Dokumenten über die Erstellung strukturierter und optisch ansprechender Dokumente bis hin zur Automatisierung des Reportings."
type: docs
weight: 40
...
Die meisten Screenshots in diesem Abschnitt zeigen Dokumente, die von Aspose.Words generiert und dann zur Anzeige in Microsoft Word und anderen Anwendungen geöffnet wurden.
...
| :- | :- |
| [Java](/words/java/supported-platforms/) | Aspose.Words für Java ist verfügbar für Java 1.6, 1.7 und 1.8 und wird an jedem Ort ausgeführt, an dem Java installiert ist. |

## Dateiformate und Konvertierungen

{{% alert color="primary" %}}

Viele Kunden weltweit verlassen sich auf die umfassenden Dokumentenimport- und -exportfunktionen von Aspose.Words.

{{% /alert %}}

| Funktion | Beschreibung |
| :- | :- |
| Microsoft Word (DOC) ([beladen](/words/java/load-in-ms-word-97-2003-formats/) und [speichern](/words/java/save-in-ms-word-97-2003-formats/)) | Die schnellste und vollständigste Implementierung des DOC -Formats, die Sie finden können. |
| WordprocessingML (DOCX, XML) ([beladen](/words/java/load-in-the-open-office-xml-2007-and-2010-formats/) und [speichern](/words/java/save-in-the-open-office-xml-docx-dotx-docm-dotm-format/)) | Aspose.Words bietet umfassende Unterstützung OOXML, Flat OPC und auch Word 2003 XML. |
| Rich-Text-Format (RTF) ([beladen](/words/java/load-in-the-rich-text-format-1-9-rtf-format/) und [speichern](/words/java/save-in-the-rich-text-format-1-9-rtf-format/)) | Umfassende Unterstützung des RTF -Formats für die Interaktion mit einer Vielzahl von Anwendungen. |
| HTML, XHTML und MHTML | [Beladen](/words/java/load-in-the-html-html-xhtml-mhtml-format/) und [speichern](/words/java/save-in-the-html-html-xhtml-mhtml-format/) HTML/XHTML für noch mehr Interoperabilität. Speichern unter MHTML ist ebenfalls verfügbar. |
| OpenDocument (ODT) | Aspose.Words kann [beladen](/words/java/load-in-the-opendocument-text-odt-ott-format/) und [speichern](/words/java/save-in-the-opendocument-text-odt-ott-format/) dokumente im `OpenDocument`-Text (.odt) formatieren. |
| [Tragbares Dokumentformat von Adobe (PDF)](/words/java/save-in-the-adobe-portable-document-pdf-format/) | Konvertieren Sie jedes Dokument mit hoher Wiedergabetreue in PDF. PDF/A wird unterstützt. |
| XML Papierspezifikation (XPS) ([beladen](/words/java/load-in-ms-word-2003-formats/) und [speichern](/words/java/save-in-the-flatopc-ooxml-document-xml-format/)) | Konvertieren Sie jedes Dokument mit hoher Wiedergabetreue in XPS. |
| Klartext (TXT) ([beladen](/words/java/load-in-the-plain-text-txt-format/) und [speichern](/words/java/save-in-the-plain-text-txt-format/)) | Extrahieren Sie einfach Text, indem Sie ihn im Nur-Text-Format speichern. |
| [Digitales Publizieren (EPUB)](/words/java/save-in-the-idpf-epub-document-epub-format/) | EPUB ist ein beliebtes Format für eBooks. Sie können jedes Dokument von Aspose.Words in das IDPF EPUB-Format konvertieren. |
