...
description: "Verwenden Sie die Silbentrennung für eine kompaktere Textanordnung mit C++. Es bietet erweiterte Algorithmen für die Arbeit mit Silbentrennungswörterbüchern und verwendet OpenOffice -Wörterbücher."
type: docs
weight: 220
...
Silbentrennungswörterbücher können aus dem entnommen werden [LibreOffice Wörterbücher GitHub](https://github.com/LibreOffice/dictionaries). Beispielsweise, [de-US Silbentrennungswörterbuch](https://github.com/LibreOffice/dictionaries/blob/master/en/hyph_en_US.dic).
...
* Der Silbentrennungsalgorithmus in Aspose.Words implementiert das nicht [nicht standardmäßige Silbentrennung](https://github.com/hunspell/hyphen/blob/master/doc/tb87nemeth.pdf). Nicht standardmäßige Muster werden ignoriert.
