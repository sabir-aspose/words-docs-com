...
description: "Aspose.Words für C++ bietet schreibgeschützte, verschlüsselte Dokumente, eingeschränkte Bearbeitung und digitale Signaturen zum Schutz von Dokumenten. Aspose.Words unterstützt die meisten Wortschutzoptionen."
type: docs
weight: 50
...
| ------------------------------- | ------------------------------ | ------------------------------------------------------------ |
| Schreibgesch | "Dokument schreibgeschützt machen" | Immer schreibgeschützt öffnen (Datei → Info → Dokument schützen)<br />Alternative Funktion: "Zu änderndes Passwort" (Speichern unter → Extras → Allgemeine Optionen → Passwort) |
...
* Probieren Sie unsere [Kostenloser Online Dokumenten-Entsperrer](https://products.aspose.app/words/unlock)
