...
Sie können auch die [InsertDocument](https://reference.aspose.com/words/de/net/aspose.words/documentbuilder/insertdocument/#insertdocument/)- oder die [InsertDocumentInline](https://reference.aspose.com/words/de/net/aspose.words/documentbuilder/insertdocumentinline/)-Methode verwenden, die dem Einfügen eines Dokuments in Microsoft Word ähnelt, um ein ganzes Dokument an der aktuellen Cursorposition einzufügen, ohne dass es vorher importiert werden muss.
...
Wenn Sie einen Abschnitt oder Absatz in einen anderen einfügen oder anhängen müssen, müssen Sie im Wesentlichen die Knoten des ersten Dokumentknotenbaums mithilfe der [ImportNode](https://reference.aspose.com/words/de/net/aspose.words/nodeimporter/importnode/)-Methode in den zweiten importieren. Nach dem Import Ihrer Knoten müssen Sie die [InsertAfter](https://reference.aspose.com/words/de/net/aspose.words/compositenode/insertafter/)-/[InsertBefore](https://reference.aspose.com/words/de/net/aspose.words/compositenode/insertbefore/)-Methode verwenden, um einen neuen Knoten nach/vor dem Referenzknoten einzufügen. Dadurch können Sie den Einfügevorgang anpassen, indem Sie Knoten aus einem Dokument importieren und an bestimmten Positionen einfügen.
...
Sowohl die [InsertDocument](https://reference.aspose.com/words/de/net/aspose.words/documentbuilder/insertdocument/)- als auch die [AppendDocument](https://reference.aspose.com/words/de/net/aspose.words/document/appenddocument/)-Methode akzeptieren [ImportFormatMode](https://reference.aspose.com/words/de/net/aspose.words/importformatmode/) und [ImportFormatOptions](https://reference.aspose.com/words/de/net/aspose.words/importformatoptions/) als Eingabeparameter. Mit **ImportFormatMode** können Sie steuern, wie die Dokumentformatierung zusammengeführt wird, wenn Sie Inhalte aus einem Dokument in ein anderes importieren, indem Sie verschiedene Formatmodi wie [UseDestinationStyles](https://reference.aspose.com/words/de/net/aspose.words/importformatmode/), [KeepSourceFormatting](https://reference.aspose.com/words/de/net/aspose.words/importformatmode/) und [KeepDifferentStyles](https://reference.aspose.com/words/de/net/aspose.words/importformatmode/) auswählen. Mit der **ImportFormatOptions** können Sie verschiedene Importoptionen auswählen, z. B. [IgnoreHeaderFooter](https://reference.aspose.com/words/de/net/aspose.words/importformatoptions/ignoreheaderfooter/), [IgnoreTextBoxes](https://reference.aspose.com/words/de/net/aspose.words/importformatoptions/ignoretextboxes/), [KeepSourceNumbering](https://reference.aspose.com/words/de/net/aspose.words/importformatoptions/keepsourcenumbering/), [MergePastedLists](https://reference.aspose.com/words/de/net/aspose.words/importformatoptions/mergepastedlists/) und [SmartStyleBehavior](https://reference.aspose.com/words/de/net/aspose.words/importformatoptions/smartstylebehavior/).

Mit Aspose.Words können Sie die Visualisierung eines resultierenden Dokuments anpassen, wenn zwei Dokumente in einem Einfüge- oder Anhängevorgang zusammengefügt werden, indem Sie die [Section](https://reference.aspose.com/words/de/net/aspose.words/section/)- und [PageSetup](https://reference.aspose.com/words/de/net/aspose.words/documentbuilder/pagesetup/)-Eigenschaften verwenden. Die **PageSetup**-Eigenschaft enthält alle Attribute eines Abschnitts wie [SectionStart](https://reference.aspose.com/words/de/net/aspose.words/pagesetup/sectionstart/), [RestartPageNumbering](https://reference.aspose.com/words/de/net/aspose.words/pagesetup/restartpagenumbering/), [PageStartingNumber](https://reference.aspose.com/words/de/net/aspose.words/pagesetup/pagestartingnumber/), [Orientation](https://reference.aspose.com/words/de/net/aspose.words/pagesetup/orientation/) und andere. Der häufigste Anwendungsfall besteht darin, die **SectionStart**-Eigenschaft festzulegen, um zu definieren, ob der hinzugefügte Inhalt auf derselben Seite angezeigt oder in eine neue Seite aufgeteilt wird.
