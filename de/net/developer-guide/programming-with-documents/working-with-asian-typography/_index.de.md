...
Die Registerkarte "Asiatische Typografie" des Dialogfelds "Absatzeigenschaften" in Microsoft Word verfügt über eine Zeilenumbruchgruppe. Die Optionen dieser Gruppe können mithilfe der [FarEastLineBreakControl](https://reference.aspose.com/words/de/net/aspose.words/paragraphformat/fareastlinebreakcontrol/)-, [WordWrap](https://reference.aspose.com/words/de/net/aspose.words/paragraphformat/wordwrap/)- und [HangingPunctuation](https://reference.aspose.com/words/de/net/aspose.words/paragraphformat/hangingpunctuation/)-Eigenschaften der **ParagraphFormat**-Klasse festgelegt werden.
