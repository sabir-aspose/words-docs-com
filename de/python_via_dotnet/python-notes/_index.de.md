---
title: Unterschiede zwischen Python- und .NET-Versionen
second_title: Aspose.Words für Python via .NET
articleTitle: Unterschiede zwischen Python- und .NET-Versionen
linktitle: Unterschiede zwischen Python- und .NET-Versionen
description: "Aspose.Words für Python via .NET ist ein Wrapper von Aspose.Words für .NET. Auf dieser Seite werden die Unterschiede in den Funktionen und im API dieser beiden Produkte beschrieben."
type: docs
weight: 15
ai_search_scope: words_python
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
ai_search_fast_endpoint: "https://docsearch.api.aspose.cloud/search"
url: /de/python-net/python-notes/
...
* Eine [DocumentVisitor](https://reference.aspose.com/words/python-net/aspose.words/documentvisitor/)-Implementierung aus dem Python-Code ist derzeit nicht möglich.
...
Die Basisklasse für alle Dokumentknoten in Aspose.Words DOM ist die [Node](https://reference.aspose.com/words/python-net/aspose.words/node/)-Klasse. Beispielsweise gibt die [get_child](https://reference.aspose.com/words/python-net/aspose.words/compositenode/get_child/)-Methode eine Instanz einer [Node](https://reference.aspose.com/words/python-net/aspose.words/node/)-Klasse zurück. Wenn Sie jedoch den zurückgegebenen Knoten ändern müssen, sollten Sie ihn in den meisten Fällen in einen konkreten Typ umwandeln. Der folgende Code zeigt, wie die Schriftfarbe des ersten [Run](https://reference.aspose.com/words/python-net/aspose.words/run/) im Dokument geändert wird:
...
Bei Verwendung der [clone](https://reference.aspose.com/words/python-net/aspose.words/document/clone/)-Methode ist möglicherweise auch eine Umwandlung erforderlich:
...
Wie Ihnen vielleicht aufgefallen ist, dass Sie im C#-Code `(Paragraph)node` zum Umwandeln verwenden würden, müssen Sie in Python die `node.as_paragraph()`-Methode verwenden. In der Python-Version der Aspose.Words-[Node](https://reference.aspose.com/words/python-net/aspose.words/node/)-Klasse wird der folgende Link zu `as_xxx`-Methoden eingeführt:
...
Die `as_xxx`-Methode löst einen `RuntimeError` mit der folgenden Meldung aus, wenn der Knoten nicht in den angegebenen Typ umgewandelt werden kann:
...
Wie Sie vielleicht bemerkt haben, stellt das [Field](https://reference.aspose.com/words/python-net/aspose.words.fields/field/)-Objekt auch eine Reihe von `as_xxx`-Methoden bereit, die unten aufgeführt sind:
...
Die [FontSourceBase](https://reference.aspose.com/words/python-net/aspose.words.fonts/fontsourcebase/)-Klasse stellt eine Reihe von `as_xxx`-Methoden bereit, die unten aufgeführt sind:
...
Um näher an der Python-Welt zu sein, verwenden API-Mitglieder von Aspose.Words für Python via .NET den Python-Snake-Stil, in den meisten Fällen haben sie jedoch eins zu eins Analogon in Aspose.Words für .NET API. Diese finden Sie analog im [xml-Datei](/words/python-net/python-notes/wrapper.zip).
