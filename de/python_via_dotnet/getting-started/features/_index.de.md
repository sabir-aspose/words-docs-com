...
|  Besonderheit | Python via .NET |
|  :-  |  :-  |
| Auf Absätze und Texte zugreifen, diese erstellen und ändern. | {{< emoticons/tick >}} |
| Auf Bilder, Textfelder und Formen zugreifen, diese erstellen und ändern. | {{< emoticons/tick >}} |
| Auf Tabellen, Zeilen und Zellen zugreifen, diese erstellen und ändern. | {{< emoticons/tick >}} |
| Auf Felder, Formularfelder, Hyperlinks und Lesezeichen zugreifen, diese erstellen und ändern. | {{< emoticons/tick >}} |
| Auf Dokumentabschnitte, Kopf- und Fußzeilen zugreifen, diese erstellen und ändern. | {{< emoticons/tick >}} |
| Auf Fußnoten, Endnoten und Kommentare zugreifen, diese erstellen und ändern. | {{< emoticons/tick >}} |
| Greifen Sie auf benutzerdefiniertes XML, SmartTags und strukturierte Dokument-Tags (Inhaltssteuerelemente) zu, erstellen und ändern Sie diese. | {{< emoticons/tick >}} |
| Greifen Sie mit **XmlDocument**-ähnlichen Klassen und Methoden auf alle Dokumentelemente zu und ändern Sie sie. | {{< emoticons/tick >}} |
| Aktualisieren Sie Feldergebnisse in `IF`, Formeln und anderen gängigen Feldtypen. | {{< emoticons/tick >}} |
| Erstellen und aktualisieren Sie Inhaltsverzeichnisfelder (TOC) genau wie Microsoft Word. | {{< emoticons/tick >}} |
| Kopieren und verschieben Sie Dokumentelemente zwischen Dokumenten. | {{< emoticons/tick >}} |
| Dokumente zusammenfügen und teilen. | {{< emoticons/tick >}} |
| Rufen Sie integrierte und benutzerdefinierte Dokumenteigenschaften ab und legen Sie sie fest. | {{< emoticons/tick >}} |
| Legen Sie den Dokumentenschutz fest, öffnen Sie geschützte und verschlüsselte Dokumente. | {{< emoticons/tick >}} |
| Text suchen und ersetzen, Dokumentinhalte aufzählen. | {{< emoticons/tick >}} |
| Akzeptieren Sie alle Überarbeitungen in einem Dokument. | {{< emoticons/tick >}} |
| Behalten oder extrahieren Sie OLE-Objekte und ActiveX-Steuerelemente aus dem Dokument. | {{< emoticons/tick >}} |
| Behalten oder entfernen Sie VBA-Makros aus dem Dokument. Behalten Sie die digitale Signatur von VBA-Makros bei. | {{< emoticons/tick >}} |
| Erkennen und überprüfen Sie digitale Signaturen in Dokumenten. | {{< emoticons/tick >}} |
| Fügen Sie HTML-Text ein. | {{< emoticons/tick >}} |
| Extrahieren Sie VBA-Makros aus einem Word-Dokument. | {{< emoticons/tick >}} |
...
|  Besonderheit | Python via .NET |
|  :-  |  :-  |
| Greifen Sie auf alle Zeichenformatierungen zu und ändern Sie diese, einschließlich Schriftarten, Farben, Effekte, Rahmen und Schattierungen. | {{< emoticons/tick >}} |
| Greifen Sie auf alle Absatzformatierungen zu und ändern Sie diese, einschließlich Einzüge, Abstände, Rahmen und Schattierungen sowie Tabstopps. | {{< emoticons/tick >}} |
| Greifen Sie auf alle Formatierungen von Listen mit Aufzählungszeichen und Nummern zu, einschließlich Nummerierung und Ebenen, und ändern Sie diese. | {{< emoticons/tick >}} |
| Greifen Sie auf die Tabellenformatierung zu und ändern Sie sie, einschließlich Ausrichtung, Ausrichtung, Rahmen und Schattierung. | {{< emoticons/tick >}} |
| Greifen Sie auf alle Abschnittseigenschaften zu und ändern Sie diese, einschließlich Papiergröße, Ränder und Ausrichtung. | {{< emoticons/tick >}} |
| Auf Dokumentstile zugreifen, diese erstellen und ändern. | {{< emoticons/tick >}} |
| Greifen Sie auf Zeichnungsobjekte zu und ändern Sie diese, einschließlich Position, Größe, Linien- und Fülleigenschaften sowie Bildbytes. | {{< emoticons/tick >}} |
...
|  :-  |  :-  |
| Unterstützung von C#-Syntax und LINQ-Erweiterungsmethoden direkt in Vorlagen (auch für `ADO.NET`-Datenquellen) | {{< emoticons/tick >}} |
| Unterstützung wiederholbarer und bedingter Dokumentblöcke (Schleifen und Bedingungen) für Tabellen, Listen und allgemeine Inhalte | {{< emoticons/tick >}} |
| Unterstützung dynamisch generierter Diagramme und Bilder | {{< emoticons/tick >}} |
| Unterstützung des Einfügens äußerer Dokumente und HTML-Blöcke in ein Dokument | {{< emoticons/tick >}} |
| Unterstützung mehrerer Datenquellen (auch unterschiedlicher Art) zur Generierung eines einzelnen Dokuments | {{< emoticons/tick >}} |
| Integrierte Unterstützung von Datenbeziehungen (Master-Detail) | {{< emoticons/tick >}} |
| Umfassende Unterstützung verschiedener Datenmanipulationen wie Gruppieren, Sortieren, Filtern und mehr direkt in Vorlagen | {{< emoticons/tick >}} |
