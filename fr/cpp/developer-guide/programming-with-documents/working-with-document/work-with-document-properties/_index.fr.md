...
Il est utile de savoir que les informations sur l'API et le numéro de version sont directement écrites dans les documents de sortie. Par exemple, lors de la conversion d'un document en PDF, Aspose.Words remplit le champ "Application" avec " Aspose.Words" et le champ "PDF Producteur " avec "Aspose.Words pour C++ YY.M. N", où *YY.M.N* est la version de Aspose.Words utilisée pour la conversion. Pour plus de détails, voir [Nom du générateur ou du Producteur Inclus dans les Documents de sortie](/words/fr/cpp/generator-or-producer-name-included-in-output-documents/).
