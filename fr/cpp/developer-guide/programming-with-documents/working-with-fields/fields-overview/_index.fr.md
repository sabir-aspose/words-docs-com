...
- Le code de champ définit le comportement du champ et comprend l'identifiant du champ et souvent d'autres paramètres tels que les noms de champ et les commutateurs.
- Le résultat du champ contient l'évaluation la plus récente du champ. Cette valeur est stockée dans le résultat du champ et est ce qui est affiché à l'utilisateur. Certains champs peuvent ne pas avoir de résultats de champ et n'afficheront donc rien dans le document. De même, certains champs peuvent ne pas être mis à jour mais n'auront donc également aucun résultat de champ.
...
Aspose.Words suit la façon dont Microsoft Word traite les champs et, par conséquent, il les gère correctement:
...
Lorsque Aspose.Words calcule un résultat de champ, il doit souvent analyser une chaîne en un nombre ou une valeur de date et également la reformater en un string.By la valeur par défaut Aspose.Words utilise la culture de thread actuelle pour effectuer l'analyse et la mise en forme lors du calcul des valeurs de champ pendant la mise à jour du champ et mail merge. Il existe également des options fournies sous la forme de la classe [FieldOptions](https://reference.aspose.com/words/cpp/class/aspose.words.fields.field_options/) qui permet un contrôle supplémentaire sur la culture utilisée lors de la mise à jour des champs.

- par défaut, la propriété [FieldUpdateCultureSource](https://reference.aspose.com/words/cpp/aspose.words.fields/fieldoptions/get_fieldupdateculturesource/) est définie sur [CurrentThread](https://reference.aspose.com/words/cpp/aspose.words.fields/fieldupdateculturesource/) qui formate les champs en utilisant la culture de thread actuelle
- cette propriété peut être définie sur [FieldCode](https://reference.aspose.com/words/cpp/aspose.words.fields/fieldupdateculturesource/) afin que la langue définie à partir du code de champ du champ soit utilisée à la place pour le formatage
