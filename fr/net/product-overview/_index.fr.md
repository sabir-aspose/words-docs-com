...
description: "Aspose.Words pour .NET est une bibliothèque logicielle conçue pour créer, modifier, convertir, restituer et imprimer des documents sans recourir à aucun autre logiciel."
type: docs
weight: 15
...
À l'aide de Aspose.Words, vous pouvez convertir un document de n'importe quel format de chargement pris en charge vers n'importe quel format d'enregistrement pris en charge, par exemple les formats Word au format PDF, HTML ou Markdown, PDF au format DOCX, etc. En savoir plus sur la conversion de documents dans la section [Convertir un document](/words/fr/net/convert-a-document/).
...
L'accès programmatique via un API riche à tous les éléments et formatages du document permet de créer, modifier, extraire, copier, diviser, joindre et remplacer le contenu du document. Apprenez-en davantage dans la section [Aspose.Words Document Object Model (DOM)](/words/fr/net/aspose-words-document-object-model/).
...
Veuillez visiter la page [Licence et abonnement](/words/fr/net/licensing/) pour plus d'informations sur les licences et consulter la page [Information sur les prix](https://purchase.aspose.com/pricing/words/family/) pour plus de détails sur les prix.
