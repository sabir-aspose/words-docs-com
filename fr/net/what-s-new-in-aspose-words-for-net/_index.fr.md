...
## Aspose.Words pour .NET 25.5, 25.6
...
La possibilité de contrôler la façon dont les paragraphes vides sont exportés vers Markdown a été introduite en ajoutant l'énumération [MarkdownEmptyParagraphExportMode](https://reference.aspose.com/words/net/aspose.words.saving/markdownemptyparagraphexportmode/) et la propriété [EmptyParagraphExportMode](https://reference.aspose.com/words/net/aspose.words.saving/markdownsaveoptions/emptyparagraphexportmode/).

#### Exporter des documents de plusieurs pages vers des formats d'image Raster <sup>25.6</sup>

La possibilité d'exporter des documents de plusieurs pages vers des formats d'image raster (tels que PNG et JPEG) avec [customizable layouts](https://reference.aspose.com/words/net/aspose.words.saving/multipagelayout/)-Horizontal, Vertical ou Grille – a été introduite en étendant la fonctionnalité d'exportation d'images.

### Rendu

#### Définition du style de graphique <sup>25.5</sup>

La possibilité de définir le style du graphique a été introduite en ajoutant l'énumération [ChartStyle](https://reference.aspose.com/words/net/aspose.words.drawing.charts/chartstyle/) et la propriété [Style](https://reference.aspose.com/words/net/aspose.words.drawing.charts/chart/style/).
...
Le rendu des légendes pour ["Waterfall" charts](https://reference.aspose.com/words/net/aspose.words.drawing.charts/chartseriestype/) a été introduit, augmentant la transparence des données et améliorant l'interprétabilité de ces graphiques.
...
En savoir plus sur [Aspose.Words pour .NET 25.5 Notes de version](https://releases.aspose.com/words/net/release-notes/2025/aspose-words-for-net-25-5-release-notes/).

En savoir plus sur [Aspose.Words pour .NET 25.6 Notes de version](https://releases.aspose.com/words/net/release-notes/2025/aspose-words-for-net-25-6-release-notes/).
