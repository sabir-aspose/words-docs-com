...
- L'article [Conversion vers un format de page fixe](/words/fr/net/converting-to-fixed-page-format/#what-is-a-page-layout) pour plus d'informations sur la mise en page
