...
- L'article [Conversion au format de page fixe](/words/net/converting-to-fixed-page-format/#what-is-a-page-layout) pour plus d'informations sur la mise en page
