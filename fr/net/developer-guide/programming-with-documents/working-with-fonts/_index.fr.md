...
Le formatage actuel de la police est représenté par l'objet **Font** renvoyé par la propriété [Font](https://reference.aspose.com/words/fr/net/aspose.words/documentbuilder/font/). La classe **Font** contient une grande variété de propriétés de police, reproduisant celles disponibles en Microsoft Word.
...
Certaines langues d'Asie de l'Est utilisent une marque d'accentuation spéciale pour indiquer une emphase. La classe **Font** fournit la propriété [EmphasisMark](https://reference.aspose.com/words/fr/net/aspose.words/font/emphasismark/) pour obtenir ou définir les valeurs d'énumération [EmphasisMark](https://reference.aspose.com/words/fr/net/aspose.words/emphasismark/) à appliquer lors du formatage.
