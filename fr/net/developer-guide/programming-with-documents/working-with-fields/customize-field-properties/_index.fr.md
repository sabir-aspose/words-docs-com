...
L'exemple de code suivant montre l'utilisation de la propriété [DisplayResult](https://reference.aspose.com/words/fr/net/aspose.words.fields/field/displayresult/):
