...
Si vous souhaitez insérer une note de bas de page ou de fin dans un document Word, veuillez utiliser la méthode [InsertFootnote](https://reference.aspose.com/words/fr/net/aspose.words/documentbuilder/insertfootnote/). Cette méthode insère une note de bas de page ou une note de fin dans le document.

Les classes [EndnoteOptions](https://reference.aspose.com/words/fr/net/aspose.words.notes/endnoteoptions/) et [FootnoteOptions](https://reference.aspose.com/words/fr/net/aspose.words.notes/footnoteoptions/) représentent les options de numérotation pour les notes de bas de page et de fin.
...
Vous pouvez définir le nombre de colonnes de disposition des notes de bas de page à l'aide de la propriété [Columns](https://reference.aspose.com/words/fr/net/aspose.words.notes/footnoteoptions/columns/). Si cette propriété a la valeur 0, la zone de notes de bas de page est formatée avec un nombre de colonnes basé sur le nombre de colonnes sur la page affichée.
