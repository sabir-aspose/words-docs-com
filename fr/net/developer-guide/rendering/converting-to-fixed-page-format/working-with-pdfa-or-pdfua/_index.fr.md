...
description: "Convertissez en PDF/A-1, PDF/A-2, PDF/A-4 et PDF/UA à l'aide de C#. Il existe quelques problèmes lors de la conversion en documents PDF/A, et Aspose.Words pour .NET les résout."
type: docs
weight: 28
...
<details>
    ...
    <img src="/words/net/working-with-pdfa-or-pdfua/m-w-heading1-2.png" alt="MWTitre1-2" style="width:800px"/>
    ...
    <img src="/words/net/working-with-pdfa-or-pdfua/acrobat-tags-pane.png" alt="Volet Balises Acrobate" style="width:800px"/>
</details>
{{% /alert %}}
...
<details>
    ...
    <img src="/words/net/working-with-pdfa-or-pdfua/m-w-decorative-shape.png" alt="MWDécoratifForme" style="width:800px"/>
    <p>Vous pouvez marquer la forme comme artefact dans le PDF de sortie:</p>
   <img src="/words/net/working-with-pdfa-or-pdfua/acrobat-mark-as-artifact-delete-empty-tag.png" alt="PdfSupprimerEmptyTag" style="width:800px"/>
...
<details>
    ...
    <img src="/words/net/working-with-pdfa-or-pdfua/m-w-language.png" alt="MWLangage" style="width:800px"/>
    <p>Ou le document PDF de sortie:</p>
    <img src="/words/net/working-with-pdfa-or-pdfua/acrobat-check-change-language.png" alt="AcrobatCheckChangeLangue" style="width:800px"/>
</details>
{{% /alert %}}
...
<details>
    <summary>La spécification nous indique ce qui suit (développez pour voir les détails):</summary>
    <p></p>
    <p>Une légende accompagnant une figure doit être étiquetée avec une balise Légende.</p>
    <p>ISO-14289-1, 7.3</p>
</details>
{{% /alert %}}
...
<details>
    ...
    <img src="/words/net/working-with-pdfa-or-pdfua/figure-caption-mw.png" alt="figure-légende-mw" style="width:800px"/>
    <p>Dans Acrobat, la légende peut être ajoutée ou modifiée via la boîte de dialogue Propriétés `Object`:</p>
    <img src="/words/net/working-with-pdfa-or-pdfua/figure-caption-acrobat.png" alt="figure-légende-acrobat" style="width:800px"/>
</details>
{{% /alert %}}
...
<img src="/words/net/working-with-pdfa-or-pdfua/alternate-descriptions-hyperlinks-mw.png" alt="descriptions alternatives-hyperliens-mw" style="width:800px"/>
...
Suivez l'exemple de code pour mettre à jour les champs `TOC` à l'aide du Aspose.Words Document Object Model (DOM):
...
<details>
    ...
    <p></p>
    <p>L'en-tête du tableau peut être configuré soit à partir du document source Microsoft Word:</p>
    <img src="/words/net/working-with-pdfa-or-pdfua/table-headers-mw.png" alt="table-en-têtes-mw" style="width:800px"/>
    <p>Ou le PDF de sortie:</p>
    <img src="/words/net/working-with-pdfa-or-pdfua/table-headers-acrobat-header-cell.png" alt="table-en-têtes-acrobat-header-cell" style="width:800px"/>
    <p></p>
    <img src="/words/net/working-with-pdfa-or-pdfua/table-headers-acrobat-scope1.png" alt="table-en-têtes-acrobat-scope1" style="width:800px"/>
    <p></p>
    <img src="/words/net/working-with-pdfa-or-pdfua/table-headers-acrobat-scope2.png" alt="table-en-têtes-acrobat-scope2" style="width:800px"/>
</details>
{{% /alert %}}
...
|  PDF/A-2a |                                                                |
|  PDF/A-4 |                                                                |
|  PDF/UA-1 |  {{< emoticons/tick >}}<br /> Le document au format PDF/UA-1 doit avoir un titre |
...
<details>
    ...
    <p></p>
    <p>La spécification nous dit ce qui suit:</p>
    <p>Le flux de métadonnées dans le dictionnaire du catalogue du document doit contenir une entrée dc:title, où dc est le préfixe recommandé pour le schéma de métadonnées Dublin Core…</p>
    <p>ISO-14289-1, 7.1</p>
</details>
{{% /alert %}}
...
<details>
    ...
    <p></p>
    <p>Le titre du document peut être défini soit sur le document source Microsoft Word:</p>
    <img src="/words/net/working-with-pdfa-or-pdfua/document-title-mw.png" alt="titre-du-document-mw" style="width:800px"/>
    <p>Ou le PDF de sortie:</p>
    <img src="/words/net/working-with-pdfa-or-pdfua/document-title-acrobat.png" alt="titre-du-document-acrobat" style="width:800px"/>
</details>
{{% /alert %}}
...
<details>
    ...
    <img src="/words/net/working-with-pdfa-or-pdfua/m-w-insert-symbol.png" alt="MWInsérerSymbol" style="width:800px"/>
