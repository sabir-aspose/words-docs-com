...
description: "Convertir en PDF/A-1, PDF/A-2, PDF/A-4 et PDF/UA en utilisant Java. Il y a quelques problèmes lors de la conversion en documents PDF/A, et Aspose.Words pour Java les résout."
type: docs
weight: 28
...
Veuillez noter que la sortie PDF/UA-1 sera également WCAG 2.0 et conforme à la section 508.
...
<details>
    ...
    <p></p>
    <p>Si la sémantique du document exige une séquence décroissante d'en-têtes, cette séquence doit se dérouler dans un ordre numérique strict et ne doit pas ignorer un niveau d'en-tête intermédiaire. H1 H2 H3 est autorisé, tandis que H1 H3 ne l'est pas.</p>
...
<details>
    ...
    <p></p>
    <p>Dans Microsoft Word par défaut, les styles "En-tête X" peuvent être utilisés pour définir le niveau de contour:</p>
...
<details>
    ...
    <p></p>
    <p>Dans Microsoft Word, la légende pourrait être insérée via le menu contextuel:</p>
...
<details>
    ...
    <p>NOTE Descriptions alternatives fournissent des descriptions textuelles qui aident à interpréter correctement un contenu non textuel autrement opaque.</p>
...
<details>
    ...
    <p></p>
    <p>L'en-tête du tableau peut être configuré soit le document source Microsoft Word:</p>
