...
- Un lecteur de métafichier ([MetafileRenderingOptions](https://reference.aspose.com/words/java/com.aspose.words/fixedpagesaveoptions/). Pour plus de détails, voir le [Gestion des métaphichiers Windows](/words/fr/java/handling-windows-metafiles/) l'article.
