---
title: Utilisation de la césure dans Java
second_title: Aspose.Words pour Java
articleTitle: Travailler avec la césure
linktitle: Travailler avec la césure
description: "Utilisez la césure pour un arrangement plus compact du texte. Il fournit des algorithmes avancés pour travailler avec des dictionnaires de césure, utilise OpenOffice dictionnaires utilisant Java."
type: docs
weight: 220
...
Pour la vérification orthographique, OpenOffice utilise le [Hunspell bibliothèque](https://hunspell.github.io/), qui est une généralisation de l'algorithme de césure de TeX. Cet algorithme permet une césure automatique non standard à l'aide de modèles de césure standard et personnalisés concurrents. Hunspell utilise le [Trait d'Union](https://github.com/hunspell/hyphen) pour la césure.

{{% alert color="primary" %}}

Les dictionnaires de césure peuvent être tirés de la [LibreOffice dictionnaires GitHub](https://github.com/LibreOffice/dictionaries). Par exemple, [fr - US dictionnaire de césure](https://github.com/LibreOffice/dictionaries/blob/master/en/hyph_en_US.dic).

{{% /alert %}}

{{% alert color="primary" %}}

Comme Microsoft Word utilise des dictionnaires autres que OpenOffice dictionnaires pour effectuer la césure, la césure de certains mots définis par OpenOffice dictionnaires peut différer de la césure Microsoft Word. Pour cette raison, nous devons parfois conseiller aux clients d'ajouter les modèles nécessaires à leurs dictionnaires afin de corriger la césure de mots particuliers.
...
* Paramètres de distance de césure (LEFTHYPHENMIN, RIGHTHYPHENMIN, COMPOUNDLEFTHYPHENMIN, COMPOUNDRIGHTHYPHENMIN) spécifiés dans le dictionnaire de césure sont ignorés. Aspose.Words utilise son propre ensemble de paramètres de distance en fonction du mode de compatibilité du document.
