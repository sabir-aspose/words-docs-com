---
title: Utilisation des champs dans Java
second_title: Aspose.Words pour Java
articleTitle: Travailler avec des Champs
linktitle: Travailler avec des Champs
description: "Introduction à la fonctionnalité de champ dans Aspose.Words pour Java."
type: docs
weight: 370
...
Dans Aspose.Words, les champs sont représentés par différentes classes, dont la plupart des noms commencent par "Champ". Les articles de cette section de documentation expliquent comment utiliser les classes Aspose.Words pour manipuler des champs de document par programmation.
