---
title: Restreindre la modification des documents dans Java
second_title: Aspose.Words pour Java
articleTitle: Restreindre la Modification des Documents
linktitle: Restreindre la Modification des Documents
description: "Limitez la modification d'un document en définissant un type de restriction. Vous pouvez également supprimer la protection et rendre les régions modifiables sans restriction à l'aide de Java."
type: docs
weight: 30
...
Aspose.Words vous permet de contrôler la manière dont vous restreignez le contenu à l'aide du paramètre d'énumération [ProtectionType](https://reference.aspose.com/words/java/com.aspose.words/protectiontype/). Cela vous permettra de sélectionner un type exact de protection tel que le suivant:
...
Aspose.Words vous permet de protéger vos documents des modifications à l'aide de la méthode [Protect](https://reference.aspose.com/words/java/com.aspose.words/document/#protect-int). Cette méthode n'est pas une fonctionnalité de sécurité et ne chiffre pas un document.
