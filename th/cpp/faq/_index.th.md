...
linktitle: FAQ
type: docs
description: "Aspose.WordsสำหรับC++ ตอบคำถามที่พบบ่อยที่สุด เรียนรู้หน้านี้เพื่อแก้ปัญหาของคุณได้อย่างรวดเร็วในคำถามทั่วไปหรือหัวข้อเฉพาะ."
weight: 75
url: /th/cpp/faq/
...
หากคุณยังไม่พบคำตอบสำหรับคำถามของคุณคุณสามารถถามในฟอรั่มการสนับสนุน สำหรับข้อมูลเกี่ยวกับวิธีการรายงานคำถามหรือปัญหาของคุณอย่างถูกต้องโปรดดูที่ [การสนับสนุนด้านเทคนิค](/words/th/cpp/technical-support/) เพจ.
...
Aspose.WordsสำหรับC++ ไม่จำเป็นต้องติดตั้งโปรแกรมของบุคคลที่สามหรือแพคเกจซอฟต์แวร์เพิ่มเติมในการทำงา เพียงแค่ดาวน์โหลดและติดตั้งAspose.Wordsตามที่อธิบายไว้ใน ["การติดตั้ง"](/words/th/cpp/installation/) บทความและเริ่มต้น.
...
สำหรับรายละเอียดโปรดดูที่ [ภาพรวมผลิตภัณฑ์](/words/th/cpp/product-overview/) เพจ.
...
คุณสามารถดูรายการที่สมบูรณ์ของรูปแบบที่สนับสนุนใน [รูปแบบเอกสารที่รองรับ](/words/th/cpp/supported-document-formats/) เพจ.
...
ดู [การออกใบอนุญาตและการสมัครสมาชิก](/words/th/cpp/licensing/) หน้าสำหรับข้อมูลเพิ่มเติม.
...
หลังจากซื้อขอใบอนุญาตตามที่อธิบายไว้ใน [ซื้อใบอนุญาต](/words/cpp/licensing/#purchased-license) มาตรา.

รายละเอียดเกี่ยวกับวิธีการติดตั้งAspose.Wordsสามารถอ่านได้บน [การติดตั้ง](/words/th/cpp/installation/) เพจ.

------

**ถาม:ฉันจะได้รับการสนับสนุนได้อย่างไร?**

ใช้ฟอรั่มการสนับสนุนทางเทคนิคฟรี สำหรับรายละเอียดเกี่ยวกับวิธีการรายงานปัญหาอย่างถูกต้องและสิ่งที่ต้องทำก่อนที่จะติดต่ [การสนับสนุนด้านเทคนิค](/words/th/cpp/technical-support/) เพจ.

## การแสดงผลเอกสาร

{{% alert color="primary" %}}

คุณสามารถค้นหาข้อมูลรายละเอียดเพิ่มเติมเกี่ยวกับการแสดงผลใน [การแสดงผล](/words/th/cpp/rendering/) ส่วนเอกสาร.

{{% /alert %}}

**ถาม:ทำไมเค้าโครงและแบบอักษรในเอกสารที่ส่งออกแตกต่างจากต้นฉบับ?**

แบบอักษรอาจไม่พร้อมใช้งานหรือสนับสนุนรูปแบบแบบอักษรโดยMicrosoft Wordแต่ไม่สนับสนุนโดยAspose.Words Aspose.Wordsจะดำเนินการ [การแทนที่แบบอักษร](/words/th/cpp/manipulate-and-substitute-truetype-fonts/).

เมื่อต้องการตรวจสอบว่าแบบอักษรหายไปหรือไม่:

- ในAspose.Wordsใช้คำเตือนการแทนที่แบบอักษร(สำหรับรายละเอียดให้ดูที่ส่วน"วิธีการรับรู้ว่าแบบอักษรถูกแทนที่"ของ [จัดการและแทนTrueTypeแบบอักษร](/words/th/cpp/manipulate-and-substitute-truetype-fonts/) ม).
...
บางแบบอักษรสคริปต์ที่ซับซ้อนต้องใช้คุณลักษณะการพิมพ์ขั้นสูงที่จะประมวลผลเพื่อที่จะแสด พิมพ์ขั้นสูงถูกปิดใช้งานในAspose.Wordsโดยค่าเริ่มต้น ผู้ใช้ต้องเปิดใช้งานการพิมพ์ขั้นสูงด้วย[TextShaperFactory](https://reference.aspose.com/words/cpp/aspose.words.layout/layoutoptions/get_textshaperfactory/).
...
คุณสามารถค้นหาข้อมูลรายละเอียดเพิ่มเติมเกี่ยวกับการเขียนโปรแกรมกับเอกสารใน [การเขียนโปรแกรมด้วยเอกสาร](/words/th/cpp/programming-with-documents/) ส่วนเอกสาร.

{{% /alert %}}

**ถาม:ทำไมเนื้อหาต่อท้ายกับเอกสารไม่ปรากฏในหน้าเดียวกัน?**

ผลลัพธ์ภาคผนวกจะปรากฏบนหน้าแยกต่างหากเนื่องจากความแตกต่างในการตั้งค่า[PageSetup](https://reference.aspose.com/words/cpp/aspose.words/pagesetup/)สำหรับ ทำการตั้งค่า**PageSetup**เหมือนกันสำหรับส่วนที่เอกสารถูกผนวกเข้าด้วยกัน.

## แปลงเอกสาร

{{% alert color="primary" %}}

คุณสามารถค้นหาข้อมูลรายละเอียดเพิ่มเติมเกี่ยวกับการแปลงเอกสารใน [แปลงเอกสาร](/words/th/cpp/convert-a-document/) ส่วนเอกสาร.
