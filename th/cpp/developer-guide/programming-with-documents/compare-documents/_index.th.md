...
โปรดทราบว่าคุณสามารถเปรียบเทียบใดๆสองเอกสารภายใน [รูปแบบไฟล์ที่รองรับ](/words/th/cpp/supported-document-formats/). คุณสามารถเปรียบเทียบวัตถุเอกสารและแม้กระทั่งคุณสามารถสร้างวัตถุเหล่านั้นจากรอย.
