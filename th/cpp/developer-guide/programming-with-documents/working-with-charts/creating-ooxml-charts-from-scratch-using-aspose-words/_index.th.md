...
linktitle: การสร้างแผนภูมิOOXMLจากรอยขีดข่วน
...
Aspose.Wordsมีวิธีการ`InsertChart`ซึ่งถูกเพิ่มเข้าไปในชั้นเรียน`DocumentBuilder` ดังนั้น,เรามาดูวิธีการแทรกแผนภูมิคอลัมน์ง่ายๆลงในเอกสารโดยใช้วิธีการ`DocumentBuilder->InsertChart`:

### วิธีการแทรกแผนภูมิคอลัมน์

ตัวอย่างรหัสที่ระบุด้านล่างแสดงวิธีการแทรกแผนภูมิคอลัมน์.
...
### วิธีการInsertScatterChart

ตัวอย่างรหัสที่ระบุด้านล่างแสดงวิธีการแทรกแผนภูมิกระจาย.
...
### วิธีการแทรกแผนภูมิพื้นที่

ตัวอย่างรหัสที่ระบุด้านล่างแสดงวิธีการแทรกแผนภูมิพื้นที่.
...
### วิธีการแทรกแผนภูมิฟอง

ตัวอย่างโค้ดที่ระบุไว้ด้านล่างแสดงวิธีการแทรกแผนภูมิฟอง.
