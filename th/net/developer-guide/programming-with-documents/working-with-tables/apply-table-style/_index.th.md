---
title: เปลี่ยนสไตล์ตารางในเอกสาร Word
second_title: Aspose.Words สำหรับ .NET
articleTitle: ใช้สไตล์ตาราง
linktitle: ใช้สไตล์ตาราง
description: "การจัดรูปแบบตารางขั้นสูง C# สร้างสไตล์ตารางโดยใช้ C# ใช้รูปแบบตาราง C#"
type: docs
weight: 80
ai_search_scope: words_net
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
ai_search_fast_endpoint: "https://docsearch.api.aspose.cloud/search"
url: /th/net/working-with-tablestyle/
...
ผู้ใช้สามารถสร้างสไตล์ใหม่และเพิ่มลงในคอลเลกชันสไตล์ได้ วิธีการ [Add](https://reference.aspose.com/words/net/aspose.words/stylecollection/add/) ใช้เพื่อสร้างสไตล์ตารางใหม่
...
Aspose.Words ยังมีวิธี [ExpandTableStylesToDirectFormatting](https://reference.aspose.com/words/net/aspose.words/document/expandtablestylestodirectformatting/) เพื่อใช้การจัดรูปแบบที่พบในลักษณะตาราง และขยายไปยังแถวและเซลล์ของตารางเป็นการจัดรูปแบบโดยตรง ลองรวมการจัดรูปแบบเข้ากับสไตล์ตารางและสไตล์เซลล์
