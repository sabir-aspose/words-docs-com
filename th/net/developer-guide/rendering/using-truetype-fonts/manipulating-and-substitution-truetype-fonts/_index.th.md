---
title: จัดการและแทนที่แบบอักษร TrueType ใน C#
...
กลไกการจัดการแบบอักษรที่มีอยู่ทั้งหมดมีอยู่ในคลาส [FontSettings](https://reference.aspose.com/words/net/aspose.words.fonts/fontsettings/) คลาสนี้มีหน้าที่รับผิดชอบในการดึงฟอนต์ภายในแหล่งฟอนต์ที่กำหนด รวมถึงกระบวนการแทนที่ฟอนต์ ดังที่อธิบายไว้ด้านล่าง
...
**FontSettings** แบบกำหนดเองมีลำดับความสำคัญสูงกว่าอินสแตนซ์เริ่มต้น
...
1. หาก Aspose.Words ไม่สามารถค้นหาแบบอักษรที่ต้องการซึ่งมีชื่อตรงกันทุกประการ และคุณสมบัติ [AltName](https://reference.aspose.com/words/net/aspose.words.fonts/fontinfo/altname/) ที่กำหนดไว้สำหรับแบบอักษรนี้ Aspose.Words จะค้นหาแบบอักษรที่กำหนดด้วย **AltName** จากคลาส [FontInfo](https://reference.aspose.com/words/net/aspose.words.fonts/fontinfo/) ซึ่งระบุข้อมูลแบบอักษร
1. หาก Aspose.Words ไม่สามารถระบุตำแหน่งแบบอักษรที่กำหนดไว้ได้ และไม่ได้กำหนด **AltName** ไว้ด้วย กฎการแทนที่แบบอักษรจะถูกใช้ทีละรายการ ดังที่อธิบายไว้ด้านล่าง (เมื่อพบการแทนที่ที่เหมาะสม กระบวนการทดแทนแบบอักษรจะหยุดลงและ ขั้นตอนต่อไปจะไม่ถูกดำเนินการ):
   ...
   1. ขั้นตอนต่อไปใช้กลไกที่เรียบง่ายแต่ทรงพลังที่เรียกว่ากฎการทดแทน **Table** ตามค่าเริ่มต้น คุณลักษณะนี้จะเปิดใช้งานและพร้อมใช้งานสำหรับระบบปฏิบัติการที่กำหนด Aspose.Words จะแทนที่แบบอักษรด้วยกฎนี้หากไม่ได้แทนที่ด้วยกฎการแทนที่ `FontConfig`<br>
      ...
      **.NET**<br>
      ...
      {{< /highlight >}}
   1. กฎการทดแทน **FontInfo** จะถูกนำมาใช้หากกฎการทดแทนตารางไม่พบแบบอักษร กลไกนี้เปิดใช้งานตามค่าเริ่มต้น Aspose.Words ค้นหาแบบอักษรที่เหมาะสมที่สุดตามข้อมูลแบบอักษรที่มีอยู่ในเอกสารเฉพาะ ข้อมูลนี้สามารถรับได้จากคลาส **FontInfo** ดังที่แสดงด้านล่าง:<br>
      **.NET**<br>
      {{< highlight csharp >}}
      ...
      **.NET**<br>
      ...
      {{< /highlight >}}
      หากไม่มี **FontInfo** สำหรับแบบอักษรที่หายไป กระบวนการจะหยุดลง<br>
   1. กฎการทดแทน **DefaultFont** จะถูกนำมาใช้ในกรณีที่การทดแทน `FontInfo` ล้มเหลวเช่นกัน กฎนี้ยังเปิดใช้งานตามค่าเริ่มต้นด้วย ตามกฎนี้ Aspose.Words จะพยายามใช้แบบอักษรเริ่มต้นที่ระบุในคุณสมบัติ [DefaultFontName](https://reference.aspose.com/words/net/aspose.words.fonts/defaultfontsubstitutionrule/defaultfontname/) หากผู้ใช้ไม่ได้เลือกแบบอักษรเริ่มต้นของตนเอง ระบบจะใช้ "Times New Roman" เป็นแบบอักษรเริ่มต้น กฎนี้สามารถปิดใช้งานได้ดังที่แสดงด้านล่าง:<br>
      **.NET**<br>
      {{< highlight csharp >}}
...
1. สุดท้ายนี้ หาก Aspose.Words ไม่พบแบบอักษรใดๆ จากแหล่งแบบอักษรที่มีอยู่ ระบบจะแสดงผลเอกสารโดยใช้แบบอักษร Fanwood ฟรีที่ฝังอยู่ในชุดประกอบ Aspose.Words<br>
...
## จะรับรู้ว่าแบบอักษรถูกแทนที่ได้อย่างไร

บางครั้งอาจไม่ชัดเจนว่าเหตุใดเค้าโครงเอกสารจึงเปลี่ยนไป หรือเหตุใดแบบอักษรบางตัวจึงไม่ดูตามที่คาดไว้ ในกรณีเช่นนี้ ข้อความเตือนการแทนที่แบบอักษรที่อินเทอร์เฟซ [IWarningCallback](https://reference.aspose.com/words/net/aspose.words/iwarningcallback/) นำมาใช้จะช่วยได้ มีประเภทคำเตือน [FontSubstitution](https://reference.aspose.com/words/net/aspose.words/warningtype/) และรูปแบบข้อความคำอธิบายมาตรฐาน "Font '<OriginalFont> ' ไม่พบ. โดยใช้ '<SubstitutionFont> ' แทน เหตุผล:<Reason> " ด้วยเหตุผลดังต่อไปนี้

- "ชื่อทางเลือกจากเอกสาร" – สำหรับการทดแทนด้วย [AltName](https://reference.aspose.com/words/net/aspose.words.fonts/fontinfo/properties/altname)
- "การทดแทนแบบอักษร" - สำหรับการทดแทนตามกฎการกำหนดค่าแบบอักษร
- "การทดแทนตาราง" – สำหรับการทดแทนตามกฎของตาราง
- "การทดแทนข้อมูลแบบอักษร" - สำหรับการทดแทนตามกฎข้อมูลแบบอักษร
- "การทดแทนแบบอักษรเริ่มต้น" - สำหรับการทดแทนตามกฎแบบอักษรเริ่มต้น
- "แบบอักษรแรกที่มี" – สำหรับการทดแทนด้วยแบบอักษรแรกที่มีอยู่
...
มีวิธี [BuildAutomatic](https://reference.aspose.com/words/net/aspose.words.fonts/fontfallbacksettings/buildautomatic/) ที่สร้างการตั้งค่าทางเลือกโดยอัตโนมัติโดยการสแกนแบบอักษรที่มีอยู่ เนื่องจากวิธีนี้อาจทำให้เกิดการตั้งค่าทางเลือกที่ไม่เหมาะสม คุณสามารถควบคุมลักษณะการทำงานของทางเลือกแบบอักษรได้ โดยใช้คุณสมบัติของคลาส [FontFallbackSettings](https://reference.aspose.com/words/net/aspose.words.fonts/fontfallbacksettings/) คลาสนี้ระบุการตั้งค่ากลไกการใช้ทางเลือกแบบอักษร คุณสามารถรับอินสแตนซ์ของคลาส **FontFallbackSettings** ได้ดังนี้:
