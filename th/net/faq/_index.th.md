...
articleTitle: คำถามที่พบบ่อย – Aspose.Words สำหรับ .NET
linktitle: คำถามที่พบบ่อย – Aspose.Words สำหรับ .NET
articleTitle: คำถามที่พบบ่อย
linktitle: คำถามที่พบบ่อย
type: docs
description: "Aspose.Words สำหรับ .NET ตอบคำถามที่พบบ่อย เรียนรู้หน้านี้เพื่อแก้ไขปัญหาของคุณอย่างรวดเร็วสำหรับคำถามทั่วไปหรือหัวข้อเฉพาะ"
weight: 75
url: /th/net/faq/
...
หากคุณไม่พบคำตอบสำหรับคำถามของคุณ คุณสามารถถามได้ที่ฟอรัมสนับสนุน สำหรับข้อมูลเกี่ยวกับวิธีการรายงานคำถามหรือปัญหาของคุณอย่างถูกต้อง โปรดดูที่หน้า [การสนับสนุนทางเทคนิค](/words/th/net/technical-support/)
...
Aspose.Words สำหรับ .NET ไม่จำเป็นต้องติดตั้งแอปพลิเคชันบุคคลที่สามหรือแพ็คเกจซอฟต์แวร์เพิ่มเติมเพื่อให้ทำงานได้ เพียงดาวน์โหลดและติดตั้ง Aspose.Words ตามที่อธิบายไว้ในบทความ [การติดตั้ง](/words/th/net/installation/) แล้วเริ่มต้นใช้งาน
...
โปรดดูรายละเอียดที่หน้า [ภาพรวมผลิตภัณฑ์](/words/th/net/product-overview/) และส่วน [แพลตฟอร์มและความสามารถ Interoperability](/words/net/platforms-and-interoperability/)
...
คุณสามารถดูรายการรูปแบบที่รองรับทั้งหมดได้ที่หน้า [รูปแบบเอกสารที่รองรับ](/words/th/net/supported-document-formats/)
...
ดูหน้า [การออกใบอนุญาตและการสมัครสมาชิก](/words/th/net/licensing/) สำหรับข้อมูลเพิ่มเติม

{{% alert color="primary" %}}

คุณยังสามารถลองใช้คุณสมบัติ Aspose.Words ที่ได้รับความนิยมสูงสุดผ่าน [แอพออนไลน์ฟรี Aspose.Words](https://products.aspose.app/words) ได้อีกด้วย
...
หากต้องการซื้อใบอนุญาต Aspose.Words คุณต้องไปที่หน้า [ซื้อ](https://purchase.aspose.com/buy) เลือกผลิตภัณฑ์ "Aspose.Words" และประเภทใบอนุญาตที่เหมาะกับคุณ จากนั้นเพิ่มใบอนุญาตลงในรถเข็นของคุณและปฏิบัติตามคำแนะนำในรถเข็นช็อปปิ้ง

หลังจากซื้อแล้ว ให้ยื่นขอใบอนุญาตตามที่อธิบายไว้ในส่วน [ใบอนุญาตที่ซื้อ](/words/net/licensing/#purchased-license)

รายละเอียดเกี่ยวกับวิธีการติดตั้ง Aspose.Words สามารถอ่านได้ในหน้า [การติดตั้ง](/words/th/net/installation/)

------

**ถาม: ฉันจะได้รับการสนับสนุนได้อย่างไร**

ใช้ฟอรัมสนับสนุนทางเทคนิคฟรี หากต้องการรายละเอียดเกี่ยวกับวิธีการรายงานปัญหาอย่างถูกต้องและสิ่งที่ต้องทำก่อนติดต่อฟอรัม โปรดดูที่หน้า [การสนับสนุนทางเทคนิค](/words/th/net/technical-support/)

## การแสดงผลเอกสาร

{{% alert color="primary" %}}

คุณสามารถดูข้อมูลโดยละเอียดเพิ่มเติมเกี่ยวกับการแสดงผลได้ในส่วนเอกสารประกอบ [กำลังแสดงผล](/words/th/net/rendering/)

{{% /alert %}}

**ถาม: เหตุใดเค้าโครงและแบบอักษรในเอกสารเอาต์พุตจึงแตกต่างจากต้นฉบับ**

แบบอักษรอาจไม่พร้อมใช้งาน หรือรูปแบบแบบอักษรได้รับการสนับสนุนโดย Microsoft Word แต่ไม่สนับสนุนโดย Aspose.Words Aspose.Words จะดำเนินการ [จัดการและแทนที่แบบอักษร TrueType](/words/th/net/manipulating-and-substitution-truetype-fonts/)

หากต้องการตรวจสอบว่าแบบอักษรหายไปหรือไม่:

* ใน Aspose.Words ให้ใช้คำเตือนการแทนที่แบบอักษร (สำหรับรายละเอียด โปรดดูส่วน "วิธีรับรู้ว่าแบบอักษรถูกแทนที่" ของบทความ [จัดการและแทนที่แบบอักษร TrueType](/words/th/net/manipulating-and-substitution-truetype-fonts/))
...
แบบอักษรสคริปต์ที่ซับซ้อนบางตัวจำเป็นต้องมีการประมวลผลคุณสมบัติการพิมพ์ขั้นสูงเพื่อให้สามารถแสดงได้อย่างถูกต้อง การพิมพ์ขั้นสูงจะถูกปิดใช้งานใน Aspose.Words ตามค่าเริ่มต้น ผู้ใช้ต้องเปิดใช้งานการพิมพ์ขั้นสูงด้วย [TextShaperFactory](https://reference.aspose.com/words/net/aspose.words.layout/layoutoptions/textshaperfactory/)
...
คุณสามารถค้นหาข้อมูลโดยละเอียดเพิ่มเติมเกี่ยวกับ Mail Merge ได้ในส่วนเอกสารประกอบ [Mail Merge และการรายงาน](/words/th/net/mail-merge-and-reporting/)
...
* ตรวจสอบว่าข้อมูลถูกโหลดลงในตารางอย่างถูกต้อง: ตั้งค่า [TableName](https://reference.aspose.com/words/net/aspose.words.mailmerging/imailmergedatasource/tablename/) อย่างถูกต้องด้วยคีย์หลักและความสัมพันธ์ที่จำเป็นทั้งหมด
* ตรวจสอบว่าช่องผสานได้รับการตั้งชื่ออย่างถูกต้อง ใช้วิธี [GetFieldNames](https://reference.aspose.com/words/net/aspose.words.mailmerging/mailmerge/getfieldnames/) เพื่อรับชื่อช่องผสานทั้งหมด และตรวจสอบให้แน่ใจว่าชื่อของช่องผสานในเทมเพลตของคุณตรงกับชื่อในแหล่งข้อมูลของคุณ
...
* ตรวจสอบส่วน "วิธีตั้งค่าความสัมพันธ์ข้อมูลใน Mail Merge ที่ซ้อนกันพร้อมภูมิภาค" ในบทความ [Mail Merge ที่ซ้อนกันกับภูมิภาค](/words/th/net/nested-mail-merge-with-regions/)
...
คุณสามารถค้นหาข้อมูลโดยละเอียดเพิ่มเติมเกี่ยวกับการเขียนโปรแกรมด้วยเอกสารได้ในส่วนเอกสารประกอบของ [การเขียนโปรแกรมด้วยเอกสาร](/words/th/net/programming-with-documents/)

{{% /alert %}}

**ถาม: เหตุใดเนื้อหาที่ต่อท้ายเอกสารจึงไม่ปรากฏในหน้าเดียวกัน**

ผลลัพธ์การผนวกจะปรากฏในหน้าแยกต่างหาก เนื่องจากความแตกต่างในการตั้งค่า [PageSetup](https://reference.aspose.com/words/net/aspose.words/pagesetup/) สำหรับส่วนที่ผนวกเอกสารเข้าด้วยกัน ทำการตั้งค่า **PageSetup** ที่เหมือนกันสำหรับส่วนที่ต่อท้ายเอกสารเข้าด้วยกัน

## แปลงเอกสาร

{{% alert color="primary" %}}

คุณสามารถดูข้อมูลโดยละเอียดเพิ่มเติมเกี่ยวกับการแปลงเอกสารได้ในส่วนเอกสารประกอบ [แปลงเอกสาร](/words/th/net/convert-a-document/)
...
หากต้องการคำตอบโดยละเอียด โปรดดูบทความ [วิธีเรียกใช้ Aspose.Words ในรูปแบบ Docker](/words/th/net/how-to-run-aspose-words-in-docker/)
