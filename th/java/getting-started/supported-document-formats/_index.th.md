...
type: docs
description: "แก้ไขเอกสารต้นฉบับในรูปแบบที่นิยมมากเช่นเดียวกับได้อย่างอิสระแปลงไฟล์จากรูปแบบหนึ่งไปยังอีกโดยใช้Java."
weight: 30
...
ตารางต่อไปนี้แสดงรูปแบบไฟล์อินพุตและเอาต์พุตที่รองรับโดยAspose.WordsสำหรับJava:
...
| `DocPreWord60` | เอกสารอยู่ในรูปแบบคำ 6 หรือคำ 95 | {{< emoticons/tick >}} |  |  |
| [`DOCX`](https://docs.fileformat.com/word-processing/docx/) | เปิดสำนักงานXMLWordprocessingMLเอกสาร(แมโครฟรี) | {{< emoticons/tick >}} | {{< emoticons/tick >}} |  |
| [`DOCM`](https://docs.fileformat.com/word-processing/docm/) | เปิดสำนักงานXMLWordprocessingMLเอกสารที่เปิดใช้งานมาโคร | {{< emoticons/tick >}} | {{< emoticons/tick >}} |  |
| [`DOTX`](https://docs.fileformat.com/word-processing/dotx/) | สำนักงานเปิดXMLWordprocessingMLแม่แบบ(แมโครฟรี) | {{< emoticons/tick >}} | {{< emoticons/tick >}} |  |
| [`DOTM`](https://docs.fileformat.com/word-processing/dotm/) | สำนักงานเปิดXMLWordprocessingMLเทมเพลตที่เปิดใช้งานมาโคร | {{< emoticons/tick >}} | {{< emoticons/tick >}} |  |
| [`XLSX`](https://docs.fileformat.com/spreadsheet/xlsx/) | รูปแบบไฟล์ตามXMLเพื่อแสดงสเปรดชีต |  |  |  |  |  |  |  |  |
| `FlatOpc` | สำนักงานเปิดXMLWordprocessingMLเก็บไว้ในแฟ้มแบนXMLแทนแพคเกจZIP | {{< emoticons/tick >}} | {{< emoticons/tick >}} |  |
| `FlatOpcMacroEnabled` | เปิดสำนักงานXMLWordprocessingMLเอกสารที่เปิดใช้งานมาโครที่เก็บไว้ในแฟ้มแบนXMLแทนที่จะเป็นแพคเกจZIP | {{< emoticons/tick >}} | {{< emoticons/tick >}} |  |
| `FlatOpcTemplate` | เปิดสำนักงานXMLWordprocessingMLแม่แบบ(แมโครฟรี)เก็บไว้ในแฟ้มแบนXMLแทนZIPแพคเกจ | {{< emoticons/tick >}} | {{< emoticons/tick >}} |  |
| `FlatOpcTemplateMacroEnabled` | สำนักงานเปิดXMLWordprocessingMLแม่แบบที่เปิดใช้งานมาโครที่เก็บไว้ในแฟ้มแบนXMLแทนที่จะเป็นแพคเกจZIP | {{< emoticons/tick >}} | {{< emoticons/tick >}} |  |
...
| `WordML` | รูปแบบMicrosoft Word2003WordprocessingML | {{< emoticons/tick >}} | {{< emoticons/tick >}} |  |
...
| [`MOBI`](https://docs.fileformat.com/ebook/mobi/) | MOBIเป็นรูปแบบeBookที่ใช้โดยผู้อ่าน`MobiPocket`และAmazonผู้อ่านจุด | {{< emoticons/tick >}} | {{< emoticons/tick >}} |  |
| [`AZW3`](https://docs.fileformat.com/ebook/azw3/) | AZW3เป็นeBookรูปแบบที่ใช้โดยAmazonผู้อ่านจุด | {{< emoticons/tick >}} | {{< emoticons/tick >}} |  |
...
| [`PDF`](https://docs.fileformat.com/pdf/) | รูปแบบเอกสารแบบพกพาของอะโดบี |  | {{< emoticons/tick >}} |  |
| [`EPS`](https://docs.fileformat.com/page-description-language/eps/) | รูปแบบไฟล์โพสต์สคริปต์ห่อหุ้ม |  | {{< emoticons/tick >}} |  |
| [`XPS`](https://docs.fileformat.com/page-description-language/xps/) | บันทึกเอกสารในรูปแบบXPS(ข้อกำหนดของกระดาษXML) |  | {{< emoticons/tick >}} |  |
| `XamlFixed` | บันทึกเอกสารในรูปแบบภาษามาร์กอัปแอ็พพลิเคชันที่ขยายได้(XAML)เป็นเอกสารถาวร |  | {{< emoticons/tick >}} |  |
...
| `OpenXps` | บันทึกเอกสารในรูปแบบOpenXPS(เอ็กมา-388) |  | {{< emoticons/tick >}} |  |
...
| WebP | รูปแบบการบีบอัดภาพของกูเกิล |  | {{< emoticons/tick >}} |  |
