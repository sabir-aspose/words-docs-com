...
เมื่อบันทึกรูปแบบคำที่สนับสนุนบาร์โค้ดคุณสามารถใช้ชนิดของบาร์โค้ดใดๆที่เป็น [สนับสนุนโดยMicrosoftคำ](https://support.microsoft.com/en-us/office/field-codes-displaybarcode-6d81eade-762d-4b44-ae81-f9d3d9e07be3-4b44-ae81-f9d3d9e07be3). หากชนิดของบาร์โค้ดไม่ถูกต้องถูกส่งผ่านคำจะแสดงข้อผิดพลาด.
...
สำหรับข้อมูลเพิ่มเติมเกี่ยวกับการแปลงเอกสารจากรูปแบบหนึ่งไปยังอีกให้ดูที่ [แปลงเอกสาร](/words/th/java/convert-a-document/) ส่วนเอกสาร.
