...
โปรดทราบว่าคุณสามารถเปรียบเทียบใดๆสองเอกสารภายใน [รูปแบบไฟล์ที่รองรับ](/words/th/java/supported-document-formats/). โดยทั่วไปคุณสามารถเปรียบเทียบวัตถุเอกสารและแม้กระทั่งคุณสามารถสร้างวัตถุเหล่านั้.
