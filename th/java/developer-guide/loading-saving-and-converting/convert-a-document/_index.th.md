...
ส่วนปัจจุบันอธิบายการแปลงที่เป็นที่นิยม,เช่นเดียวกับความคิดสำหรับการทำงานร่วมกับบาง ใช้ตัวอย่างของส่วนนี้คุณสามารถเข้าใจว่ากระบวนการแปลงตัวเองเป็นสากลมากและมีจุ [รูปแบบที่รองรับโดยAspose.WordsสำหรับJava](/words/th/java/supported-document-formats/).
