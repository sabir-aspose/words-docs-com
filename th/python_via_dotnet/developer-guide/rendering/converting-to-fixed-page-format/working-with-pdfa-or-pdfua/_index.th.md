...
description: "แปลงเป็น PDF/A-1, PDF/A-2, PDF/A-4 และ PDF/UA โดยใช้ Python มีปัญหาเล็กน้อยเมื่อแปลงเป็นเอกสาร PDF/A และ Aspose.Words สำหรับ Python จะช่วยแก้ปัญหาเหล่านี้"
type: docs
weight: 28
url: /th/python-net/working-with-pdfa-or-pdfua/
...
สำหรับเอกสาร PDF/UA-1 ที่มีโครงสร้างไม่รัดกุม จำเป็นต้องมีหมายเลขหัวเรื่องเพิ่มเติมตามลำดับโดยไม่มีช่องว่าง
...
<details>
    ...
    <p></p>
    <p>ในสไตล์ "Heading X" เริ่มต้นของ Microsoft Word สามารถใช้เพื่อตั้งค่าระดับเค้าร่าง:</p>
    <img src="/words/python-net/working-with-pdfa-or-pdfua/m-w-heading1-2.png" alt="MWหัวข้อ1-2" style="width:800px"/>
...
<details>
    ...
    <img src="/words/python-net/working-with-pdfa-or-pdfua/m-w-decorative-shape.png" alt="MWรูปทรงตกแต่ง" style="width:800px"/>
...
ภาษาของข้อความระบุไว้ในเอกสาร Microsoft Word Aspose.Words ส่งออกภาษาที่ระบุไปยังเอาต์พุต PDF โดยมีแอตทริบิวต์ *Lang* ที่แนบมากับลำดับเนื้อหาที่ทำเครื่องหมายไว้หรือแท็ก Span ซึ่งควบคุมโดยคุณสมบัติ [export_language_to_span_tag](https://reference.aspose.com/words/python-net/aspose.words.saving/pdfsaveoptions/export_language_to_span_tag/) โดยทั่วไปจะไม่มีปัญหาด้านภาษาเมื่อผู้ใช้ป้อนข้อความผ่าน Microsoft Word แต่มีความเป็นไปได้ที่ภาษาอาจไม่ถูกต้องหากข้อความถูกสร้างขึ้นโดยอัตโนมัติ
...
<img src="/words/python-net/working-with-pdfa-or-pdfua/acrobat-replacement-text.png" alt="Acrobatข้อความทดแทน" style="width:800px"/>
...
<details>
    ...
    <img src="/words/python-net/working-with-pdfa-or-pdfua/acrobat-remove-notdef-glyph-edit-pdf-tool.png" alt="AcrobatRemoveNotdefGlyph-เครื่องมือแก้ไข Pdf" style="width:800px"/>
</details>
{{% /alert %}}
...
<details>
    ...
    <img src="/words/python-net/working-with-pdfa-or-pdfua/m-w-insert-symbol.png" alt="คุณสามารถ MWInsert" style="width:800px"/>
