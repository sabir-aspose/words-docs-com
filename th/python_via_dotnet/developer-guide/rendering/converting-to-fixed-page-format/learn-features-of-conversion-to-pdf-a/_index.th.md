...
description: "แปลงเป็น PDF/A-1, PDF/A-2, PDF/A-4 และ PDF/UA โดยใช้ Python เลือกมาตรฐาน PDF ที่ดีที่สุดเพื่อแปลงเอกสารโดยใช้ Python via .NET"
type: docs
weight: 25
ai_search_scope: words_python
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
ai_search_fast_endpoint: "https://docsearch.api.aspose.cloud/search"
url: /th/python-net/learn-features-of-conversion-to-pdf-a/
...
ในส่วนนี้ เราจะพิจารณาปัญหาหลักที่อาจเกิดขึ้นเมื่อทำงานกับเอกสารในมาตรฐาน PDF ต่างๆ และอธิบายตัวเลือกในการแก้ไข
...
PDF/A เป็น PDF เวอร์ชันมาตรฐาน ISO ซึ่งมีไว้สำหรับใช้ในการจัดเก็บถาวรและการจัดเก็บเอกสารอิเล็กทรอนิกส์ในระยะยาว ในขณะเดียวกัน PDF/UA ก็เป็น PDF เวอร์ชันมาตรฐานของ ISO อีกเวอร์ชันหนึ่ง ซึ่งออกแบบมาเพื่อให้ผู้พิการที่ใช้เทคโนโลยีอำนวยความสะดวกสามารถเข้าถึงได้ หากต้องการระบุระดับการปฏิบัติตามมาตรฐาน PDF ให้ใช้คุณสมบัติ [PdfSaveOptions.compliance](https://reference.aspose.com/words/python-net/aspose.words.saving/pdfsaveoptions/compliance/) เนื่องจากเงื่อนไขในการจัดเก็บข้อมูล เอกสาร PDF/A จะต้องฝังแบบอักษรทั้งหมดและปิดใช้งานการเข้ารหัส ในขณะที่ PDF/UA จะต้องฝังเฉพาะแบบอักษรทั้งหมดเท่านั้น
