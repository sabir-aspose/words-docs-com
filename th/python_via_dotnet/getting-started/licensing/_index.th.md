...
โดยปกติมันก็เพียงพอที่จะใช้ใบอนุญาตมิเตอร์ครั้งเดียวในการเริ่มต้นการประยุกต์ใช้ 24 ชั่วโมงAspose.Wordsจะออกจากโหมดที่ได้รับอนุญาตและสลับไปยังโหมดการประเมินผล เพื่อหลีกเลี่ยงกรณีดังกล่าวคุณสามารถใช้วิธีการ[is_metered_licensed](https://reference.aspose.com/words/python-net/aspose.words/metered/is_metered_licensed/#default)เพื่อตรวจสอบสถานะใบอนุญาตและใช้ใบ.
