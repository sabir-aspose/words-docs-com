...
1. Invoke one of the [Document.save](https://reference.aspose.com/words/nodejs-net/aspose.words/document/save/) methods on the [Document](https://reference.aspose.com/words/nodejs-net/aspose.words/document/) object and specify the desired output format as PDF by entering a file name with the “.PDF” extension.
