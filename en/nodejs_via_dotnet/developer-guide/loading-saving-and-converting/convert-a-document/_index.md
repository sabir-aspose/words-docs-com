---
title: Convert a Document in Node.js
...
Almost any task that you want to perform with Aspose.Words involves loading or saving a document in some format. As mentioned in previous sections, the [LoadFormat](https://reference.aspose.com/words/nodejs-net/aspose.words/loadformat/) enumeration specifies all *load* or *import* formats supported by Aspose.Words, and the [SaveFormat](https://reference.aspose.com/words/nodejs-net/aspose.words/saveformat/) enumeration specifies all *save* or *export* formats supported by Aspose.Words. Thus, Aspose.Words can convert a document from any supported load format into any supported save format. As a rule, such a conversion requires several stages of calculation. However from the user perspective conversion from a document format to another one is itself very simple, and can be accomplished with just two steps:

1. Load your document into a [Document](https://reference.aspose.com/words/nodejs-net/aspose.words/document/) object using one of its constructors.
1. Invoke one of the [save](https://reference.aspose.com/words/nodejs-net/aspose.words/document/save/) methods on the [Document](https://reference.aspose.com/words/nodejs-net/aspose.words/document/) object and specify the desired output format.
...
<div class="row">
	<div class="col-md-4">
		<h2>Convert Word to PDF</h2>
			<ul>
				<li><a href="/words/nodejs-net/convert-a-document-to-pdf/#converting-doc-or-docx-to-pdf">Convert DOC to PDF</a></li>
				<li><a href="/words/nodejs-net/convert-a-document-to-pdf/#converting-doc-or-docx-to-pdf">Convert DOCX to PDF</a></li>
				<li>and others</li>
			</ul>
		<h2>Convert Image to PDF</h2>
			<ul>
				<li><a href="/words/nodejs-net/convert-a-document-to-pdf/#convert-an-image-to-pdf">Convert JPG to PDF</a></li>
				<li><a href="/words/nodejs-net/convert-a-document-to-pdf/#convert-an-image-to-pdf">Convert TIFF to PDF</a></li>
				<li>and others</li>
			</ul>
	...
	<div class="col-md-4">
		<h2>Convert PDF to Word</h2>
			<ul>
				<li><a href="/words/nodejs-net/convert-pdf-to-other-document-formats/">Convert PDF to DOCX</a></li>
        <li>Convert PDF to DOC</li>
				<li>and others</li>
			</ul>
		<h2>Convert PDF to Image</h2>
			<ul>
				<li><a href="/words/nodejs-net/convert-a-document-to-an-image/">Convert PDF to JPG</a></li>
	...
	<div class="col-md-4">
		<h2>Convert a Document to an Image</h2>
			<ul>
				<li><a href="/words/nodejs-net/convert-a-document-to-an-image/">Convert PDF to JPG</a></li>
				<li><a href="/words/nodejs-net/convert-a-document-to-an-image/">Convert DOCX to JPG</a></li>
				<li>and others</li>
			</ul>
		<h2>Convert a Document to Markdown</h2>
			<ul>
				<li><a href="/words/nodejs-net/convert-a-document-to-markdown/">Convert a Document to Markdown</a></li>
				<li>Convert HTML to Markdown</li>
				<li>and others</li>
			</ul>
		<h2>Convert a Document to HTML</h2>
			<ul>
				<li><a href="/words/nodejs-net/convert-a-document-to-html-mhtml-or-epub/#convert-a-document">Convert Word to HTML</a></li>
