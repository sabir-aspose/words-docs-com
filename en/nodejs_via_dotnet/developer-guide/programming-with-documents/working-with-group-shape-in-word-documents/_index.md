...
Below are some of the `Shape` types supported in Aspose.Words. For complete list, please see [aspose.words.drawing.ShapeType](https://reference.aspose.com/words/nodejs-net/aspose.words.drawing/shadowtype/) enumeration
