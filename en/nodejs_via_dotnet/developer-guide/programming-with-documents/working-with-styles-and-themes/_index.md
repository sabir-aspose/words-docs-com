...
description: "Access and manage styles and themes in a document using Node.js."
type: docs
weight: 110
...
- Opening a Word document using the [Document](https://reference.aspose.com/words/nodejs-net/aspose.words/document/) class.
