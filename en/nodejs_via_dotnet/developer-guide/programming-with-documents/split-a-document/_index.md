...
You can also split a document page by page, by page ranges, or starting with the specified page numbers. In such case the [extractPages](https://reference.aspose.com/words/nodejs-net/aspose.words/document/extractPages/#number_number) method can do the job.

This section describes several use cases of dividing documents by paged using the [Document](https://reference.aspose.com/words/nodejs-net/aspose.words/document/) class and the [extractPages](https://reference.aspose.com/words/nodejs-net/aspose.words/document/extractPages/#number_number) method.
