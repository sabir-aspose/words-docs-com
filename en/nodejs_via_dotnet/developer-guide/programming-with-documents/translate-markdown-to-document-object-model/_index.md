...
type: docs
description: "Tarnslate a Markdown document to Document Object Model and back using Node.js. So you can work with complex existing Markdown and programmatically create a Markdown document from scratch."
weight: 20
...
We use [Font](https://reference.aspose.com/words/nodejs-net/aspose.words/font/) formatting for inline blocks. When there is no direct correspondence for a Markdown feature in Aspose.Words DOM, we use a character style with a name that starts from some special words.
...
We use [Font](https://reference.aspose.com/words/nodejs-net/aspose.words/font/) formatting when translating **Bold**, *Italic* or ~~Strikethrough~~ inline markdown features.
