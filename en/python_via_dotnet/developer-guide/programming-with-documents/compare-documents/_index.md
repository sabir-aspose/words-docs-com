...
Note that you can compare any two documents within the [supported file formats](/words/python-net/supported-document-formats/). Basically, you can compare document objects and even you can create those objects from scratch without having any specific format.
