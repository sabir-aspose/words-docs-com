...
<details>
    ...
    <img src="figure-caption-mw.png" alt="figure-caption-mw-python" style="width:800px"/>
    <p>In Acrobat the caption could be added or changed via the `Object` Properties dialog:</p>
    <img src="figure-caption-acrobat.png" alt="figure-caption-acrobat-python" style="width:800px"/>
</details>
{{% /alert %}}
...
<img src="alternate-descriptions-hyperlinks-mw.png" alt="alternate-descriptions-hyperlinks-mw-python" style="width:800px"/>
...
{{< gist "aspose-words-gists" "9ce54931bf26b94a3b63e3accb0f4722" "update-screen-tip.py" >}}
...
<details>
    ...
    <img src="table-headers-mw.png" alt="table-headers-mw-python" style="width:800px"/>
    <p>Or the output PDF:</p>
    <img src="table-headers-acrobat-header-cell.png" alt="table-headers-acrobat-header-cell-python" style="width:800px"/>
    <p></p>
    <img src="table-headers-acrobat-scope1.png" alt="table-headers-acrobat-scope1-python" style="width:800px"/>
    <p></p>
    <img src="table-headers-acrobat-scope2.png" alt="table-headers-acrobat-scope2-python" style="width:800px"/>
</details>
{{% /alert %}}
...
<details>
    ...
    <img src="document-title-mw.png" alt="document-title-mw-python" style="width:800px"/>
    <p>Or the output PDF:</p>
    <img src="document-title-acrobat.png" alt="document-title-acrobat-python" style="width:800px"/>
</details>
{{% /alert %}}
