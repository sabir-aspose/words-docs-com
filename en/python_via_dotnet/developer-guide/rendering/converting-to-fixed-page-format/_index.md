...
The example below demonstrateshow to save a document to JPEG format usingthe [save](https://reference.aspose.com/words/python-net/aspose.words/document/save/) method and rendering options:
