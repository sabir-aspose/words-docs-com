...
description: "Aspose.Words for Python via .NET can embed the correct TrueType fonts into the resulting document to ensure that it displays accurately. If a font or a specific character is not available, Aspose.Words searches for a suitable font replacement or uses the Font fallback mechanism."
type: docs
weight: 10
...
This page explains how to configure and use Aspose.Words for Python via .NET to manage TrueType fonts, covering font manipulation, substitution rules, fallback settings, and related performance considerations.
...
{{< gist "aspose-words-gists" "7e584de6b8683fd2e44372e565d6b5d7" "load-option-font-settings.py" >}}
...
{{< gist "aspose-words-gists" "7e584de6b8683fd2e44372e565d6b5d7" "font-settings-default-instance.py" >}}
...
{{< gist "aspose-words-gists" "7e584de6b8683fd2e44372e565d6b5d7" "font-settings-font-source.py" >}}
...
You can get more information about a font substitution warning issued by Aspose.Words when loading or saving a document using the [FontSubstitutionWarningInfo](https://reference.aspose.com/words/python-net/aspose.words/fontsubstitutionwarninginfo/) class.
...
{{< gist "aspose-words-gists" "7e584de6b8683fd2e44372e565d6b5d7" "font-fallback-settings.py" >}}
...
- [FontSubstitutionWarningInfo](https://reference.aspose.com/words/python-net/aspose.words/fontsubstitutionwarninginfo/)
- [FontFallbackSettings](https://reference.aspose.com/words/python-net/aspose.words.fonts/fontfallbacksettings/)