...
This page describes Structured Document Tags (content controls) in Aspose.Words for Python via .NET, including where they can be placed in a document and the various tag types supported.
