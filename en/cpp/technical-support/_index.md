...
* Make sure you are using the latest Aspose.Words version before reporting an issue. See [Aspose.Words for C++ Downloads](https://www.nuget.org/packages/Aspose.Words.Cpp) to find out about the latest version.
