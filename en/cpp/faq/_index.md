...
Aspose.Words for C++ does not need to install any third-party applications or additional software packages to work. Just download and install Aspose.Words as described in the [”Installation”](/words/cpp/installation/) article and get started.
...
The font may not be available, or the font format is supported by Microsoft Word but not supported by Aspose.Words. Aspose.Words will perform [font substitution](/words/cpp/manipulate-and-substitute-truetype-fonts/).
