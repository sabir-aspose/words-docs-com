...
linktitle: DNN Word Import Module
...
This page describes the DNN Word Import module, which allows importing Word documents into DNN.
...
Please check [the video](https://www.youtube.com/watch?v=-Leeo3saS4I) below to see the module in action.
...
1. Browse to the latest source code that you have downloaded and open **AsposeDotNetNukeContentExport.sln** or **Aspose.DNN.WordImport.sln**
