...
* Support document formats other than DOCX – DOC, RTF, HTML, [and others](/words/net/supported-document-formats/)
* Create documents by [copying or joining fragments of one or more documents](/words/net/insert-and-append-documents/) with automatically merging per-document structures such as styles and lists
* Provide access to complex operations such as [find and replace](/words/net/find-and-replace/), insert and update a table of contents, formula or fields, and others
...
* Quality [conversion between many popular document formats](/words/net/convert-a-document/) and [printing](/words/net/print-a-document-programmatically-or-using-dialogs/)
...
* Programmatic access to the document properties that provide users with features such as, for example, [splitting a document into parts](/words/net/split-a-document/) or [comparing two documents](/words/net/compare-documents/)
* And others
