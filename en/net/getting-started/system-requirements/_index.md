...
Aspose.Wordsfor .NET can be used to develop applications in any development environment targeting the .NET platform, but the environments listed in the following table are explicitly supported:
