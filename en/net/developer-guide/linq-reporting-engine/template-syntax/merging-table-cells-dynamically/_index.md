...
1. **Q:** How do I merge table cells horizontally using the `cellMerge` tag?  
...
2. **Q:** Which tag should I use to merge cells both vertically and horizontally?  
...
3. **Q:** What are the mandatory conditions for dynamic cell merging to occur?  
...
4. **Q:** How can I prevent cells with identical text from merging when they belong to different data groups?  
...
5. **Q:** Can the `cellMerge` tag be used inside a table data band?  
