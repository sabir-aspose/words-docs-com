...
{{< gist "aspose-words-gists" "eae698972bc6e939d7d403a32732da83" "insert-field.java" >}}
...
{{< gist "aspose-words-gists" "eae698972bc6e939d7d403a32732da83" "insert-nested-fields.java" >}}
...
{{< gist "aspose-words-gists" "eae698972bc6e939d7d403a32732da83" "specify-locale-at-field-level.java" >}}
...
{{< gist "aspose-words-gists" "eae698972bc6e939d7d403a32732da83" "insert-field-none.java" >}}
...
{{< gist "aspose-words-gists" "eae698972bc6e939d7d403a32732da83" "insert-field-using-field-builder.java" >}}
...
The `MERGEFIELD` field in Word document can be represented by the [FieldMergeField](https://reference.aspose.com/words/java/com.aspose.words/fieldmergefield/) class. You can use the **FieldMergeField** class to perform the following operations:
...
{{< gist "aspose-words-gists" "eae698972bc6e939d7d403a32732da83" "insert-address-block-field-using-dom.java" >}}
...
{{< gist "aspose-words-gists" "eae698972bc6e939d7d403a32732da83" "insert-advance-field-without-document-builder.java" >}}

### Inserting `ASK` field into a Document without using DocumentBuilder

The `ASK` field is used to prompt the user for text to assign to a Bookmark in Word document. `ASK` field in Word document can be represented by the [FieldAsk](https://reference.aspose.com/words/java/com.aspose.words/fieldask/) class. You can use the **FieldAsk** class to perform the following operations:
...
{{< gist "aspose-words-gists" "eae698972bc6e939d7d403a32732da83" "insert-author-field.java" >}}
...
{{< gist "aspose-words-gists" "eae698972bc6e939d7d403a32732da83" "insert-field-include-text-without-document-builder.java" >}}
...
{{< gist "aspose-words-gists" "eae698972bc6e939d7d403a32732da83" "insert-toa-field-without-document-builder.java" >}}
...
- [FieldMergeField](https://reference.aspose.com/words/java/com.aspose.words/fieldmergefield/)
- [FieldAddressBlock](https://reference.aspose.com/words/java/com.aspose.words/fieldaddressblock/)
- [FieldAdvance](https://reference.aspose.com/words/java/com.aspose.words/fieldadvance/)
- [FieldAsk](https://reference.aspose.com/words/java/com.aspose.words/fieldask/)
- [FieldAuthor](https://reference.aspose.com/words/java/com.aspose.words/fieldauthor/)
- [FieldIncludeText](https://reference.aspose.com/words/java/com.aspose.words/fieldincludetext/)
- [FieldToa](https://reference.aspose.com/words/java/com.aspose.words/fieldtoa/) 
