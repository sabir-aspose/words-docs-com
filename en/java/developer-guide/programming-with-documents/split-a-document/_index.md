...
You cannot split a document using the [DocumentSplitCriteria](https://reference.aspose.com/words/java/com.aspose.words/documentsplitcriteria/) property when saving to MHTML format.
