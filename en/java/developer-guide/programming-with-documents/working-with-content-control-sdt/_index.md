...
The following code example showshow to create content control of type checkbox:
...
The following code example showshow to set the current state of the checkbox:
