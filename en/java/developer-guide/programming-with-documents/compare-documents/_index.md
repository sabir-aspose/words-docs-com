...
{{< gist "aspose-words-gists" "bb20fc6b8fbf12d0a3175a5fe1cb3d29" "compare-for-equal.java" >}}
...
For example, Aspose.Words allows you to ignore changes made during a comparison operation for certain types of objects within the original document. You can select the appropriate property for the object type, such as [IgnoreHeadersAndFooters](https://reference.aspose.com/words/java/com.aspose.words/compareoptions/#getIgnoreHeadersAndFooters), [IgnoreFormatting](https://reference.aspose.com/words/java/com.aspose.words/compareoptions/#getIgnoreFormatting), [IgnoreComments](https://reference.aspose.com/words/java/com.aspose.words/compareoptions/#getIgnoreComments), and others by setting them to "true".

In addition, Aspose.Words provides the [Granularity](https://reference.aspose.com/words/java/com.aspose.words/compareoptions/#getGranularity) property with which you can specify whether to track changes by character or by word.

Another common property is a choice in which document to show comparison changes. For example, the “Compare documents dialogue box” in Microsoft Word has the option “Show changes in” – this also affects the comparison results. Aspose.Words provides the [Target](https://reference.aspose.com/words/java/com.aspose.words/compareoptions/#getTarget) property that serves this purpose.

The following code example shows how to set the advanced comparing properties:

{{< gist "aspose-words-gists" "bb20fc6b8fbf12d0a3175a5fe1cb3d29" "compare-options.java" >}}

## Related APIs

- [Document.Compare](https://reference.aspose.com/words/java/com.aspose.words/document/#getCompare) – compares two documents and records differences as revisions
- [CompareOptions](https://reference.aspose.com/words/java/com.aspose.words/compareoptions/) – specifies comparison behavior (e.g., ignore headers, formatting, comments)
- [Granularity](https://reference.aspose.com/words/java/com.aspose.words/compareoptions/#getGranularity) – controls whether changes are tracked by character or by word
- [CompareTarget](https://reference.aspose.com/words/java/com.aspose.words/compareoptions/#getTarget) – determines which document displays the changes
- [Revision](https://reference.aspose.com/words/java/com.aspose.words/revision/) – represents a single change detected during comparison
- [Revisions](https://reference.aspose.com/words/java/com.aspose.words/revisioncollection/) – collection of all changes recorded in the document after comparison
