---
title: Install Aspose.Words IntelliJ IDEA
...
1. Click **Finish**.<br>
This will retrieve the [Aspose.Words for Java API](https://products.aspose.com/words/java/) latest maven dependency reference from Aspose Cloud Maven Repository and configure it in pom.xml<br>
...
Congratulations! {{< emoticons/cross >}} You have successfully created Aspose.Words Maven project for using [Aspose.Words for Java API](https://products.aspose.com/words/java/).<br>
