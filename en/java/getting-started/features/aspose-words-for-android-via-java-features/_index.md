...
| Access, create and modify fields, form fields, hyperlinks and bookmarks. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
...
| Get and set built-in and custom document properties. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| Specify document protection, open protected and encrypted documents. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| Find and replace text, enumerate over document content. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| Accept all revisions in a document. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
...
| Support of several data sources (including of different types) for generation of a single document | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
