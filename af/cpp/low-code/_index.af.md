...
Aspose.Words vir C++ ondersteun Beide Vlot en Nie-Vlot APIs, sodat ontwikkelaars die styl wat die beste pas by hul kodering voorkeure en projek behoeftes te kies. Kom ons kyk na'n paar voorbeelde om te sien hoe hierdie twee tipes API verskil.
...
Om meer gevorderde opsies te verken, kan jy altyd LowCode APIs kombineer met die volledige Aspose.Words voorwerpmodel. Sien meer Low Code voorbeelde in die [API documentation](https://reference.aspose.com/words/cpp/aspose.words.lowcode/).