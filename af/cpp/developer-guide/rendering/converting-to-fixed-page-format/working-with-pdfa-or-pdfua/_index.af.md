...
description: "Skakel om na PDF/A-1, PDF/A-2, PDF/A-4 en PDF/UA met behulp van C++. Daar is'n paar probleme wanneer die omskakeling na PDF/A dokumente, en Aspose.Words vir C++ los hulle op."
type: docs
weight: 38
url: /af/cpp/working-with-pdfa-or-pdfua/
...
Let asseblief daarop dat PDF/UA-1 uitset sal ook WCAG 2.0 en Artikel 508 voldoen.
...
Teks taal word gespesifiseer in Microsoft Word dokumente. Aspose.Words voer die gespesifiseerde taal uit na'n uitset PDF met die *Lang* kenmerk wat aan'n gemerkte inhoud volgorde of'n Span tag gekoppel is-dit word beheer deur die [ExportLanguageToSpanTag](https://reference.aspose.com/words/cpp/aspose.words.saving/pdfsaveoptions/get_exportlanguagetospantag/) eienskap. Oor die algemeen is daar geen taalprobleme wanneer teks deur die gebruiker via Microsoft Word ingevoer word nie. Maar daar is'n moontlikheid dat die taal dalk onakkuraat is as die teks outomaties gegenereer word.
...
<details>
    <summary>Die spesifikasie vertel ons die volgende (brei uit om besonderhede te sien):</summary>
    <p></p>
    <p>'n onderskrif wat'n figuur vergesel, moet met'n Onderskrif-etiket gemerk word.</p>
    <p>ISO-14289-1, 7.3</p>
</details>
{{% /alert %}}
...
{{% alert color="secondary" %}}
<details>
    <summary>In hierdie blok kan jy voorbeelde sien: hoe om die onderskrif in te voeg (brei uit om besonderhede te sien).</summary>
    <p></p>
    <p>In Microsoft Word, kan die onderskrif ingevoeg word deur die konteks kieslys:</p>
    <img src="figure-caption-mw.png" alt="figure-caption-mw" style="width:800px"/>
    <p>In Acrobat kan die onderskrif bygevoeg of verander word via die `Object` Eienskappe dialoog:</p>
...
<details>
    <summary>Die spesifikasie vertel ons die volgende (brei uit om besonderhede te sien):</summary>
    <p></p>
    <p>Tabelle moet koptekste insluit ... Tabelle kan kolomopskrifte, ryopskrifte of albei bevat.</p>
    <p>ISO-14289-1, 7.5</p>
</details>
{{% /alert %}}
...
{{% alert color="secondary" %}}
<details>
    <summary>In hierdie blok kan jy voorbeelde sien: hoe om die tabelopskrif te stel (brei uit om besonderhede te sien).</summary>
    <p></p>
    <p>Die tabel kop kan ingestel word op die bron Microsoft Word dokument:</p>
    <img src="table-headers-mw.png" alt="table-headers-mw" style="width:800px"/>
    <p>Of die uitset PDF:</p>
...
| PDF/A-2a |  |
| PDF/A-4 |  |
| PDF/UA-1 | {{< emoticons/tick >}}<br />Dokument in PDF/UA-1 moet'n titel hê. |
...
<details>
    ...
    <p></p>
    <p>Die spesifikasie vertel ons die volgende:</p>
    <p>Die Metadata stroom in die dokument se katalogus woordeboek moet'n dc:titel inskrywing bevat, waar dc is die aanbevole voorvoegsel vir Die Dublin Core metadata skema…</p>
    <p>ISO-14289-1, 7.1</p>
</details>
{{% /alert %}}
...
{{% alert color="secondary" %}}
<details>
    <summary>In hierdie blok kan jy voorbeelde sien: hoe om die dokumenttitel te stel (brei uit om besonderhede te sien).</summary>
    <p></p>
    <p>Die dokument titel kan ingestel word op die bron Microsoft Word dokument:</p>
