...
description: "Hoe om koptekste en voetskrifte te manipuleer met behulp van C++."
type: docs
weight: 150
...
As jy'n dokument kop of voetskrif programmaties wil byvoeg, is die maklikste manier om die [DocumentBuilder](https://reference.aspose.com/words/cpp/aspose.words/documentbuilder/) klas te gebruik om dit te doen.
...
### Spesifiseer Of Verskillende Opskrifte Of Voetskrifte Vir Onewe Of Ewe Bladsye Vertoon moet Word
 ...
 Vervolgens wil u verskillende opskrifte of voetskrifte vir onewe en egalige bladsye in'n dokument stel. Om dit te doen, moet jy die [OddAndEvenPagesHeaderFooter](https://reference.aspose.com/words/cpp/aspose.words/pagesetup/get_oddandevenpagesheaderfooter/) vlag op `true` stel en dan die waardes **HeaderPrimary** en **HeaderEven**, of **FooterPrimary** en **FooterEven** spesifiseer.

{{< gist "aspose-words-gists" "e26133cadfcbe798f1ae301e2941f5ff" "odd-even-pages.h" >}}

### Voeg'n Absoluut Geposisioneer Beeld in Die Kop

Om'n beeld in'n koptekst of voetskrif te plaas, gebruik die **HeaderPrimary** kopteksttipe of die **FooterPrimary** voetteksttipe en die `InsertImage` metode.
...
Indien nodig, kan jy bladsynommers by die koptekst of voettekst voeg. Om dit te doen, gebruik die **HeaderPrimary** koptekst tipe of die **FooterPrimary** voetskrif tipe en die [InsertField](https://reference.aspose.com/words/cpp/aspose.words/documentbuilder/insertfield/) metode om die vereiste veld by te voeg.
