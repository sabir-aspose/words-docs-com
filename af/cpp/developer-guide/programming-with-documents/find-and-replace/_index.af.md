...
Gebruik die ander [Replace](https://reference.aspose.com/words/cpp/aspose.words/range/replace/) metode om spesifieke karakterkombinasies te soek en te vervang deur die `Regex` parameter as die gereelde uitdrukkingspatroon in te stel om ooreenkomste te vind.
...
Let daarop dat die metakarakter **&&** gelyk is aan **&**. Byvoorbeeld, as jy teks vir **&p** moet vind wat nie 'n paragraafbreuk is nie, dan kan jy **&&p** gebruik.
...
U kan teks in die kop - /voetskrifgedeelte van'n Word-dokument vind en vervang deur die [HeaderFooter](https://reference.aspose.com/words/cpp/aspose.words/headerfooter/) - klas te gebruik.
