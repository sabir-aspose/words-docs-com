---
title: Maak'n Dokument Leesalleen in C++
second_title: Aspose.Words vir C++
articleTitle: Maak'n Leesalleen Dokument
linktitle: Maak'n Leesalleen Dokument
description: "Maak u dokument leesalleen sodat die inhoud gekopieer of gelees kan word, maar nie gewysig kan word nie."
type: docs
weight: 10
ai_search_scope: words_cpp
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
ai_search_fast_endpoint: "https://docsearch.api.aspose.cloud/search"
url: /af/cpp/make-a-document-read-only/
...
Aspose.Words het die openbare klas [WriteProtection](https://reference.aspose.com/words/cpp/aspose.words.settings/writeprotection/) wat skryfbeskermingsinstellings vir'n dokument spesifiseer. Jy skep nie gevalle van hierdie klas direk.
...
Aspose.Words laat jou toe om'n dokument lees-alleen te maak om redigering te beperk deur die [ReadOnlyRecommended](https://reference.aspose.com/words/cpp/aspose.words.settings/writeprotection/get_readonlyrecommended/) eienskap en die [SetPassword](https://reference.aspose.com/words/cpp/aspose.words.settings/writeprotection/setpassword/) metode te gebruik.
...
As jy moet kyk of'n dokument'n skryfbeskermingswagwoord het wat dit beperk om te redigeer, kan jy die [IsWriteProtected](https://reference.aspose.com/words/cpp/aspose.words.settings/writeprotection/get_iswriteprotected/) - eienskap gebruik.
