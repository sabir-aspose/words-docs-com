...
* As'n vooraf gerenderde tekening teenwoordig is, maar verkeerd is, is dit nodig om SmartArt koue weergawe eksplisiet uit te voer deur [UpdateSmartArtDrawing](https://reference.aspose.com/words/cpp/aspose.words.drawing/shape/updatesmartartdrawing/) metode te noem.
