...
url: /af/cpp/working-with-columns-and-rows/
...
In die Aspose.Words Dokument Voorwerp Model (DOM), die [Table](https://reference.aspose.com/words/cpp/aspose.words.tables/table/) knoop bestaan uit [Row](https://reference.aspose.com/words/cpp/aspose.words.tables/row/) nodes en dan [Cell](https://reference.aspose.com/words/cpp/aspose.words.tables/cell/) nodes. So, in die `Document` Voorwerp Model van Aspose.Words, soos in Word dokumente, is daar geen konsep van'n kolom.
...
Dit behels die beperking van inhoud binne die selle van'n ry om oor'n bladsy verdeel te word. In Microsoft Word, kan dit gevind word onder Tabel Eienskappe as die opsie "Laat ry om te breek oor bladsye". In Aspose.Words word dit gevind onder die [RowFormat](hhttps://reference.aspose.com/words/cpp/aspose.words.tables/rowformat/) voorwerp van a [Row](https://reference.aspose.com/words/cpp/aspose.words.tables/row/) as die eienskap [RowFormat.AllowBreakAcrossPages](https://reference.aspose.com/words/cpp/aspose.words.tables/rowformat/get_allowbreakacrosspages/).
...
Om dit te doen, gebruik Aspose.Words 'n metode, wat gebruikers toelaat om'n tabel te kies en die [KeepWithNext](https://reference.aspose.com/words/cpp/aspose.words/paragraphformat/get_keepwithnext/) parameter in staat te stel om waar te wees vir elke paragraaf binne die tabel selle. Die uitsondering is die laaste paragraaf in die tabel, wat op vals gestel moet word.
