...
Daar is baie verskillende eienskappe van die [CompareOptions](https://reference.aspose.com/words/net/aspose.words.comparing/compareoptions/) klas wat jy kan aansoek doen wanneer jy wil dokumente te vergelyk.
...
Daarbenewens bied Aspose.Words die [Granularity](https://reference.aspose.com/words/net/aspose.words.comparing/compareoptions/granularity/) eienskap waarmee u kan spesifiseer of u veranderinge volgens karakter of woord moet opspoor.

Nog'n gemeenskaplike eienskap is'n keuse in watter dokument om vergelyking veranderinge te wys. Byvoorbeeld, die" Vergelyk dokumente dialoog boks "in Microsoft Word het die opsie" Wys veranderinge in " – dit beïnvloed ook die vergelyking resultate. Aspose.Words verskaf die [Target](https://reference.aspose.com/words/net/aspose.words.comparing/compareoptions/target/) eienskap wat hierdie doel dien.
