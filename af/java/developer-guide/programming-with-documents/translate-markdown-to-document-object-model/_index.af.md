...
In teenstelling met Word-dokumente, voldoen Markdown nie aan die DOM wat in Die [Aspose.Words Dokument Voorwerp Model (DOM)](/words/af/java/aspose-words-document-object-model/) artikel. Aspose.Words bied egter sy eie meganisme vir die vertaling van Markdown dokumente na DOM en terug, sodat ons suksesvol kan werk met hul elemente soos teks opmaak, tabelle, koptekste, en ander.
...
Ons gebruik [Font](https://reference.aspose.com/words/java/com.aspose.words/font/) formatering vir inline blokke. Wanneer daar geen direkte ooreenstemming is vir'n Markdown kenmerk in Aspose.Words DOM nie, gebruik ons'n karakterstyl met'n naam wat begin met'n paar spesiale woorde.
...
Ons gebruik [Font](https://reference.aspose.com/words/java/com.aspose.words/font/) formatering wanneer ons **Bold**, *Italic* of ~~Strikethrough~~ inline markdown funksies vertaal.
...
| **Autolink**<br />`<scheme://domain.com>`<br />`<email@domain.com>` | Die [FieldHyperlink](https://reference.aspose.com/words/java/com.aspose.words/fieldhyperlink/) klas. |
...
| **Link**<br />`[link text](url)`<br />`[link text](<url>"title")`<br />`[link text](url 'title')`<br />`[link text](url (title))` | Die [FieldHyperlink](https://reference.aspose.com/words/java/com.aspose.words/fieldhyperlink/) klas. |
...
| **Image**<br />`![](url)`<br />`![alt text](<url>"title")`<br />`![alt text](url ‘title’)`<br />`![alt text](url (title))` | Die [Shape](https://reference.aspose.com/words/java/com.aspose.words/shape/) klas. |
...
| Markdown kenmerk | Aspose.Words |
| ---------------------------------------- | ------------------------------------------------------------ |
| `Table`<br />`a|b`<br />`-|-`<br />`c|d` | [Table](https://reference.aspose.com/words/java/com.aspose.words/table/), [Row](https://reference.aspose.com/words/java/com.aspose.words/row/) en [Cell](https://reference.aspose.com/words/java/com.aspose.words/cell/) klasse. |
