---
title: Enkripteer'n Dokument in Java
second_title: Aspose.Words vir Java
articleTitle: Enkripteer'n Dokument
linktitle: Enkripteer'n Dokument
description: "Enkripteer jou dokument met toepaslike enkripsie-algoritmes vir spesifieke dokumentformate in Java."
type: docs
weight: 20
ai_search_scope: words_java
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
ai_search_fast_endpoint: "https://docsearch.api.aspose.cloud/search"
url: /af/java/encrypt-a-document/
...
U kan die toepaslike **Password** eienskap vir die vereiste formaat vind. Elke dokument stoor formaat het'n ooreenstemmende klas wat stoor opsies vir hierdie formaat. Byvoorbeeld, die [Password](https://reference.aspose.com/words/java/com.aspose.words/docsaveoptions/#getPassword) eienskap in die [DocSaveOptions](https://reference.aspose.com/words/java/com.aspose.words/docsaveoptions/) klas vir DOC, of die [Password](https://reference.aspose.com/words/java/com.aspose.words/ooxmlsaveoptions/#getPassword) eienskap in die [OoxmlSaveOptions](https://reference.aspose.com/words/java/com.aspose.words/ooxmlsaveoptions/) klas vir DOCX, DOCM, DOTX, DOTM, en FlatOpc.
