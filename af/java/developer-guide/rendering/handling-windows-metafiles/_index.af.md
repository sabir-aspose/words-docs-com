---
title: Hantering van Windows Meta Lêers in Java
second_title: Aspose.Words vir Java
articleTitle: Hantering Van Windows Meta Lêers
linktitle: Hantering Van Windows Meta Lêers
description: "Aspose.Words vir Java implementeer sy eie Windows Metafile-speler Om Metafile-formaat op alle platforms te speel en ondersteun die hantering van die basiese metafile-funksies en kan terugval na'n ander tipe metafile-speler uitvoer."
type: docs
weight: 30
ai_search_scope: words_java
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
ai_search_fast_endpoint: "https://docsearch.api.aspose.cloud/search"
url: /af/java/handling-windows-metafiles/
...
Die [MetafileRenderingOptions](https://reference.aspose.com/words/java/com.aspose.words/metafilerenderingoptions/) klas stel jou in staat om die metafile speler te beheer. Byvoorbeeld, jy kan bepaal hoe metafile beelde moet weergegee word met behulp van die [RenderingMode](https://reference.aspose.com/words/java/com.aspose.words/metafilerenderingmode/) eiendom, wat'n spesiale betekenis het wanneer die omskakeling na bitmaps (sien ook die [MetafileRenderingOptions](https://reference.aspose.com/words/java/com.aspose.words/imagesaveoptions/#getMetafileRenderingOptions) eiendom).
