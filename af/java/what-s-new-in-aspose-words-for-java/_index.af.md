...
## Aspose.Words vir Java 25.5, 25.6
...
Aspose.Words 25.6 verbeter die lewering van presisie en visualisering funksies deur die bekendstelling van gevorderde beeld uitvoer opsies, verbeterde MathML hantering, en beter grafiek verteenwoordiging.

### Omskakeling, Laai En Stoor Van Dokumente

#### Voer Leë Paragrawe uit na Markdown <sup>25.5</sup>

Die vermoë om te beheer hoe leë paragrawe uitgevoer word na Markdown is ingestel deur die [MarkdownEmptyParagraphExportMode](https://reference.aspose.com/words/java/com.aspose.words/markdownemptyparagraphexportmode/) opsomming en die [EmptyParagraphExportMode](https://reference.aspose.com/words/java/com.aspose.words/markdownsaveoptions/#getEmptyParagraphExportMode) eienskap by te voeg.

#### Voer Meerbladsydokumente uit Na Rasterbeeldformate <sup>25.6</sup>

Die vermoë om multi-bladsy dokumente uit te voer na raster beeld formate (soos PNG en JPEG) met [customizable layouts](https://reference.aspose.com/words/java/com.aspose.words/multipagelayout/) Horisontale, Vertikale, of Rooster is ingestel deur die uitbreiding van beeld uitvoer funksionaliteit.

### Lewering

#### Die Opstel Van Die Grafiek Styl <sup>25.5</sup>

Die vermoë om die grafiek styl te stel is ingestel deur die toevoeging van die [ChartStyle](https://reference.aspose.com/words/java/com.aspose.words/chartstyle/) opsomming en die [Style](https://reference.aspose.com/words/java/com.aspose.words/chart/#getStyle) eienskap.

#### Lewering Connector Lyne in MathML Uitdrukkings <sup>25.6</sup>

Die weergawe van verbindingslyne in MathML uitdrukkings is geïmplementeer om'n meer akkurate en visueel konsekwente vertoning van wiskundige formules te verseker.

#### Lewering Legendes vir Waterval Kaarte <sup>25.6</sup>

Die weergawe van legendes vir ["Waterfall" charts](https://reference.aspose.com/words/java/com.aspose.words/chartseriestype/) is ingestel, wat die deursigtigheid van data verhoog en die interpreteerbaarheid van hierdie kaarte verbeter.

### Ander

* Die vermoë om wiskundige formules met verskeie skuinsstrepe te verpak, is verbeter, wat die uitleg duidelikheid en formule leesbaarheid verbeter. <sup>25.6</sup>

{{% alert color="primary" %}}

Leer meer oor [Aspose.Words vir Java 25.5 Vrystelling Notas](https://releases.aspose.com/words/java/release-notes/2025/aspose-words-for-java-25-5-release-notes/).

Leer meer oor [Aspose.Words vir Java 25.6 Vrystelling Notas](https://releases.aspose.com/words/java/release-notes/2025/aspose-words-for-java-25-6-release-notes/).
