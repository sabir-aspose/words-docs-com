...
description: "Aspose.Words vir Java bied verskillende planne vir aankoop of bied'n Gratis Proeflopie en'n 30-Dag Tydelike Lisensie vir evaluering met Behulp van Lisensiëring en Inskrywing beleid."
type: docs
weight: 60
...
Aspose.Words is ongelooflike sagteware wat ontwikkelaars kan probeer voordat hulle koop. Jy kan maklik aflaai / installeer Aspose.Words vir Java en Aspose.Words vir Android via Java [van Maven](https://releases.aspose.com/words/java/) vir evaluering.
...
Die Proef weergawe van Aspose.Words vir Java en Aspose.Words vir Android via Java sonder die gespesifiseerde lisensie bied volle produk funksionaliteit, maar voeg'n evaluerende watermerk aan die bokant van die dokument by laai en stoor en beperk die maksimum dokument grootte tot'n paar honderd paragrawe.

### Tydelike Lisensie

As jy wil toets Aspose.Words vir Java en Aspose.Words vir Android via Java sonder die beperkings van die Proef weergawe, kan jy ook'n 30-Dag Tydelike Lisensie aanvra. Vir meer besonderhede, sien die [Kry'n Tydelike Lisensie](https://purchase.aspose.com/temporary-license/) bladsy.
...
* Eksplisiete pad
* Die gids met die *Aspose.Words JAR* lêer
* 'n ingebedde hulpbron in die JAR word *Aspose.Words JAR*genoem
* As'n Gemete Lisensie - 'n nuwe lisensie meganisme

Dikwels is die maklikste manier om'n lisensie te stel om die lisensie lêer in dieselfde gids as *Aspose.Words JAR* te plaas en spesifiseer net die lêernaam sonder die pad.

{{% alert color="primary" %}}

Gebruik die [SetLicense](https://reference.aspose.com/words/java/com.aspose.words/license/#setLicense-java.io.InputStream) metode om'n komponent te lisensieer.

Om **SetLicense** verskeie kere te bel is nie skadelik nie, dit mors net verwerker tyd.

Om [SetMeteredKey](https://reference.aspose.com/words/java/com.aspose.words/metered/#setMeteredKey-java.lang.String-java.lang.String) verskeie kere te bel is ook nie skadelik nie, maar mors net verwerker tyd en kan verbruik onbehoorlik ophoop.
...
Bel **SetLicense** in jou opstartkode voordat jy Aspose.Words klasse gebruik.

{{% /alert %}}

Wanneer die ontwikkeling van'n klas biblioteek, kan jy **SetLicense** roep van die statiese konstruktor van jou klas wat Aspose.Words gebruik. Die statiese konstruktor sal uitgevoer word voor instantiating jou klas om te verseker dat die Aspose.Words lisensie korrek geïnstalleer.

##### Laai'n Lisensie vanaf'n Lêer

Deur die [SetLicense](https://reference.aspose.com/words/java/com.aspose.words/license/#setLicense-java.lang.String) metode te gebruik, kan jy probeer om die lisensie lêer te vind in die ingebedde hulpbronne of gids wat die JARs van jou aansoek bevat vir verdere gebruik.
...
##### Laai'n Lisensie vanaf'n `Stream` Voorwerp

Die volgende kode voorbeeld toon hoe om'n lisensie van'n stroom te inisialiseer met behulp van'n ander [SetLicense](https://reference.aspose.com/words/java/com.aspose.words/license/#setLicense-java.io.InputStream) metode:
...
'n netjiese manier om'n lisensie met jou aansoek te pak en seker te maak dat dit nie verlore gaan nie, is om dit as'n ingebedde hulpbron in te sluit. U kan eenvoudig die LIC - lêer na die hulpbronmap van u projek kopieer.

Die heropbou van die projek moet die .lic lêer in aansoek .jar lêer. Daarna kan jy aansoek doen vir'n lisensie deur die volgende kode te gebruik:
...
Nadat u al die nodige stappe voltooi het om hierdie tipe lisensie te bekom, ontvang u die sleutels, nie die lisensie-lêer nie. Hierdie gemete sleutel kan toegepas word met behulp van die [Metered](https://reference.aspose.com/words/java/com.aspose.words/metered/) klas spesiaal vir hierdie doel ingestel.
...
Gewoonlik is dit genoeg om die meterlisensie een keer toe te pas wanneer die aansoek begin. As die meetlisensie-meganisme egter nie 24 uur lank met die Aspose-bedieners kommunikeer nie, sal Aspose.Words die gelisensieerde modus verlaat en oorskakel na die evalueringsmodus. Om so'n geval te vermy, kan u die [IsMeteredLicensed](https://reference.aspose.com/words/java/com.aspose.words/metered/#isMeteredLicensed) - metode gebruik om die lisensiestatus na te gaan en die gemete lisensie weer toe te pas indien nodig.

{{% alert color="primary" %}}

Let asseblief daarop dat u'n stabiele Internetverbinding moet hê vir die korrekte gebruik van Die Gemete lisensie, aangesien die Gemete meganisme die konstante interaksie met ons dienste vereis vir korrekte berekeninge.

Vir meer besonderhede, verwys na die [Meterlisensie FAQ](https://purchase.aspose.com/faqs/licensing/metered/) afdeling.
