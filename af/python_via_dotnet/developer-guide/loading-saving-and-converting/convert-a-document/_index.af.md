...
url: /af/python-net/convert-a-document/
weight: 30
...
<div class="row">
	<div class="col-md-4">
		<h2>Skakel Woord om na PDF</h2>
			<ul>
				<li><a href="/words/python-net/convert-a-document-to-pdf/#converting-doc-or-docx-to-pdf">Omskep DOC na PDF</a></li>
				<li><a href="/words/python-net/convert-a-document-to-pdf/#converting-doc-or-docx-to-pdf">Omskep DOCX na PDF</a></li>
				<li>en ander</li>
			</ul>
		<h2>Skakel Beeld om na PDF</h2>
			<ul>
				<li><a href="/words/python-net/convert-a-document-to-pdf/#convert-an-image-to-pdf">Omskep JPG na PDF</a></li>
				<li><a href="/words/python-net/convert-a-document-to-pdf/#convert-an-image-to-pdf">Omskep TIFF na PDF</a></li>
				<li>en ander</li>
			</ul>
	...
	<div class="col-md-4">
		<h2>Omskep PDF Na Word</h2>
			<ul>
				<li><a href="/words/python-net/convert-pdf-to-other-document-formats/">Omskep PDF na DOCX</a></li>
        <li>Omskep PDF na DOC</li>
				<li>en ander</li>
			</ul>
		<h2>Omskep PDF Na Beeld</h2>
			<ul>
				<li><a href="/words/python-net/convert-a-document-to-an-image/">Omskep PDF na JPG</a></li>
        <li>Omskep PDF na SVG</li>
				<li>en ander</li>
			</ul>
		<h2>Skakel PDF Om Na Webformate</h2>
			<ul>
	...
	<div class="col-md-4">
		<h2>Skakel'n Dokument om Na'n Beeldlêer</h2>
			<ul>
				<li><a href="/words/python-net/convert-a-document-to-an-image/">Omskep PDF na JPG</a></li>
				<li><a href="/words/python-net/convert-a-document-to-an-image/">Omskep DOCX na JPG</a></li>
				<li>en ander</li>
			</ul>
		<h2>Skakel'n Dokument om na Markdown</h2>
			<ul>
				<li><a href="/words/python-net/convert-a-document-to-markdown/">Skakel'n Dokument om na Markdown</a></li>
				<li>Omskep HTML na Markdown</li>
				<li>en ander</li>
			</ul>
		<h2>Skakel'n Dokument om na HTML</h2>
			<ul>
				<li><a href="/words/python-net/convert-a-document-to-html-mhtml-or-epub/#convert-a-document">Skakel Woord om na HTML</a></li>
