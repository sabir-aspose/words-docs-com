...
linktitle: Werk met Group Shape in Word-Dokumente
description: "Voeg group shape by'n dokument met Python."
type: docs
weight: 290
...
In Aspose.Words is dit baie maklik om'n group shape te voeg met behulp van [GroupShape](https://reference.aspose.com/words/python-net/aspose.words.drawing/groupshape/) klas. Vorm word afsonderlik geskep met behulp van [Shape](https://reference.aspose.com/words/python-net/aspose.words.drawing/shape/) klas en dan bygevoeg in [GroupShape](https://reference.aspose.com/words/python-net/aspose.words.drawing/groupshape/) voorwerp met behulp van [append_child](https://reference.aspose.com/words/python-net/aspose.words/compositenode/append_child/) metode.
...
Hieronder is'n paar van die `Shape` tipes ondersteun in Aspose.Words. Vir die volledige lys, sien asseblief [aspose.words.drawing.ShapeType](https://reference.aspose.com/words/python-net/aspose.words.drawing/shapetype/) opsomming
