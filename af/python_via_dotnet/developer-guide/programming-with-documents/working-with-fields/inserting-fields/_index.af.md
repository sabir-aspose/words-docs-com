...
- gebruik [Aspose.Words Dokument Voorwerp Model (DOM)](/words/af/python-net/aspose-words-document-object-model/)
...
U kan ook verskillende soorte velde invoeg met behulp van [Aspose.Words Dokument Voorwerp Model (DOM)](/words/af/python-net/aspose-words-document-object-model/). In hierdie afdeling sal ons kyk na'n paar voorbeelde.
