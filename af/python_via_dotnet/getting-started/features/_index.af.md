...
Ondersteun Linux konfigurasies word aangebied in [Aspose.Words - vir - Python - via-.NET](https://github.com/aspose-words/Aspose.Words-for-Python-via-.NET/blob/master/Dockerfile). As jy ondersteuning vir meer platforms nodig het, soek die" tweelingbroer " - produkte Aspose.Words vir .NET of Aspose.Words vir Java.
...
| Kenmerk | Python via .NET |
| :- | :- |
| Toegang tot en verander alle karakter formatering insluitend lettertipes, kleure, effekte, grense en skadu. | {{< emoticons/tick >}} |
| Toegang tot en verander alle paragraaf formatering insluitend inkeping, spasiëring, grense en skadu, oortjie stop. | {{< emoticons/tick >}} |
| Toegang tot en verander alle bullet en genommerde lyste formatering insluitend nommering en vlakke. | {{< emoticons/tick >}} |
| Toegang tot en verander tabel formatering insluitend belyning, oriëntasie, grense en skadu. | {{< emoticons/tick >}} |
| Toegang tot en verander alle afdeling eienskappe insluitend papier grootte, marges en oriëntasie. | {{< emoticons/tick >}} |
| Toegang, skep en wysig dokumentstyle. | {{< emoticons/tick >}} |
| Toegang en verander tekening voorwerpe insluitend posisie, grootte, lyn en vul eienskappe, beeld grepe. | {{< emoticons/tick >}} |
...
| Kenmerk | Python via .NET |
| :- | :- |
| Gebruik alle standaard Microsoft Word Mail Merge velde in jou verslae insluitend `MERGEFIELD`, `NEXT`, `NEXTIF`, `ADDRESSBLOCK`, GREETINGLINE. | {{< emoticons/tick >}} |
| Voer Mail Merge uit vir dokumente wat selfs die mees komplekse en geneste `IF` velde en formules bevat. | {{< emoticons/tick >}} |
| Vul en dinamies groei tabelle of fragmente in die dokument uit jou databron met behulp van Mail Merge streke. | {{< emoticons/cross >}} |
| Genereer maklik verslae wat meester-detail (ouer-kind) data soos Orde/OrderDetails bevat. | {{< emoticons/cross >}} |
| Vul dokumente in met data van enige .NET databron soos DataSet, DataTable, DataView, DataReader of ADO Rekordstel. | {{< emoticons/cross >}} |
| Vul dokumente van enige databron soos'n LINQ navraag, XML lêer of besigheid voorwerpe deur die implementering van die [IMailMergeDataSource](https://reference.aspose.com/words/python-net/aspose.words.mailmerging/imailmergedatasource/) koppelvlak. | {{< emoticons/cross >}} |
| Neem presiese beheer, soos getalformatering, oor hoe u data saamgevoeg word met behulp van gebeure. | {{< emoticons/cross >}} |
| Voeg beelde in tydens mail merge. | {{< emoticons/tick >}} |
| Programmaties skep of verander'n Microsoft Word Mail Merge databron vir'n dokument. Bewaar Mail Merge instellings en databronne. | {{< emoticons/tick >}} |
| Haal Mail Merge veld name. | {{< emoticons/tick >}} |
...
| :- | :- |
| Ondersteuning van C# sintaksis en LINQ uitbreidingsmetodes direk in sjablone (selfs vir `ADO.NET` databronne) | {{< emoticons/tick >}} |
| Ondersteuning van herhaalbare en voorwaardelike dokumentblokke (lusse en voorwaardes) vir tabelle, lyste en algemene inhoud | {{< emoticons/tick >}} |
| Ondersteuning van dinamiese gegenereerde kaarte en beelde | {{< emoticons/tick >}} |
| Ondersteuning van die invoeging van eksterne dokumente en HTML blokke in'n dokument | {{< emoticons/tick >}} |
| Ondersteuning van verskeie databronne (insluitend van verskillende tipes) vir die opwekking van'n enkele dokument | {{< emoticons/tick >}} |
| Ingeboude ondersteuning van data verhoudings (master-detail) | {{< emoticons/tick >}} |
| Omvattende ondersteuning van verskeie data manipulasies soos groepering, sorteer, filter, en ander direk in templates | {{< emoticons/tick >}} |
