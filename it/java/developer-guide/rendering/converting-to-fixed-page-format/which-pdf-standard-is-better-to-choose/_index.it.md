...
description: "Scegli lo standard PDF migliore per esportare il risultato della tua attività di programmazione in Java. Quale standard PDF è migliore– PDF 1.7, PDF 2.0, PDF/A-1, PDF/A-2, o PDF/UA."
type: docs
weight: 27
...
Aspose.Words PDF 2.0 output permette solo di utilizzare alcune nuove funzionalità, come un nuovo algoritmo di crittografia. Ma ci possono essere difficoltà nella gestione dell'output PDF 2.0 nei vecchi spettatori PDF. Quindi, PDF 2.0 dovrebbe essere usato se sono necessarie nuove funzionalità. In caso contrario, si dovrebbe usare PDF 1.7.
...
È importante notare che l'output PDF/UA-1 sarà anche WCAG 2.0 e conforme alla Sezione 508.
