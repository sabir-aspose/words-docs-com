...
- Un giocatore metafile ([MetafileRenderingOptions](https://reference.aspose.com/words/java/com.aspose.words/fixedpagesaveoptions/). Per maggiori dettagli, vedere il [Gestione dei metafile Windows](/words/it/java/handling-windows-metafiles/) articolo.
