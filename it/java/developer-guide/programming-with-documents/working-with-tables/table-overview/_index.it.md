...
description: "Lavora con le tabelle e i loro componenti come celle, righe, colonne in Aspose.Words per Java. Come lavorare con le tabelle in Java."
type: docs
weight: 10
...
Aspose.Words ha un numero di classi correlate alle tabelle– [Tables](https://reference.aspose.com/words/java/com.aspose.words/table/), [Rows](https://reference.aspose.com/words/java/com.aspose.words/row/), [Cells](https://reference.aspose.com/words/java/com.aspose.words/cell/), e altri.

## Vedi anche

* [Aspose.Words Modello oggetto documento (DOM)](/words/it/java/aspose-words-document-object-model/)
