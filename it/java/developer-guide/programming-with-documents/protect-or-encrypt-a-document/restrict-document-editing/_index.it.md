---
title: Limita la modifica del documento in Java
second_title: Aspose.Words per Java
articleTitle: Limita la modifica dei documenti
linktitle: Limita la modifica dei documenti
description: "Limitare la modifica di un documento impostando un tipo di restrizione. Puoi anche rimuovere la protezione e rendere le regioni modificabili senza restrizioni usando Java."
type: docs
weight: 30
...
Aspose.Words consente di controllare il modo in cui si limita il contenuto utilizzando il parametro di enumerazione [ProtectionType](https://reference.aspose.com/words/java/com.aspose.words/protectiontype/). Ciò consentirà di selezionare un tipo esatto di protezione come il seguente:
...
Aspose.Words consente di proteggere i documenti dalle modifiche utilizzando il metodo [Protect](https://reference.aspose.com/words/java/com.aspose.words/document/#protect-int). Questo metodo non è una funzione di sicurezza e non crittografa un documento.
