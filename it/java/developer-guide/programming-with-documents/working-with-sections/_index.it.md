...
description: "Comprensione dei concetti della sezione del documento e delle pratiche di manipolazione utilizzando Java. Inserire una sezione in un documento Java. Rimuovi sezione Java. Copiare sezioni tra i documenti."
type: docs
weight: 120
...
Aspose.Words consente di dividere e formattare i documenti utilizzando diverse interruzioni di sezione dell'enumerazione [BreakType](https://reference.aspose.com/words/java/com.aspose.words/breaktype/):
...
È inoltre possibile utilizzare l'enumerazione [SectionStart](https://reference.aspose.com/words/java/com.aspose.words/sectionstart/) per scegliere un tipo di interruzione che si applica solo alla prima sezione, ad esempio NewColumn, NewPage, EvenPage, e OddPage.
...
Aspose.Words consente di inserire un'interruzione di sezione nel testo utilizzando il metodo [InsertBreak](https://reference.aspose.com/words/java/com.aspose.words/documentbuilder/#insertBreak-int).
...
Utilizzare il metodo [Remove](https://reference.aspose.com/words/java/com.aspose.words/node/#remove) per eliminare un'interruzione di sezione. Se non è necessario rimuovere un'interruzione di sezione specifica e invece eliminare il contenuto di quella sezione, è possibile utilizzare il metodo [ClearContent](https://reference.aspose.com/words/java/com.aspose.words/section/#clearContent).
...
Aspose.Words consente di duplicare una sezione creandone una copia completa utilizzando il metodo [deepClone](https://reference.aspose.com/words/java/com.aspose.words/section/#deepClone).
...
Aspose.Words consente di copiare sezioni tra documenti utilizzando il metodo [ImportNode](https://reference.aspose.com/words/java/com.aspose.words/documentbase/#importNode-com.aspose.words.Node-boolean).
...
Se si desidera rimuovere il testo di intestazioni e piè di pagina senza rimuovere gli oggetti [HeaderFooter](https://reference.aspose.com/words/java/com.aspose.words/headerfooter/) nel documento, è possibile utilizzare il metodo [ClearHeadersFooters](https://reference.aspose.com/words/java/com.aspose.words/section/#clearHeadersFooters). Inoltre, è possibile utilizzare il metodo [DeleteHeaderFooterShapes](https://reference.aspose.com/words/java/com.aspose.words/section/#deleteHeaderFooterShapes) per rimuovere tutte le forme da intestazioni e piè di pagina nel documento.
...
Aspose.Words consente di personalizzare le proprietà di pagina e sezione utilizzando la classe [PageSetup](https://reference.aspose.com/words/java/com.aspose.words/pagesetup/).
