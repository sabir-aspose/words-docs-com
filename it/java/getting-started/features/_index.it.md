...
description: "Aspose.Words per Java offre agli utenti una vasta gamma di funzionalità, dalla semplice conversione e modifica di documenti alla creazione di documenti strutturati e visivamente accattivanti o all'automazione dei report."
type: docs
weight: 40
...
La maggior parte degli screenshot in questa sezione mostra i documenti generati da Aspose.Words e quindi aperti per la visualizzazione in Microsoft Word e altre applicazioni.
...
| :- | :- |
| [Java](/words/java/supported-platforms/) | Aspose.Words per Java è disponibile per Java 1.6, 1.7 e 1.8 e verrà eseguito in qualsiasi luogo in cui è installato Java. |

## Formati di file e conversioni

{{% alert color="primary" %}}

Molti clienti in tutto il mondo si affidano alle funzionalità complete di importazione ed esportazione dei documenti fornite da Aspose.Words.

{{% /alert %}}

| Caratteristica | Descrizione |
| :- | :- |
| Microsoft Word (DOC) ([carico](/words/java/load-in-ms-word-97-2003-formats/) e [salvare](/words/java/save-in-ms-word-97-2003-formats/)) | L'implementazione del formato DOC più veloce e completa che puoi trovare. |
| WordprocessingML (DOCX, XML) ([carico](/words/java/load-in-the-open-office-xml-2007-and-2010-formats/) e [salvare](/words/java/save-in-the-open-office-xml-docx-dotx-docm-dotm-format/)) | Aspose.Words fornisce un supporto completo OOXML, Flat OPC e anche Word 2003 XML. |
| Formato RTF (RTF) ([carico](/words/java/load-in-the-rich-text-format-1-9-rtf-format/) e [salvare](/words/java/save-in-the-rich-text-format-1-9-rtf-format/)) | Supporto completo del formato RTF per interagire con una varietà di applicazioni. |
| HTML, XHTML e MHTML | [Carico](/words/java/load-in-the-html-html-xhtml-mhtml-format/) e [salvare](/words/java/save-in-the-html-html-xhtml-mhtml-format/) HTML/XHTML per una maggiore interoperabilità. È disponibile anche Salva come MHTML. |
| OpenDocument (ODT) | Aspose.Words può [carico](/words/java/load-in-the-opendocument-text-odt-ott-format/) e [salvare](/words/java/save-in-the-opendocument-text-odt-ott-format/) documenti nel testo `OpenDocument` (.formato odt). |
...
| XML Specificazione di carta (XPS) ([carico](/words/java/load-in-ms-word-2003-formats/) e [salvare](/words/java/save-in-the-flatopc-ooxml-document-xml-format/)) | Converti qualsiasi documento in XPS con alta fedeltà. |
| Testo normale (TXT) ([carico](/words/java/load-in-the-plain-text-txt-format/) e [salvare](/words/java/save-in-the-plain-text-txt-format/)) | Estrarre facilmente il testo salvando in formato testo normale. |
| [Editoria digitale (EPUB)](/words/java/save-in-the-idpf-epub-document-epub-format/) | EPUB è un formato popolare per eBooks. È possibile convertire qualsiasi documento da Aspose.Words al formato IDPF EPUB. |
