...
Aspose.Wordsper C++ supporta sia Fluente che non fluente APIs, consentendo agli sviluppatori di scegliere lo stile che meglio si adatta alle loro preferenze di codifica e alle esigenze del progetto. Diamo un'occhiata ad alcuni esempi per vedere come questi due tipi di API differiscono.
...
Per esplorare opzioni più avanzate, è sempre possibile combinare LowCode APIs con il modello a oggetti completo Aspose.Words. Vedi altri esempi Low Code nel [API documentation](https://reference.aspose.com/words/cpp/aspose.words.lowcode/).