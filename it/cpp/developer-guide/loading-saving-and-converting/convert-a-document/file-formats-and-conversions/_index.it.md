...
linktitle: La conversione è Aspose.Words ' Flagship Feature
description: "Converti documenti da qualsiasi carico supportato per salvare il formato con solo due righe di codice C++. Fornisce conversioni di alta qualità."
type: docs
weight: 50
...
Per ulteriori dettagli sul caricamento, la conversione e il salvataggio dei documenti, vedere [Caricamento, salvataggio e conversione](/words/it/cpp/loading-saving-and-converting/) sezione.
...
Si noti che in tali situazioni, Aspose.Words ha la conversione contrassegnata come "alta fedeltà" e il documento di output sarà lo stesso dopo la conversione tramite Microsoft Word.
