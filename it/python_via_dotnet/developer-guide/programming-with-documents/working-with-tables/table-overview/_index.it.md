...
description: "Lavora con tabelle e i loro componenti come celle, righe, colonne in Aspose.Words per Python. Come lavorare con le tabelle in Python."
type: docs
weight: 10
...
In Aspose.Words, tutte le classi e le proprietà relative alle tabelle sono contenute nel modulo [Aspose.Words.Tables](https://reference.aspose.com/words/python-net/aspose.words.tables/).

## Guarda anche

* [Aspose.Words Document Object Model (DOM)](/words/it/python-net/aspose-words-document-object-model/)
* [Livelli logici dei nodi in un documento](/words/it/python-net/logical-levels-of-nodes-in-a-document/)
