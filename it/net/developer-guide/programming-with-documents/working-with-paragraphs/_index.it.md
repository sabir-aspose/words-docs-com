...
Aspose.Words espone la proprietà pubblica [BreakIsStyleSeparator](https://reference.aspose.com/words/it/net/aspose.words/paragraph/breakisstyleseparator/) sulla classe `Paragraph` per identificare un paragrafo con un separatore di stile, come mostrato nell'esempio seguente:
