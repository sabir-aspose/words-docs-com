...
La scheda Tipografia asiatica della finestra di dialogo delle proprietà del paragrafo in Microsoft Word ha un gruppo di interruzioni di riga. Le opzioni di questo gruppo possono essere impostate utilizzando le proprietà [FarEastLineBreakControl](https://reference.aspose.com/words/it/net/aspose.words/paragraphformat/fareastlinebreakcontrol/), [WordWrap](https://reference.aspose.com/words/it/net/aspose.words/paragraphformat/wordwrap/), [HangingPunctuation](https://reference.aspose.com/words/it/net/aspose.words/paragraphformat/hangingpunctuation/) della classe **ParagraphFormat**.
