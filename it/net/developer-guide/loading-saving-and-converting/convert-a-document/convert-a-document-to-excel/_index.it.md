...
La conversione di documenti da un formato all'altro è la caratteristica principale di Aspose.Words. Puoi convertire documenti in qualsiasi formato [caricare il formato](https://reference.aspose.com/words/it/net/aspose.words/loadformat/) disponibile anche nel formato XLSX.

## Converti un documento in XLSX

Convertire un documento in XLSX è un processo piuttosto complicato. Per salvare il documento in formato XLSX utilizzando Aspose.Words, utilizza la classe [XlsxSaveOptions](https://reference.aspose.com/words/it/net/aspose.words.saving/xlsxsaveoptions/) e il nuovo elemento `Xlsx` nell'enumerazione [SaveFormat](https://reference.aspose.com/words/it/net/aspose.words/saveformat/). Come accennato in precedenza, puoi salvare il documento in qualsiasi formato di caricamento supportato da Aspose.Words a XLSX.
...
È inoltre possibile specificare il livello di compressione durante il salvataggio utilizzando la proprietà [CompressionLevel](https://reference.aspose.com/words/it/net/aspose.words.saving/xlsxsaveoptions/compressionlevel/).
