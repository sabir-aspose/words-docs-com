...
description: "Converti in PDF/A-1, PDF/A-2, PDF/A-4 e PDF/UA utilizzando C#. Scegli il miglior standard PDF per convertire un documento utilizzando C#."
type: docs
weight: 25
...
Il PDF è un formato complesso di per sé, poiché ha una struttura di file specifica, un modello grafico, l'incorporamento di caratteri e alcune funzionalità di output complesse come tag della struttura del documento, crittografia, firme digitali e moduli modificabili. Inoltre, la conversione di un documento in PDF richiede diverse fasi di calcolo, complesse e dispendiose in termini di tempo.

Nei seguenti articoli considereremo i principali problemi che possono sorgere quando si lavora con documenti in vari standard PDF e descriveremo le opzioni per risolverli.
...
* [Converti un documento in PDF](/words/it/net/convert-a-document-to-pdf/)
