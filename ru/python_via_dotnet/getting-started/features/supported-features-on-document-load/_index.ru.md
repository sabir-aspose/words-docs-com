...
Дополнительную информацию и описание функций, доступных для различных форматов, смотрите в разделе [Поддерживаемые функции при загрузке документа](/words/ru/net/supported-features-on-document-load/) в документации Aspose.Words для .NET.
