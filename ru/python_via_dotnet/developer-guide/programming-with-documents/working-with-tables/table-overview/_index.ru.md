...
description: "Работайте с таблицами и их компонентами, такими как ячейки, строки, столбцы, в Aspose.Words для Python. Как работать с таблицами в Python."
type: docs
weight: 10
...
В Aspose.Words все классы и свойства, относящиеся к таблицам, содержатся в модуле [Aspose.Words.Tables](https://reference.aspose.com/words/python-net/aspose.words.tables/).
