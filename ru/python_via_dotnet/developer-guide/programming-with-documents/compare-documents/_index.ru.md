...
Обратите внимание, что вы можете сравнить любые два документа в рамках [поддерживаемые форматы файлов](/words/ru/python-net/supported-document-formats/). В принципе, вы можете сравнивать объекты документа и даже создавать эти объекты с нуля, не имея какого-либо определенного формата.
