...
- Проигрыватель метафайлов ([metafile_rendering_options](https://reference.aspose.com/words/python-net/aspose.words.saving/fixedpagesaveoptions/metafile_rendering_options/)). Более подробную информацию смотрите в разделе [Обработка Windows метафайлов](/words/ru/python-net/handling-windows-metafiles/) статья.
