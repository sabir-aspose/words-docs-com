...
- Раздел документации [Защита или шифрование документа](/words/ru/python-net/protect-or-encrypt-a-document/) для получения дополнительной информации о защите и шифровании документа
- Статья [Найдите и замените](/words/ru/python-net/find-and-replace/) для получения дополнительной информации о поиске и замене нужного вам контента
