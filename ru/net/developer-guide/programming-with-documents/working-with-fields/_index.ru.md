...
В Aspose.Words Поля представляют собой [Fields](https://reference.aspose.com/words/net/aspose.words.fields/) пространство имен. Статьи в этом разделе документации объясняют, как использовать Aspose.Words классы для программного манипулирования полями документов.
