...
|  -------------------------------  |  ------------------------------  |  ------------------------------------------------------------  |
|  Только для чтения |  "Сделать документ доступным только для чтения" |  Всегда открывайте только чтение (файл → информация → документ защиты)<br/>Альтернативная функция: "Пароль для изменения" (Сохранить как → Инструменты → Общие опции → Пароль) |
