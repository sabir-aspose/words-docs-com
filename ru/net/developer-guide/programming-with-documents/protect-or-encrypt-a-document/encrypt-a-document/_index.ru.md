...
description: "Шифруйте ваш документ, используя соответствующие алгоритмы шифрования для конкретных форматов документов. C#."
type: docs
weight: 20
...
Вы можете найти подходящий **Password** собственности в требуемом формате. Каждый документ сохраняет формат в [Сохранение пространства имен](https://reference.aspose.com/words/net/aspose.words.saving/) имеет соответствующий класс, содержащий варианты сохранения для данного формата. Например, в [Password](https://reference.aspose.com/words/net/aspose.words.saving/docsaveoptions/password/) имуществом в [DocSaveOptions](https://reference.aspose.com/words/net/aspose.words.saving/docsaveoptions/) Класс для DOC, или [Password](https://reference.aspose.com/words/net/aspose.words.saving/ooxmlsaveoptions/password/) имуществом в [OoxmlSaveOptions](https://reference.aspose.com/words/net/aspose.words.saving/ooxmlsaveoptions/) класс для DOCX, DOCM, DOTX, DOTM и FlatOpc.
...
Чтобы определить, зашифрован ли документ и нужен ли пароль, вы можете использовать [IsEncrypted](https://reference.aspose.com/words/net/aspose.words/fileformatinfo/isencrypted/) имуществом, [FileFormatInfo](https://reference.aspose.com/words/net/aspose.words/fileformatinfo/) класс. Это свойство также позволит вам выполнить некоторые действия перед загрузкой документа, например, сообщить пользователю предоставить пароль.
