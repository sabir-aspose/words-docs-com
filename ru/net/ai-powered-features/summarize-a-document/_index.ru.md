...
type: docs
weight: 20
description: "Обобщите документ. Aspose.Words для .NET упрощает обобщение документа с помощью моделей OpenAI и Google AI, позволяя указать длину резюме."
