...
Обычно достаточно применить дозированную лицензию один раз при запуске приложения. Однако, если механизм дозированного лицензирования не сможет связаться с серверами Aspose в течение 24 часов, Aspose.Words выйдет из лицензионного режима и переключится в ознакомительный режим. Чтобы избежать такого случая, вы можете использовать метод [IsMeteredLicensed](https://reference.aspose.com/words/java/com.aspose.words/metered/#isMeteredLicensed) для проверки статуса лицензии и при необходимости повторно применить дозированную лицензию.
