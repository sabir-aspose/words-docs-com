...
Если результаты вашего профилирования указывают на возможную проблему с памятью в Aspose.Words, пожалуйста, свяжитесь с нашим [Команда поддержки](/words/ru/java/technical-support/) и включите всю диагностическую информацию.

## Смотрите также

* [Визуализация](/words/ru/java/rendering/)
* [Mail Merge и отчетность](/words/ru/java/mail-merge-and-reporting/)
