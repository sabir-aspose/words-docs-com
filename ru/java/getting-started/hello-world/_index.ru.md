...
Библиотека "Aspose.Words для Java" предоставляет разработчикам прямой доступ к созданию, изменению, объединению, конвертации, сравнению документов Word и Web. PDF, DOCX, DOC, RTF, ODT, EPUB, HTML и многие другие форматы файлов являются [поддерживаемый](/words/ru/java/supported-document-formats/).
