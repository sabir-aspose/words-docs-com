...
Узнать более подробно о бесплатной пробной или временной лицензии на Aspose.Words на Android через Java на [на странице лицензирования и подписку](/words/ru/java/licensing/).
...
В Aspose.Words для Android и Java лицензия может быть [встроена как ресурс](/words/ru/java/licensing/) или загружена из потока:
