...
description: "Работайте с таблицами и их компонентами, такими как ячейки, строки, столбцы, в Aspose.Words для Java. Как работать с таблицами в Java."
type: docs
weight: 10
...
Aspose.Words имеет ряд классов, связанных с таблицами – [Tables](https://reference.aspose.com/words/java/com.aspose.words/table/), [Rows](https://reference.aspose.com/words/java/com.aspose.words/row/), [Cells](https://reference.aspose.com/words/java/com.aspose.words/cell/), и другими.
