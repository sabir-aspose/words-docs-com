...
- Проигрыватель метафайлов ([MetafileRenderingOptions](https://reference.aspose.com/words/java/com.aspose.words/fixedpagesaveoptions/). Более подробную информацию смотрите в разделе [Обработка Windows метафайлов](/words/ru/java/handling-windows-metafiles/) статья.
