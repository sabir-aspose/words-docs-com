...
Если вы не нашли ответа на свой вопрос, вы можете задать его на форуме поддержки. Информацию о том, как правильно сообщить о своем вопросе или проблеме, смотрите в разделе [техническая поддержка](/words/ru/java/technical-support/) страница.
...
Aspose.Words для работы Java не требуется устанавливать какие-либо сторонние приложения или дополнительные пакеты программного обеспечения. Просто скачайте и установите Aspose.Words, как описано в [Установка](/words/ru/java/installation/) напишите статью и приступайте к работе.
...
Для получения более подробной информации смотрите [Обзор продукта](/words/ru/java/product-overview/) страница и весь [Платформы и Interop гибкость](/words/java/platforms-and-interoperability/) раздел.
...
Вы можете ознакомиться с полным списком поддерживаемых форматов на странице [Поддерживаемые форматы документов](/words/ru/java/supported-document-formats/) страница.
...
Дополнительную информацию смотрите на странице [Лицензирование и подписка](/words/ru/java/licensing/).
...
После приобретения, обратиться за лицензией как описано в [Лицензии](/words/ru/java/licensing/) раздел.

Подробную информацию о том, как установить Aspose.Words, можно прочитать на сайте [Установка](/words/ru/java/installation/) страница.

------

**Вопрос: Как я могу получить поддержку?**

Воспользуйтесь бесплатным форумом технической поддержки. Подробную информацию о том, как правильно сообщить о проблеме и что необходимо сделать, прежде чем обращаться на форум, смотрите в [техническая поддержка](/words/ru/java/technical-support/) страница.

## Рендеринг документа

{{% alert color="primary" %}}

Более подробную информацию о рендеринге вы можете найти в разделе [Визуализация](/words/ru/java/rendering/) раздел документации.

{{% /alert %}}

**Вопрос: Почему макет и шрифты в выходном документе отличаются от оригинала?**

Шрифт может не быть в наличии, или в форме шрифта поддерживается Microsoft Word, но не поддерживаемые Aspose.Words. Aspose.Words будет выполнять [подстановка шрифтов](/words/ru/java/manipulate-and-substitute-truetype-fonts/).

Чтобы проверить, не отсутствует ли шрифт:

- В Aspose.Words используйте предупреждения о замене шрифта (подробнее смотрите раздел "Как распознать, что шрифт был заменен" в статье [Манипулирование и замена шрифтов TrueType](/words/ru/java/manipulate-and-substitute-truetype-fonts/) ).
...
Вы можете найти более подробную информацию о Mail Merge в разделе документации [Mail Merge и отчетности](/words/ru/java/mail-merge-and-reporting/).
...
- Ознакомьтесь с разделом "Как настроить связи данных во вложенных Mail Merge с регионами" в статье [Вложенные Mail Merge с регионами](/words/ru/java/nested-mail-merge-with-regions/).
...
Вы можете найти более подробную информацию о программировании с использованием документов в разделе [Программирование с использованием документов](/words/ru/java/programming-with-documents/) документация.
...
Вы можете найти более подробную информацию о преобразовании документа в разделе [Преобразование документа](/words/ru/java/convert-a-document/) документация.
...
Подробный ответ вы найдете в статье [Печать документа программным способом или с помощью диалоговых окон](/words/ru/java/print-a-document-programmatically-or-using-dialogs/).
