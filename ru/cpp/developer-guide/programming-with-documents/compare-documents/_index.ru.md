...
Обратите внимание, что вы можете сравнить любые два документа в рамках [поддерживаемые форматы файлов](/words/ru/cpp/supported-document-formats/) Вы можете сравнивать объекты документа и даже создавать эти объекты с нуля, не имея какого-либо определенного формата.
