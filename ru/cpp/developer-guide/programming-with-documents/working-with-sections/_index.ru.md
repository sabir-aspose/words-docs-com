...
Поскольку раздел является обычным составным узлом, для управления разделами можно использовать весь API управления узлами: добавлять, удалять и выполнять другие операции с разделами. Подробнее об узлах вы можете прочитать в статье [Aspose.Words Объектная модель документа (DOM).](/words/ru/cpp/aspose-words-document-object-model/).
...
- [Вставка и добавление документов](/words/ru/cpp/insert-and-append-documents/)
