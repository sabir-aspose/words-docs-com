...
description: "Работа с частями таблицы – строками, столбцами и ячейками с использованием C++. Укажите строку заголовка на C++."
type: docs
weight: 30
...
### Найдите индекс ячейки в строке {#find-the-index-of-a-cell-in-a-row}
...
В объектной модели документа Aspose.Words (DOM) узел [Table](https://reference.aspose.com/words/cpp/aspose.words.tables/table/) состоит из [Row](https://reference.aspose.com/words/cpp/aspose.words.tables/row/) узлов, а затем из [Cell](https://reference.aspose.com/words/cpp/aspose.words.tables/cell/) узлов. Таким образом, в объектной модели документа Aspose.Words, как и в документах Word, отсутствует понятие столбца.
...
Обратите внимание, что строки заголовка не работают во вложенных таблицах. То есть, если у вас есть таблица внутри другой таблицы, эта настройка не будет иметь эффекта. Это ограничение Microsoft Word, которое не допускает этого, а не Aspose.Words.
...
Это включает в себя ограничение разбиения содержимого внутри ячеек строки на страницы. В Microsoft Word это можно найти в разделе "Свойства таблицы" в качестве опции "Разрешить разбиение строки на страницы". В Aspose.Words это находится в [RowFormat](hhttps://reference.aspose.com/words/cpp/aspose.words.tables/rowformat/) объекте [Row](https://reference.aspose.com/words/cpp/aspose.words.tables/row/) как свойство [RowFormat.AllowBreakAcrossPages](https://reference.aspose.com/words/cpp/aspose.words.tables/rowformat/get_allowbreakacrosspages/).
...
Для этого в Aspose.Words используется метод, который позволяет пользователям выбирать таблицу и устанавливать для параметра [KeepWithNext](https://reference.aspose.com/words/cpp/aspose.words/paragraphformat/get_keepwithnext/) значение true для каждого абзаца в ячейках таблицы. Исключением является последний абзац в таблице, для которого должно быть установлено значение false.
