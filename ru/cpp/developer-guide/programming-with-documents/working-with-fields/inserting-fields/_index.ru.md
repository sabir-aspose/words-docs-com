...
- с помощью [Aspose.Words Объектная модель документа (DOM)](/words/ru/cpp/aspose-words-document-object-model/)
...
Вы также можете вставлять поля различных типов, используя [Aspose.Words Объектную модель документа (DOM)](/words/ru/cpp/aspose-words-document-object-model/). В этом разделе мы рассмотрим несколько примеров.
