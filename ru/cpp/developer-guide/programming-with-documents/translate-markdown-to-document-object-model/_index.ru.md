...
В отличие от документов Word, Markdown не соответствует DOM, описанному в статье [Aspose.Words Объектной модели документа (DOM)](/words/ru/cpp/aspose-words-document-object-model/). Однако Aspose.Words предоставляет свой собственный механизм для перевода Markdown документов в DOM и обратно, так что мы можем успешно работать с их элементами, такими как форматирование текста, таблицы, заголовки и другие.
