...
Используя Aspose.Words, вы можете преобразовать документ из любого поддерживаемого формата загрузки в любой поддерживаемый формат сохранения, например, из форматов Word в PDF, HTML или Markdown, HTML в DOCX и т.д. Подробнее о преобразовании документов читайте в разделе [Преобразовать документ](/words/ru/cpp/convert-a-document/) раздел.
...
Всесторонний [импорт и экспорт документов](/words/ru/cpp/loading-saving-and-converting/) с [поддерживается более 35 форматов файлов](/words/ru/cpp/supported-document-formats/) позволяет пользователям конвертировать документы из [one popular format](https://reference.aspose.com/words/cpp/aspose.words/loadformat/) в [another](https://reference.aspose.com/words/cpp/aspose.words/saveformat/), например, из DOCX в PDF, JPEG или Markdown.

#### Объектная модель документа (DOM)

Программный доступ через расширенный API ко всем элементам документа и его форматированию позволяет создавать, изменять, извлекать, копировать, разделять, объединять и заменять содержимое документа. Подробнее читайте в разделе [Aspose.Words Объектная модель документа (DOM).](/words/ru/cpp/aspose-words-document-object-model/) раздел.

#### Визуализация

Мы используем термин [Рендеринг в Aspose.Words](/words/ru/cpp/rendering/) для описания процесса преобразования документа в формат файла или носителя, разбитый на страницы или имеющий концепцию страниц.
...
Создавайте документы или отчеты с нуля или путем заполнения шаблонов данными из источников данных или бизнес-объектов. Дополнительные сведения о создании отчетов и извлечении данных из баз данных см. в разделе [Mail Merge и отчеты](/words/ru/cpp/mail-merge-and-reporting/).
...
Пожалуйста, посетите страницу [Лицензирование](/words/ru/cpp/licensing/) для получения информации о лицензиях и ознакомьтесь со страницей [Информация о ценах](https://purchase.aspose.com/pricing/words/family/) для получения подробной информации о ценах.

## Техническая поддержка

Для более подробной информации Aspose.Words техническую поддержку, взгляните на [страница поддержки ](/words/ru/cpp/technical-support/).
