...
- В примерах **API Reference** структура основана на именах классов, в примерах **Docs** она в основном основана на [Разработчик обманут](/words/ru/cpp/developer-guide/) раздел документации.
