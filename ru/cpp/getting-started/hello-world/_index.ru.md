...
"Aspose.Words для C++" библиотека предоставляет разработчикам прямой доступ к созданию, изменению, объединению, конвертации, сравнению документов Word и Web. PDF, DOCX, DOC, RTF, ODT, EPUB, HTML и многим другим форматам файлов доступны [поддерживаемый](/words/ru/cpp/supported-document-formats/).
