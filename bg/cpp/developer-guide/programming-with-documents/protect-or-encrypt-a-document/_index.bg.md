...
| ------------------------------- | ------------------------------ | ------------------------------------------------------------ |
| Само За Четене | "Направете документ само за четене" | Винаги Отваряйте Само За Четене (Файл → Информация → Защитен Документ)<br />Алтернативна функция: "парола за промяна" (Запазване като → Инструменти → Общи Опции → парола) |
