...
Имайте предвид, че можете да сравните всеки два документа в рамките на [поддържани файлови формати](/words/bg/cpp/supported-document-formats/). Можете да сравнявате обекти на документи и дори можете да създадете тези обекти от нулата, без да имате конкретен формат.
