...
Ако не сте намерили отговор на въпроса си, можете да попитате във форума за поддръжка. За информация как правилно да съобщите за вашия въпрос или проблем, вижте [Техническа Поддръжка](/words/bg/cpp/technical-support/) Пейдж.
...
Aspose.Words за C++ не е необходимо да инсталирате приложения на трети страни или допълнителни софтуерни пакети, за да работят. Просто изтеглете и инсталирайте Aspose.Words, както е описано в ["Инсталация"](/words/bg/cpp/installation/) статия и да започнете.
...
За подробности вижте [Преглед На Продукта](/words/bg/cpp/product-overview/) Пейдж.
...
Можете да видите пълния списък на поддържаните формати на [Поддържани Формати На Документи](/words/bg/cpp/supported-document-formats/) Пейдж.
...
Вижте [Лицензиране и абонамент](/words/bg/cpp/licensing/) страница за повече информация.
...
След закупуване, да кандидатства за лиценз, както е описано в [Закупен Лиценз](/words/bg/cpp/licensing/) отдел.

Подробности за това как да инсталирате Aspose.Words можете да прочетете на [Инсталация](/words/bg/cpp/installation/) Пейдж.

------

**В: Как мога да получа подкрепа?**

Използвайте безплатния форум за техническа поддръжка. За подробности как правилно да съобщите за проблем и какво трябва да се направи, преди да се свържете с форума, вижте [Техническа Поддръжка](/words/bg/cpp/technical-support/) Пейдж.

## Представяне на документ

{{% alert color="primary" %}}

Можете да намерите по-подробна информация за рендерирането в [Рендериране](/words/bg/cpp/rendering/) раздел документация.

{{% /alert %}}

**В: защо оформлението и шрифтовете в изходния документ се различават от оригинала?**

Шрифтът може да не е наличен или форматът на шрифта да се поддържа от Microsoft Word, но да не се поддържа от Aspose.Words. Aspose.Words ще изпълнява [заместване на шрифта](/words/bg/cpp/manipulate-and-substitute-truetype-fonts/).

За да проверите дали шрифтът липсва:

- В Aspose.Words Използвайте предупрежденията за заместване на шрифта (за подробности вижте раздела "Как да разпознаете, че шрифтът е заменен" на [Манипулира и замества TrueType шрифтове](/words/bg/cpp/manipulate-and-substitute-truetype-fonts/) член).
...
Можете да намерите по-подробна информация за програмирането с документи в [Програмиране с документи](/words/bg/cpp/programming-with-documents/) раздел документация.
...
Можете да намерите по-подробна информация за конвертирането на документ в [Конвертиране на документ](/words/bg/cpp/convert-a-document/) раздел документация.
