...
type: docs
weight: 10
description: "Aspose.Words за C++ поддържа OpenAI и Гугъл AI модели за обобщаване и превод на документи. Използвайте Aspose.Words с Gpt-4o, Gpt-4o мини, Gpt-4 турбо, GPT-3.5 турбо, Gemini 1.5 Flash, Gemini 1.5 Flash - 8Б, Gemini 1.5 про."
ai_search_scope: words_cpp
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
ai_search_fast_endpoint: "https://docsearch.api.aspose.cloud/search"
url: /bg/cpp/supported-ai-models/
...
За повече информация вижте документацията [Aspose.Words.AI](https://reference.aspose.com/words/cpp/aspose.words.ai/) API.
