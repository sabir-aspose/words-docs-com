...
Библиотеката" Aspose.Words за C++ " дава на разработчиците директен достъп за създаване, модифициране, обединяване, конвертиране, сравняване Word и уеб документи. PDF, DOCX, DOC, RTF, ODT, EPUB, HTML и много други файлови формати са [поддържа](/words/bg/cpp/supported-document-formats/).
