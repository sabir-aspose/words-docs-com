...
- За **API Reference** примери структурата се основава на имената на класовете, за **Docs** примери се основава най-вече на имената на класовете. [Разработчик Виновен](/words/bg/cpp/developer-guide/) раздел документация.
