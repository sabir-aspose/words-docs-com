...
След закупуване, кандидатстват за лиценз, както е описано в [Закупен лиценз](/words/bg/java/licensing/) Секция.
...
Можете да намерите по-подробна информация за Mail Merge в [Mail Merge и докладване](/words/bg/java/mail-merge-and-reporting/) раздел за документация.
...
- Проверете секцията "Как да създадем връзки с данни в Нестед" Mail Merge с региони в статията [Гнездо Mail Merge с региони](/words/bg/java/nested-mail-merge-with-regions/).
