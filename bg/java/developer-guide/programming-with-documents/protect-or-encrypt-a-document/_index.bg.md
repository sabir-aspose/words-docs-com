...
|  -------------------------------  |  ------------------------------  |  ------------------------------------------------------------  |
|  Само за четене |  Направете документ само за четене |  Винаги отваряйте само за четене (Архив → Информация → Защита на документ)<br/>Алтернативна функция: "Парола за промяна" (Запази като → Инструменти → Общи опции → Парола) |
