...
Първото обаждане [Document.updateFields()](https://reference.aspose.com/words/java/com.aspose.words/document/#updateFields) ще изгради `TOC` Всички текстови записи са населени и `TOC` Изглежда почти завършен. Единственото нещо, което липсва, е номерата на страниците, които засега се показват с гол?.
