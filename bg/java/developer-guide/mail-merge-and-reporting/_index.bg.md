---
title: Mail Merge и докладване в Java
second_title: Aspose.Words за Java
articleTitle: Mail Merge и докладване
linktitle: Mail Merge и докладване
type: docs
description: "Mail Merge е популярна функция за бързо създаване на документи. Aspose.Words за Java взема стандартната Mail Merge функционалност и я напредва много стъпки напред, превръщайки я в пълноценно решение за отчитане, което ви позволява да създавате още по-сложни документи като отчети, каталози, запаси и фактури."
keywords: "how to use Mail Merge Java"
weight: 40
ai_search_scope: words_java
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
ai_search_fast_endpoint: "https://docsearch.api.aspose.cloud/search"
url: /bg/java/mail-merge-and-reporting/
...
Можете да изтеглите примерния файл на този пример от [Aspose.Words GitHub](https://github.com/aspose-words/Aspose.Words-for-Java/blob/master/Examples/Data/Mail%20merge%20destinations%20-%20Orders.docx).
