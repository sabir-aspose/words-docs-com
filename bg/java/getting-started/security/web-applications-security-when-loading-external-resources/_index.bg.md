...
За да решите проблемите, описани по-горе, и да подобрите сигурността на уеб приложенията, можете да контролирате или деактивирате зареждането на външни ресурси с помощта на [IResourceLoadingCallback](https://reference.aspose.com/words/java/com.aspose.words/iresourceloadingcallback/).
...
Тази статия се основава на консултантската фирма Независими охранителни оценители [Доклад](/words/java/web-applications-security-when-loading-external-resources/ise-aspose-report.pdf).
