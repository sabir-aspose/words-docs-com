---
title: Работа с Smart Art Cold Rendering in C#
second_title: Aspose.Words вместо .NET
articleTitle: Работа с Smart Art Cold Rendering
linktitle: Работа с Smart Art Cold Rendering
description: "Въведение в Smart Художествени форми, използващи C#."
type: docs
...
* Ако предварително нарисувана рисунка присъства, но е неточна, тя е длъжна да извърши SmartArt студено предаване изрично чрез призоваване [UpdateSmartArtDrawing](https://reference.aspose.com/words/net/aspose.words.drawing/shape/updatesmartartdrawing/) метод.
