...
В Aspose.Words полетата са представени от [Fields](https://reference.aspose.com/words/net/aspose.words.fields/) пространство за имена. Членове в настоящия раздел за документация обясняват как да се използва Aspose.Words класове, за да се манипулира документ полета programmically.
