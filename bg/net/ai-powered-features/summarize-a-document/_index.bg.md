...
type: docs
weight: 20
description: "Обобщете документ. Aspose.Words за .NET опростява обобщаването на документи, използвайки модели OpenAI и Гугъл AI, като ви позволява да зададете дължината на резюмето."
