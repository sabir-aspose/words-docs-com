---
title: Замяна на вярно Тип шрифтове
...
description: "Aspose.Words вместо Python via .NET може да включи правилните шрифтове TrueType в получения документ, за да се гарантира, че той показва точно. Ако няма шрифт или специфичен символ, Aspose.Words търсене на подходящ заместител на шрифта или използване на механизма за изтегляне на шрифта."
type: docs
weight: 10
ai_search_scope: words_python
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
ai_search_fast_endpoint: "https://docsearch.api.aspose.cloud/search"
url: /bg/python-net/manipulating-and-substitution-truetype-fonts/
...
Всички налични механизми за манипулиране на шрифта се съдържат в [FontSettings](https://reference.aspose.com/words/python-net/aspose.words.fonts/fontsettings/) Клас. Този клас отговаря за извличането на шрифтове в рамките на определени източници на шрифт, както и за процеса на заместване на шрифта, както е описано по-долу.
...
Тъй като описаната по-горе процедура отнема време, тя може да повлияе отрицателно на ефективността на приложението при първото му пускане. Но всеки случай на [FontSettings](https://reference.aspose.com/words/python-net/aspose.words.fonts/fontsettings/) има собствен кеш, който може да намали времето за обработка на последващите документи. Например, можете да споделите случай на [FontSettings](https://reference.aspose.com/words/python-net/aspose.words.fonts/fontsettings/) клас между различните документи, което ви позволява да ускорите зареждането на документите. Следният пример показва следното:
...
В случай, когато [FontSettings](https://reference.aspose.com/words/python-net/aspose.words.fonts/fontsettings/) не е определено изрично, Aspose.Words използва по подразбиране [FontSettings](https://reference.aspose.com/words/python-net/aspose.words.fonts/fontsettings/) Например. Този случай се споделя автоматично между документите и може да бъде извлечен, както следва:
...
Ако сте сигурни, че всички документи за обработка изискват едни и същи настройки на шрифта, тогава се препоръчва да се създаде и да се използва по подразбиране [FontSettings](https://reference.aspose.com/words/python-net/aspose.words.fonts/fontsettings/) Например. Предполагам, че трябва да използвате едни и същи източници на шрифт за всички ваши документи. В този случай можете просто да измените процедурата по подразбиране, както следва:
...
Обичаят [FontSettings](https://reference.aspose.com/words/python-net/aspose.words.fonts/fontsettings/) имат по-висок приоритет от случая по подразбиране.
...
1. Ако Aspose.Words не е в състояние да открие желания шрифт с точното име, както и [alt_name](https://reference.aspose.com/words/python-net/aspose.words.fonts/fontinfo/alt_name/) свойство определено за този шрифт, след това Aspose.Words will find the font defined with [alt_name](https://reference.aspose.com/words/python-net/aspose.words.fonts/fontinfo/alt_name/) от [FontInfo](https://reference.aspose.com/words/python-net/aspose.words.fonts/fontinfo/) клас, който определя информацията за шрифта.
1. Ако Aspose.Words не може да намери определения шрифт, и [alt_name](https://reference.aspose.com/words/python-net/aspose.words.fonts/fontinfo/alt_name/) не се определя също така, след това правилата за заместване на шрифта се прилагат един по един, както е описано по-долу (когато бъде намерена подходящата замяна, процесът на заместване на шрифта спира и следващата стъпка не се изпълнява):
...
{{< /highlight >}}
   1. [FontInfo](https://reference.aspose.com/words/python-net/aspose.words.fonts/fontinfo/) Правилото за заместване се прилага, ако правилото за заместване на таблицата не може да намери шрифта. Този механизъм е активиран по подразбиране. Aspose.Words намира най-подходящия шрифт според информацията за шрифта, съдържаща се в конкретен документ. Тази информация може да бъде получена от [FontInfo](https://reference.aspose.com/words/python-net/aspose.words.fonts/fontinfo/) клас, както е показано по- долу:<br/>
{{< highlight python >}}
...
{{< /highlight >}}
      Ако [FontInfo](https://reference.aspose.com/words/python-net/aspose.words.fonts/fontinfo/) не е на разположение за липсващия шрифт, след това процесът спира.<br/>
   1. [DefaultFont](https://reference.aspose.com/words/python-net/aspose.words.fonts/defaultfontsubstitutionrule/) Правилото за заместване се прилага в случаите, когато `FontInfo` Заместването също се провали. Това правило също е активирано по подразбиране. Според това правило, Aspose.Words ще се опита да използва шрифта по подразбиране, посочен в [default_font_name](https://reference.aspose.com/words/python-net/aspose.words.fonts/defaultfontsubstitutionrule/default_font_name/) собственост. Ако потребителят не е избрал своя собствен шрифт по подразбиране, тогава "Times New Roman" ще се използва като шрифт по подразбиране. Това правило може да бъде изключено, както е показано по-долу:<br/>
{{< highlight python >}}
...
1. Най-накрая, ако Aspose.Words не могат да се намерят шрифтове сред наличните източници на шрифтове, тя прави документа с помощта на безплатния Fanwood шрифт, който е вграден в Aspose.Words пакет.<br/>

Ако [FontInfo](https://reference.aspose.com/words/python-net/aspose.words.fonts/fontinfo/) *FontInfo заместващото правило* винаги ще решава шрифта и ще отменя правилото за шрифта по подразбиране. Ако искате да използвате правилото за шрифта по подразбиране, трябва да изключите правилото за заместване *FontInfo. Имайте предвид, че правилото за заместване на FontConfig* ще реши шрифта в повечето случаи и по този начин отменя всички други правила.
...
Има [build_automatic](https://reference.aspose.com/words/python-net/aspose.words.fonts/fontfallbacksettings/build_automatic/) метод, който автоматично изгражда резервните настройки чрез сканиране на наличните шрифтове. Тъй като този метод може да доведе до неоптимална настройка за връщане, можете да контролирате поведението на шрифта чрез използване на свойствата на [FontFallbackSettings](https://reference.aspose.com/words/python-net/aspose.words.fonts/fontfallbacksettings/) Клас. Този клас определя настройките на механизма за изтегляне на шрифта. Можете да получите случай на [FontFallbackSettings](https://reference.aspose.com/words/python-net/aspose.words.fonts/fontfallbacksettings/) клас, както следва:
...
Aspose.Words осигурява предварително зададени настройки за изтегляне на шрифта Google Noto шрифтове. Това са безплатни шрифтове лицензирани под SIL Open Font License, които могат да бъдат изтеглени от Google Noto Шрифтове. На [FontFallbackSettings](https://reference.aspose.com/words/python-net/aspose.words.fonts/fontfallbacksettings/) Класът осигурява [load_noto_fallback_settings](https://reference.aspose.com/words/python-net/aspose.words.fonts/fontfallbacksettings/load_noto_fallback_settings/) метод. Зарежда предварително настройките за изтегляне, които използват Google Noto шрифтове, показани в примера с код по-долу:
