...
* текстът е заобиколен от специалните полеви възли [FieldStart](https://reference.aspose.com/words/python-net/aspose.words.fields/fieldstart/) както и [FieldEnd](https://reference.aspose.com/words/python-net/aspose.words.fields/fieldend/)
* [FieldSeparator](https://reference.aspose.com/words/python-net/aspose.words.fields/fieldseparator/) Възел разделя текста в полето в полевия код и резултата от полето
...
От както **ConvertFieldsToStaticText** метод приема два параметъра .. [CompositeNode](https://reference.aspose.com/words/python-net/aspose.words/compositenode/) свойства и [FieldType](https://reference.aspose.com/words/python-net/aspose.words.fields/fieldtype/) Изброяване, възможно е да се премине всеки композитен възел към този метод. Това позволява полетата да бъдат преобразувани в статичен текст само в специфични части на документа.

Например, можете да преминете [Document](https://reference.aspose.com/words/python-net/aspose.words/document/) обект и конвертиране на полета от посочения тип от целия документ в статичен текст, или можете да преминете [Body](https://reference.aspose.com/words/python-net/aspose.words/body/) обект на раздел и само конвертирате полетата, намерени в това тяло.

{{% alert color="primary" %}}

При преминаване на блок ниво възел като [Paragraph](https://reference.aspose.com/words/python-net/aspose.words/paragraph/), Имайте предвид, че в някои случаи полетата могат да обхващат няколко параграфа. Ако това се случи, се препоръчва да се премине на родителя на композита вместо да се избегне това.

{{% /alert %}}

На [FieldType](https://reference.aspose.com/words/python-net/aspose.words.fields/fieldtype/) Преброяване на **ConvertFieldsToStaticText** метод определя какъв тип полета трябва да се конвертират в статичен текст. Всеки друг тип поле в документа ще остане непроменен.
...
Можете да изтеглите примерния файл от [Aspose.Words GitHub](https://github.com/aspose-words/Aspose.Words-for-Python-via-.NET/blob/master/Examples/Data/Linked%20fields.docx).
