---
title: Python както и .NET Разлики във версията
second_title: Aspose.Words вместо Python via .NET
articleTitle: Python както и .NET Разлики във версията
linktitle: Python както и .NET Разлики във версията
...
* [DocumentVisitor](https://reference.aspose.com/words/python-net/aspose.words/documentvisitor/) изпълнението в момента не е възможно от Python Код.
...
Базов клас за всички документни възли в Aspose.Words DOM е [Node](https://reference.aspose.com/words/python-net/aspose.words/node/) Клас. Например [get_child](https://reference.aspose.com/words/python-net/aspose.words/compositenode/get_child/) метод връща и пример за [Node](https://reference.aspose.com/words/python-net/aspose.words/node/) клас, но ако имате нужда да модифицирате върнатия възел, в повечето случаи трябва да го хвърлите на бетонен тип. Следният код показва как да промените цвета на шрифта на първия [Run](https://reference.aspose.com/words/python-net/aspose.words/run/) в документа:
...
Кастингът може да се изисква и когато [clone](https://reference.aspose.com/words/python-net/aspose.words/document/clone/) метод се използва:
...
Както може би сте забелязали. C# код, който бихте използвали `(Paragraph)node` за леене, в Python трябва да използвате `node.as_paragraph()` метод. В Python версия на Aspose.Words [Node](https://reference.aspose.com/words/python-net/aspose.words/node/) класа въвежда следната връзка на `as_xxx` методи:
...
Както може би си забелязал. [Field](https://reference.aspose.com/words/python-net/aspose.words.fields/field/) обект също осигурява набор от `as_xxx` методи, изброени по-долу:
...
[FontSourceBase](https://reference.aspose.com/words/python-net/aspose.words.fonts/fontsourcebase/) клас осигурява набор от `as_xxx` методи, изброени по-долу:
...
Да бъда по-близо до Python свят, API членове на Aspose.Words вместо Python via .NET използва питоничен стил змия, обаче в повечето случаи те имат един към един аналог в Aspose.Words вместо .NET API. Можете да намерите тези аналог в [xml файл](/words/python-net/python-notes/wrapper.zip).
