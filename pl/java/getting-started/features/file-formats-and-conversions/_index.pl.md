---
title: Formaty i konwersje plików
second_title: Aspose.Words zamiast Java
articleTitle: Formaty i konwersje plików
linktitle: Formaty i konwersje plików
...
Możesz spróbować funkcji konwersji za pomocą naszego [Bezpłatny konwerter online](https://products.aspose.app/words/conversion) narzędzie.
...
Więcej szczegółów na temat załadunku, konwersji i zapisywania dokumentów, zobacz [Ładowanie, zapasowanie i konwertowanie](/words/pl/java/loading-saving-and-converting/) sekcja.
...
Należy zauważyć, że w takich sytuacjach, Aspose.Words ma konwersja oznaczona "high- fidelity" i dokument wyjściowy będzie taki sam jak po konwersji przez Microsoft Word.
...
Skalowalne scenariusze po stronie serwera Aspose.Words głównie ze względu na jego prosty i czysty projekt - Aspose.Words obsługuje wielościenne czytanie. [Document](https://reference.aspose.com/words/java/com.aspose.words/document/) obiekty są od siebie niezależne i tak długo, jak tylko jeden wątek może modyfikować dokument na raz (typowy wymóg dla dowolnej klasy kolekcji), wiele gwintów może przetwarzać dowolną liczbę dokumentów w tym samym czasie.
