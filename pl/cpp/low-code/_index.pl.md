...
Aspose.Words dla C++ obsługuje zarówno Fluent, jak i Non-Fluent APIs, umożliwiając programistom wybór stylu, który najlepiej pasuje do ich preferencji kodowania i potrzeb projektu. Spójrzmy na kilka przykładów, aby zobaczyć, jak te dwa typy API różnią się.
...
Aby poznać bardziej zaawansowane opcje, zawsze możesz połączyć LowCode APIs z pełnym modelem obiektowym Aspose.Words. Zobacz więcej przykładów Low Code w [API documentation](https://reference.aspose.com/words/cpp/aspose.words.lowcode/).