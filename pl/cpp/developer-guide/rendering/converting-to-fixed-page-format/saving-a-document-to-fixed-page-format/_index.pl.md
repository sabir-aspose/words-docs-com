...
- Gracz metafile ([MetafileRenderingOptions](https://reference.aspose.com/words/cpp/aspose.words.saving/fixedpagesaveoptions/get_metafilerenderingoptions/)). Aby uzyskać więcej informacji, zobacz [Obsługa Windows Metaplików](/words/pl/cpp/handling-windows-metafiles/) artykuł.
