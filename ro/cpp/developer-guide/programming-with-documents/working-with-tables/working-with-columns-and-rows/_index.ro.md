...
description: "Lucrul cu părți ale unui tabel – rânduri, coloane și celule folosind C++. Specificați Rândul Antet C++."
type: docs
weight: 30
...
### Găsiți indexul unui rând dintr-un tabel {#find-the-index-of-a-row-in-a-table}
...
### Găsiți indexul unei celule într-un rând {#find-the-index-of-a-cell-in-a-row}
...
În modelul obiectului Document Aspose.Words (DOM), nodul [Table](https://reference.aspose.com/words/cpp/aspose.words.tables/table/) este format din noduri [Row](https://reference.aspose.com/words/cpp/aspose.words.tables/row/) și apoi noduri [Cell](https://reference.aspose.com/words/cpp/aspose.words.tables/cell/). Astfel, în modelul de Obiect `Document` al Aspose.Words, ca și în documentele Word, nu există niciun concept de coloană.
