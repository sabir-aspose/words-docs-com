...
- utilizarea [Aspose.Words Model Obiect Document (DOM)](/words/ro/cpp/aspose-words-document-object-model/)
...
De asemenea, puteți insera diferite tipuri de câmpuri folosind [Aspose.Words Model Obiect Document (DOM)](/words/ro/cpp/aspose-words-document-object-model/). În această secțiune, vom analiza câteva exemple.
