...
description: "Aspose.Words pentru Java oferă utilizatorilor o gamă largă de funcții, de la simpla conversie și modificare a documentelor la crearea de documente structurate și atrăgătoare din punct de vedere vizual sau automatizarea raportării."
type: docs
weight: 40
ai_search_scope: words_java
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
ai_search_fast_endpoint: "https://docsearch.api.aspose.cloud/search"
url: /ro/java/features/
...
Tabelele de mai jos rezumă Aspose.Words pentru Java caracteristici și să ofere link-uri către descrieri detaliate caracteristică.

{{% alert color="primary" %}}

Majoritatea capturilor de ecran din această secțiune demonstrează documente generate de Aspose.Words și apoi deschise pentru vizualizare în Microsoft Word și alte aplicații.

{{% /alert %}}

## Platforme Acceptate

Platformele Aspose.Words pentru Java pot fi utilizate cu sunt enumerate mai jos. Dacă aveți nevoie de asistență pentru mai multe platforme, căutați produsul " fratele geamăn Aspose.Words pentru .NET.

| Caracteristică | Descriere |
| :- | :- |
| [Java](/words/java/supported-platforms/) | Aspose.Words pentru Java este disponibil pentru Java 1.6, 1.7 și 1.8 și va rula în orice loc unde Java este instalat. |
...
| Caracteristică | Descriere |
| :- | :- |
| Microsoft Word (DOC) ([încărcare](/words/java/load-in-ms-word-97-2003-formats/) și [salvați](/words/java/save-in-ms-word-97-2003-formats/)) | Cea mai rapidă și mai completă implementare în format DOC pe care o puteți găsi. |
| WordprocessingML (DOCX, XML) ([încărcare](/words/java/load-in-the-open-office-xml-2007-and-2010-formats/) și [salvați](/words/java/save-in-the-open-office-xml-docx-dotx-docm-dotm-format/)) | Aspose.Words oferă suport exhaustiv OOXML, plat OPC și, de asemenea, Word 2003 XML. |
| Format Text Îmbogățit (RTF) ([încărcare](/words/java/load-in-the-rich-text-format-1-9-rtf-format/) și [salvați](/words/java/save-in-the-rich-text-format-1-9-rtf-format/)) | Suport complet al formatului RTF pentru a interacționa cu o varietate de aplicații. |
| HTML, XHTML și MHTML | [Încărcare](/words/java/load-in-the-html-html-xhtml-mhtml-format/) și [salvați](/words/java/save-in-the-html-html-xhtml-mhtml-format/) HTML / XHTML pentru o interoperabilitate și mai mare. Salvare ca MHTML este de asemenea disponibil. |
| OpenDocument (ODT) | Aspose.Words poate [încărcare](/words/java/load-in-the-opendocument-text-odt-ott-format/) și [salvați](/words/java/save-in-the-opendocument-text-odt-ott-format/) documente în textul `OpenDocument` (.formatul odt). |
| [Format Document Portabil Adobe (PDF)](/words/java/save-in-the-adobe-portable-document-pdf-format/) | Convertiți orice document în PDF cu fidelitate ridicată. PDF/A este acceptat. |
| XML Specificații De Hârtie (XPS) ([încărcare](/words/java/load-in-ms-word-2003-formats/) și [salvați](/words/java/save-in-the-flatopc-ooxml-document-xml-format/)) | Convertiți orice document în XPS cu fidelitate ridicată. |
| Text Simplu (TXT) ([încărcare](/words/java/load-in-the-plain-text-txt-format/) și [salvați](/words/java/save-in-the-plain-text-txt-format/)) | Extrageți cu ușurință textul salvând în format text simplu. |
| [Editare Digitală (EPUB)](/words/java/save-in-the-idpf-epub-document-epub-format/) | EPUB este un format popular pentru eBooks. Puteți converti orice document din Aspose.Words în formatul IDPF EPUB. |
...
| Redați paginile documentelor în imagini raster (mai multe pagini TIFF, PNG, JPEG, BMP). |
| Redați paginile la un obiect grafic Java la o anumită dimensiune. |
| Imprimați pagini de documente utilizând infrastructura de imprimare Java. |
| Actualizați `TOC`, numerele paginilor și alte câmpuri înainte de redare sau imprimare. |
| Efecte 3D De redare prin OpenGL |
...
| Reconstruiți și actualizați câmpurile Cuprins (TOC) exact așa cum face Microsoft Word. |
...
| Specificați protecția documentelor, deschideți documentele protejate și criptate. |
...
| Detectați semnăturile digitale în documente. |
...
| Caracteristică |
| :- |
| Accesați și modificați toate formatările de caractere, inclusiv fonturile, culorile, efectele, marginile și umbrirea. |
