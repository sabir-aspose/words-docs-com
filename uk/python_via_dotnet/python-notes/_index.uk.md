---
title: Python і .NET Версія Відмінності
second_title: Aspose.Words для Python via .NET
articleTitle: Python і .NET Версія Відмінності
linktitle: Python і .NET Версія Відмінності
...
* Ім'я * [DocumentVisitor](https://reference.aspose.com/words/python-net/aspose.words/documentvisitor/) неможливе виконання Python код.
...
Базовий клас для всіх вузлів документів Aspose.Words DOM є [Node](https://reference.aspose.com/words/python-net/aspose.words/node/) клас. Приклад [get_child](https://reference.aspose.com/words/python-net/aspose.words/compositenode/get_child/) метод повертає і екземпляр [Node](https://reference.aspose.com/words/python-net/aspose.words/node/) клас, але якщо потрібно змінити повернутий вузол, в більшості випадків потрібно його відлити до бетонного типу. Наступний код показує, як змінити колір шрифту першого [Run](https://reference.aspose.com/words/python-net/aspose.words/run/) в документі:
...
Кастинг може бути також обов'язково, коли [clone](https://reference.aspose.com/words/python-net/aspose.words/document/clone/) метод використовується:
...
Як ви помітили, де C# Ви будете використовувати `(Paragraph)node` для лиття, в Python Ви повинні використовувати `node.as_paragraph()` метод. У Python версія Aspose.Words [Node](https://reference.aspose.com/words/python-net/aspose.words/node/) Клас знайомить з наступним посиланням `as_xxx` методи:
...
Як ви помітили [Field](https://reference.aspose.com/words/python-net/aspose.words.fields/field/) об'єкт також забезпечує набір `as_xxx` методи, які вказані нижче:
...
[FontSourceBase](https://reference.aspose.com/words/python-net/aspose.words.fonts/fontsourcebase/) Клас надає набір комплектів `as_xxx` методи, які вказані нижче:
...
## API Члени
Щоб бути ближче Python світ, API членів Aspose.Words для Python via .NET використовує стиль pythonic змія, проте в більшості випадків вони мають один до одного аналога в Aspose.Words для .NET APIй Ви можете знайти ці аналоги в [xml файл](/words/python-net/python-notes/wrapper.zip)й
