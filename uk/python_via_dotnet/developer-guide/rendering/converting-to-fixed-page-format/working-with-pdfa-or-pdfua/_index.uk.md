...
description: "Перетворення в PDF/A-1, PDF/A-2, PDF/A-4 та PDF/UA за допомогою Pythonй Є кілька проблем при конвертації документів PDF/A, і Aspose.Words для Python розчиняє їх."
type: docs
weight: 28
url: /uk/python-net/working-with-pdfa-or-pdfua/
...
Текстова мова вказана в Microsoft Word документи. Aspose.Words експорт вказаної мови до виходу PDF з *Lang* атрибут, прикріплений до послідовності позначеного вмісту або тегу Span - він керується [export_language_to_span_tag](https://reference.aspose.com/words/python-net/aspose.words.saving/pdfsaveoptions/export_language_to_span_tag/) майно. Зазвичай не існує мовних питань, коли текст вводиться користувачем через Microsoft Wordй Якщо текст автоматично генерується.
