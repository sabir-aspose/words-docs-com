...
З Aspose.Words може легко конвертувати будь-який документ у XPS, > Вам потрібно лише написати код, який проходить XPS документ до документа `XpsPrint` APIй Єдина проблема полягає в тому, що `XpsPrint` API - це незахищений і вимагає певних знань технології платформи.
