...
articleTitle: Вивчайте особливості перетворення в PDF/A та PDF/UA
linktitle: Вивчайте особливості перетворення в PDF/A та PDF/UA
description: "Перетворення в PDF/A-1, PDF/A-2, PDF/A-4 та PDF/UA за допомогою C#й Виберіть найкращий стандарт PDF для перетворення документа за допомогою C#й"
type: docs
weight: 25
ai_search_scope: words_net
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
ai_search_fast_endpoint: "https://docsearch.api.aspose.cloud/search"
url: /uk/net/learn-features-of-conversion-to-pdf-a-pdf-ua/
...
У наступних статтях ми розглянемо основні проблеми, які можуть виникнути при роботі з документами в різних стандартах PDF і описати варіанти їх вирішення.
...
* PDF/A-4 передбачає переглянуті рівні конформансу: регулярний PDF/A-4 конформанс еквівалентний попередньому рівні версій У відповідності, а рівень А видалення
* Вміст PDF/UA-1 повинен бути позначений і стандартизований відповідно до ISO 32000-1: 2008

PDF/A є PDF ISO-стандартна версія PDF, призначена для використання в архіві та довгостроковому зберіганні електронних документів. У той же час PDF/UA ще один ISO стандартизована версія PDF, призначена для забезпечення доступності людей з обмеженими можливостями, які використовують допоміжну технологію. Для визначення рівня відповідності стандартам PDF, використання [Compliance](https://reference.aspose.com/words/net/aspose.words.saving/pdfsaveoptions/compliance/) майно. У зв'язку з умовами зберігання PDF/A документ необхідно зібрати всі шрифти та вимкнути шифрування, в той час як PDF/UA необхідно лише зібрати всі шрифти.
...
* [Перетворення документа в PDF](/words/uk/net/convert-a-document-to-pdf/)
