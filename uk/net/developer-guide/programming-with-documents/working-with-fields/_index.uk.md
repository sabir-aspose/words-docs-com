...
У Aspose.Words, > полів представлені [Fields](https://reference.aspose.com/words/net/aspose.words.fields/) простір імен. Статті в розділі даної документації пояснюють, як використовувати Aspose.Words класи маніпуляції полями документів, тематично.
