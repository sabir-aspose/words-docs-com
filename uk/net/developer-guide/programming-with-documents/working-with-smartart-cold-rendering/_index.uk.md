...
* Ім'я * Якщо попередньо відреставрований малюнок присутній, але невірно, потрібно виконати SmartArt холодний рендеринг явно за допомогою виклику [UpdateSmartArtDrawing](https://reference.aspose.com/words/net/aspose.words.drawing/shape/updatesmartartdrawing/) метод.
