...
У Aspose.Words, Всі класи та властивості, пов'язані з таблицями, містяться в [Aspose.Words.Tables](https://reference.aspose.com/words/net/aspose.words.tables/) простір імен.

## Дивитися ще

* [Aspose.Words Document Object Model (DOM)](/words/uk/net/aspose-words-document-object-model/)
* [Логічні рівні імен у документі](/words/uk/net/logical-levels-of-nodes-in-a-document/)
