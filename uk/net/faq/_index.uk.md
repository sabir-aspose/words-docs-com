...
articleTitle: Питання та відповіді Aspose.Words для .NET
linktitle: Питання та відповіді Aspose.Words для .NET
articleTitle: Контакти
linktitle: Контакти
type: docs
...
Якщо ви не знайшли відповіді на своє питання, ви можете запитати на форум підтримки. Для отримання інформації про те, як правильно повідомити своє питання або проблему, див. інформацію [Технічна підтримка](/words/uk/net/technical-support/) Сторінка
...
Aspose.Words для .NET не потрібно встановлювати сторонні додатки або додаткові пакети програмного забезпечення для роботи. Просто завантажити і встановити Aspose.Words як описано в [Монтаж](/words/uk/net/installation/) Стаття та початок роботи.
...
Деталі див. інформацію [Огляд продукту](/words/uk/net/product-overview/) Сторінка та сторінка [Платформи та Interopдовговічність](/words/net/platforms-and-interoperability/) секція.
...
Ви можете переглянути повний список підтримуваних форматів на [Підтримувані формати документів](/words/uk/net/supported-document-formats/) Сторінка
...
Дивитися [Ліцензування та підписка](/words/uk/net/licensing/) сторінка для отримання додаткової інформації.
...
Купити Aspose.Words ліцензія, необхідно перейти до [Покупка](https://purchase.aspose.com/buy) сторінка, виберіть "Aspose.Words" продукт і тип ліцензії, який підходить вам. Потім додайте ліцензію на кошик і дотримуйтесь інструкцій кошика.

Після придбання, застосуйте ліцензію, як описано в [Придбання ліцензії](/words/net/licensing/#purchased-license) секція.

Детальніше про те, як встановити Aspose.Words можна прочитати на сайті [Монтаж](/words/uk/net/installation/) Сторінка

------

**Q: Як отримати підтримку?**

Використовуйте безкоштовний форум технічної підтримки. Про те, як правильно звітувати проблему і які необхідно зробити перед контактом з форумом, див. інформацію [Технічна підтримка](/words/uk/net/technical-support/) Сторінка

## Рендеринг документа

{{% alert color="primary" %}}

Більш детальну інформацію про рендерингу можна знайти в [Рендеринг](/words/uk/net/rendering/) розділ документації.

{{% /alert %}}

**Q: Чому розмітка і шрифти у вихідному документі відрізняється від оригіналу?**

Формат шрифту може бути недоступний, або формат шрифту підтримується Microsoft Word але не підтримується Aspose.Wordsй Aspose.Words виконувати [Маніпулювати і підстановити TrueType Fonts](/words/uk/net/manipulating-and-substitution-truetype-fonts/)й

Щоб перевірити, чи відсутні шрифти:

* В Aspose.Words Використовуйте попередження заміни шрифтів (для деталей, див. розділ "Як дізнатися, що запис було замінено шрифтом" [Маніпулювати і підстановити TrueType Fonts](/words/uk/net/manipulating-and-substitution-truetype-fonts/) стаття).
...
У `APS.NET`, немає доступу до папки системних шрифтів у середній довірі. Користувачі повинні зберігати шрифти у власній папці.

------

**Q: Чому не працює за замовчуванням шрифтWindows Картини та символи Unicode замінені на .notdef glyph?**

Ми можемо часто бачити `.notdef` glyph замість символу Unicode. Це зазвичай коробка або питання glyphй
...
Деякі складні шрифти скриптів вимагають розширених функцій типографії для відображення їх правильно. Розширена Типографія вимкнена в Aspose.Words за замовчуванням. Користувачі мають увімкнути розширену Типографію [TextShaperFactory](https://reference.aspose.com/words/net/aspose.words.layout/layoutoptions/textshaperfactory/)й
...
Дізнатися більше про інформацію Mail Merge в [Mail Merge та звітність](/words/uk/net/mail-merge-and-reporting/) розділ документації.
...
* Ім'я * Перевірити дані, завантажені належним чином в таблиці: встановити [TableName](https://reference.aspose.com/words/net/aspose.words.mailmerging/imailmergedatasource/tablename/) правильно з усіма необхідними основними ключами і відносинами.
* Ім'я * Перевірте, що поля об'єднання названі належним чином. Використання [GetFieldNames](https://reference.aspose.com/words/net/aspose.words.mailmerging/mailmerge/getfieldnames/) метод, щоб отримати всі назви поля злиття і забезпечити, що ім'я поля злиття в шаблоні відповідає одному у вашому джерелі даних.
...
* Ім'я * Перевірити розділ "Як налаштувати відносини з даними в гнізді Mail Merge з регіонами" у статті [Непристойна Mail Merge з регіонами](/words/uk/net/nested-mail-merge-with-regions/)й
...
Детальна інформація про програмування з документами [Програмування документів](/words/uk/net/programming-with-documents/) розділ документації.

{{% /alert %}}

**Q: Чому не додано до документа на одній сторінці?**

На окремій сторінці з’являється результат Додаток через різницю [PageSetup](https://reference.aspose.com/words/net/aspose.words/pagesetup/) налаштування для розділів, в яких задано документи. Зробіть ідентичні **PageSetup** налаштування для розділів, в яких задано документи.

## Конвертувати документ

{{% alert color="primary" %}}

Дізнатися більше детальну інформацію про перетворення документа в [Конвертувати документ](/words/uk/net/convert-a-document/) розділ документації.
...
Для детальної відповіді вивчіть статтю [Як запустити Aspose.Words в Docker](/words/uk/net/how-to-run-aspose-words-in-docker/)й
