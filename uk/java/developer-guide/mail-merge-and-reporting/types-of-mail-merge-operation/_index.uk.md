---
title: Типи операцій Mail Merge в Java
second_title: Aspose.Words для Java
articleTitle: Типи операцій Mail Merge
linktitle: Типи операцій Mail Merge
type: docs
description: "Виконайте два різних типи операцій Mail Merge: прості Mail Merge і Mail Merge з регіонами. Простий Mail Merge повторює весь документ для кожного запису джерела даних, тоді як Mail Merge з регіонами повторює лише певні області для кожного запису, використовуючи Java."
keywords: "how to execute Mail Merge java, Mail Merge Java, Simple Mail Merge"
weight: 20
ai_search_scope: words_java
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
url: /uk/java/types-of-mail-merge-operations/
...
Клас [MailMerge](https://reference.aspose.com/words/java/com.aspose.words/mailmerge/) представляє функціональність Mail Merge. За допомогою його властивостей ви можете налаштувати необхідну поведінку перед виконанням операції Mail Merge.
...
Як тільки ваш шаблон буде готовий, ви можете приступити до виконання простої операції Mail Merge. Aspose.Words дозволяє виконати просту операцію Mail Merge, використовуючи різні [Execute methods](https://reference.aspose.com/words/java/com.aspose.words/mailmerge/#execute-com.aspose.words.IMailMergeDataSource), які приймають різні об'єкти даних як джерело даних.

Наступний приклад коду показує, як виконати просту операцію Mail Merge, використовуючи один із методів [Execute](https://reference.aspose.com/words/java/com.aspose.words/mailmerge/#execute-java.lang.String---java.lang.Object):
...
Інформація про Регіон Mail Merge може бути отримана за допомогою класу [MailMergeRegionInfo](https://reference.aspose.com/words/java/com.aspose.words/mailmergeregioninfo/).
...
Наступний приклад коду показує, як виконати Mail Merge з регіонами, використовуючи метод [ExecuteWithRegions(DataSet)](https://reference.aspose.com/words/java/com.aspose.words/mailmerge/#executeWithRegions-com.aspose.words.net.System.Data.DataSet):
