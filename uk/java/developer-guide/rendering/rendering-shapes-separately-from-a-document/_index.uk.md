...
При рендерингу **Shape**, > вона повинна бути частиною ієрархії документа. Якщо **Shape** не є частиною дерева документа, після того, як рендеринг буде порожнім після виклику **ShapeRenderer** методи.
