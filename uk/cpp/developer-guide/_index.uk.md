...
- [Завантаження, збереження та перетворення](/words/uk/cpp/loading-saving-and-converting/) - містить інформацію про різні способи завантаження або збереження документів та функції, що залежать від формату, які корисні для перетворення документа з одного формату в інший.
- [Візуалізація](/words/uk/cpp/rendering/) - надає інформацію про те, як отримати посторінкове уявлення документа в форматі сторінки flow-layout.
- [Mail Merge та створення звітів](/words/uk/cpp/mail-merge-and-reporting/) - надає інформацію про створення документів, таких як звіти, каталоги, запаси та рахунки-фактури, із шаблонів із полями Mail Merge.
- [Програмування за допомогою документів](/words/uk/cpp/programming-with-documents/) - містить інформацію про те, як програмно створювати документи, змінювати їх і управляти ними, включаючи зміну їх змісту і зовнішнього вигляду.
