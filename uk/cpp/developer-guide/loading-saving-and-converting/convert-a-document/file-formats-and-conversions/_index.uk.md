---
title: Формати файлів і їх перетворення
second_title: Aspose.Words для C++
articleTitle: Чому конверсія є основною функцією Aspose.Words?
linktitle: Конверсія-це флагманська функція Aspose.Words
description: "Перетворіть документи з будь-якого підтримуваного завантажуваного формату в збережений за допомогою лише двох рядків коду C++. Це забезпечує високоякісне перетворення."
type: docs
weight: 50
ai_search_scope: words_cpp
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
ai_search_fast_endpoint: "https://docsearch.api.aspose.cloud/search"
url: /uk/cpp/file-formats-and-conversions/
...
1. Завантаження документа з файлу або потоку
2. Збережіть його в будь-якому підтримуваному форматі
...
Додаткові відомості про завантаження, перетворення та збереження документів див. у розділі [Завантаження, збереження та перетворення](/words/uk/cpp/loading-saving-and-converting/) розділ.
...
Зверніть увагу, що в таких ситуаціях перетворення Aspose.Words позначено як "високоточне", і вихідний документ буде таким же, як і після перетворення за допомогою Microsoft Word.
...
Масштабовані сценарії сервера використовують Aspose.Words в основному через його простий і зрозумілий дизайн-Aspose.Words підтримує багатопотоковість. [Document](https://reference.aspose.com/words/cpp/aspose.words/document/) об'єкти незалежні один від одного, і поки лише один потік може змінювати документ одночасно (типова вимога для будь-якого класу колекцій), кілька потоків можуть обробляти будь-яку кількість документів одночасно.
