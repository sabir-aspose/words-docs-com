...
- Програвач метафайлів ([MetafileRenderingOptions](https://reference.aspose.com/words/cpp/aspose.words.saving/fixedpagesaveoptions/get_metafilerenderingoptions/)). Більш детальну інформацію дивіться в розділі [Обробка Windows метафайлів](/words/uk/cpp/handling-windows-metafiles/) стаття.
