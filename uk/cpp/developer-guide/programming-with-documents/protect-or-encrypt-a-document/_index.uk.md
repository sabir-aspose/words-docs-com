...
| ------------------------------- | ------------------------------ | ------------------------------------------------------------ |
| Доступний лише для читання | "Зробити документ доступним лише для читання" | Завжди відкривайте документ лише для читання (Файл → Інформація → захист документа)<br />Альтернативна функція: "Пароль для зміни "(Зберегти як → Інструменти → Загальні параметри → Пароль) |
