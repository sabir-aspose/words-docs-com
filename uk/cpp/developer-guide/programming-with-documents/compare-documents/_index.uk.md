...
Зверніть увагу, що ви можете порівняти будь-які два документи в рамках [підтримувані формати файлів](/words/uk/cpp/supported-document-formats/) Ви можете порівнювати об'єкти документа і навіть створювати ці об'єкти з нуля, не маючи певного формату.
