...
Створюйте документи або звіти з нуля або заповнюючи шаблони даними з джерел даних або бізнес-об'єктів. Додаткові відомості про створення звітів і Витяг даних з баз даних див. в розділі [Mail Merge та звіти](/words/uk/cpp/mail-merge-and-reporting/).
...
Будь ласка, відвідайте сторінку [Ліцензування](/words/uk/cpp/licensing/) для отримання інформації про Ліцензії та ознайомтеся зі сторінкою [Інформація про ціни](https://purchase.aspose.com/pricing/words/family/) для отримання детальної інформації про ціни.

## Технічна підтримка

Для більш докладної інформації Aspose.Words технічну підтримку, погляньте на [сторінка підтримки ](/words/uk/cpp/technical-support/).
