...
бібліотека " Aspose.Words для C++" надає розробникам прямий доступ до створення, модифікації, об'єднання, перетворення, порівняння Word та веб-документів. PDF, DOCX, DOC, RTF, ODT, EPUB, HTML і багато інших форматів файлів є [підтримуваний](/words/uk/cpp/supported-document-formats/).
