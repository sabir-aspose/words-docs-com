...
description: "Crie e gerencie seções e quebras de seção em um documento usando Python. Inserir seção em um documento Python. Remova a seção Python. Copie seções entre documentos."
type: docs
weight: 120
