...
articleTitle: Por que a conversão é o principal recurso de Aspose.Words?
linktitle: A conversão é Aspose.Words' característica principal
description: "Converta documentos de qualquer carga suportada para salvar o formato com apenas duas linhas de código C++. Ele fornece conversões de alta qualidade."
type: docs
weight: 50
url: /pt/cpp/file-formats-and-conversions/
...
Para obter mais detalhes sobre como carregar, converter e salvar documentos, consulte o [Carregamento, poupança e conversão](/words/pt/cpp/loading-saving-and-converting/) secção.
