...
Aspose.Words para C++ suporta Fluent e Non-Fluent APIs, permitindo que os desenvolvedores escolham o estilo que melhor se adapta às suas preferências de codificação e necessidades do projeto. Vejamos alguns exemplos para ver como esses dois tipos de API diferem.
...
Para explorar opções mais avançadas, você sempre pode combinar LowCode APIs com o modelo de objeto completo Aspose.Words. Veja mais Low Code Exemplos em [API documentation](https://reference.aspose.com/words/cpp/aspose.words.lowcode/).