---
title: Formatos de ficheiros e conversões
second_title: Aspose.Words para Java
articleTitle: Formatos de ficheiros e conversões
linktitle: Formatos de ficheiros e conversões
description: "Converta documentos de qualquer carga suportada para salvar o formato com apenas duas linhas de código Java. Ele fornece conversões de alta qualidade usando Java."
type: docs
weight: 40
...
A capacidade de converter de forma rápida e fiável vários formatos de documentos com um elevado grau de precisão é a principal característica do Aspose.Words. Esta é muitas vezes uma razão boa o suficiente para escolher Aspose.Words para Java.
...
Para obter mais detalhes sobre como carregar, converter e salvar documentos, consulte o [Carregamento, poupan valuetech](/words/pt/java/loading-saving-and-converting/) secção.
...
Aspose.Words Document Object Model (DOM) foi concebido tendo em mente os formatos de Documento Microsoft Word. Por conseguinte, o nosso nível de apoio a esses formatos, tais como DOC, DOCX, RTF, ou WordprocessingML, é sem precedentes. A conversão em qualquer direção entre esses formatos é de alta fidelidade.
...
Note-se que em tais situações, Aspose.Words tem a conversão marcada como "alta fidelidade" e o documento de saída será o mesmo que após a conversão via Microsoft Word.
...
Cenários escaláveis do lado do servidor usam Aspose.Words principalmente por causa de seu design simples e limpo – Aspose.Words suporta multithreading. [Document](https://reference.aspose.com/words/java/com.aspose.words/document/) os objetos são independentes uns dos outros e, desde que apenas um encadeamento possa modificar um documento por vez (um requisito típico para qualquer classe de coleção), vários encadeamentos podem processar qualquer número de documentos ao mesmo tempo.

## Alto Desempenho

Aspose.Words demonstra alto desempenho ao carregar e salvar documentos. Nos testes, um arquivo DOC com mais de 5Mb de tamanho foi carregado em menos de 1 segundo e depois salvo em menos de 1 segundo em uma máquina P4 3GHz. Arquivos menores podem ser processados a velocidades de milhares por minuto.
