...
Em contraste com os documentos do Word, Markdown não está em conformidade com o DOM descrito no [Aspose.Words Modelo De Objecto Do Documento (DOM)](/words/pt/java/aspose-words-document-object-model/) artigo. No entanto, Aspose.Words fornece seu próprio mecanismo para traduzir Markdown documentos para DOM e vice-versa, para que possamos trabalhar com sucesso com seus elementos, como formatação de texto, tabelas, cabeçalhos e outros.
