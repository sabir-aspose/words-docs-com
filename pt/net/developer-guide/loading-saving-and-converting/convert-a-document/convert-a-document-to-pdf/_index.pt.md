...
- O artigo [Conversão para formato de página fixa](/words/net/converting-to-fixed-page-format/#what-is-a-page-layout) para mais informações sobre layout de página
