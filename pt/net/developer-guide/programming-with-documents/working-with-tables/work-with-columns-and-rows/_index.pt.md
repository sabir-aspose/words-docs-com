---
title: Trabalhe com colunas e linhas em C#
...
## Encontre o índice de elementos da tabela {#find-the-index-of-table-elements}

Colunas, linhas e células são gerenciadas acessando o nó do documento selecionado por meio de seu índice. Encontrar o índice de qualquer nó envolve reunir todos os nós filhos do tipo de elemento do nó pai e, em seguida, usar o método [IndexOf](https://reference.aspose.com/words/net/aspose.words/nodecollection/indexof/) para encontrar o índice do nó desejado na coleção.

### Encontre o índice de uma tabela em um documento {#find-the-index-of-table-in-a-document}
...
Da mesma forma, pode ser necessário fazer alterações em uma linha específica de uma tabela selecionada. Para fazer isso, você também pode consultar uma linha pelo seu índice.
...
## Trabalhar com colunas {#work-with-columns}

No Aspose.Words Document Object Model (DOM), o nó [Table](https://reference.aspose.com/words/net/aspose.words.tables/table/) consiste em nós [Row](https://reference.aspose.com/words/net/aspose.words.tables/row/) e depois em nós [Cell](https://reference.aspose.com/words/net/aspose.words.tables/cell/). Assim, no Modelo de Objeto `Document` do Aspose.Words, assim como nos documentos Word, não existe o conceito de coluna.
...
## Evite que tabelas e linhas se quebrem nas páginas {#keep-tables-and-rows-from-breaking-across-pages}
...
Você pode baixar o arquivo de amostra deste exemplo em [Aspose.Words GitHub](https://github.com/aspose-words/Aspose.Words-for-.NET/blob/master/Examples/Data/Table%20spanning%20two%20pages.docx).

{{% /alert %}}

### Evite que uma tabela se quebre nas páginas {#keep-a-table-from-breaking-across-pages}
