...
description: "Converta para PDF/A-1, PDF/A-2, PDF/A-4 e PDF/UA usando C#. Existem alguns problemas ao converter para documentos PDF/A, e o Aspose.Words para .NET os resolve."
type: docs
weight: 28
url: /pt/net/working-with-pdfa-or-pdfua/
...
<details>
    ...
    <img src="/words/net/working-with-pdfa-or-pdfua/m-w-heading1-2.png" alt="MWTtítulo 1-2" style="width:800px"/>
    ...
    <img src="/words/net/working-with-pdfa-or-pdfua/acrobat-tags-pane.png" alt="Painel Acrobat Tags" style="width:800px"/>
</details>
{{% /alert %}}
...
<details>
    ...
    <img src="/words/net/working-with-pdfa-or-pdfua/m-w-decorative-shape.png" alt="MWDecorativoForma" style="width:800px"/>
...
O idioma do texto é especificado em documentos Microsoft Word. Aspose.Words exporta o idioma especificado para um PDF de saída com o atributo *Lang* anexado a uma sequência de conteúdo marcado ou a uma tag Span – é controlado pela propriedade [ExportLanguageToSpanTag](https://reference.aspose.com/words/net/aspose.words.saving/pdfsaveoptions/exportlanguagetospantag/). Geralmente não há problemas de idioma quando o texto é inserido pelo usuário via Microsoft Word. Mas existe a possibilidade de a linguagem ser imprecisa se o texto for gerado automaticamente.
...
<details>
    ...
    <img src="/words/net/working-with-pdfa-or-pdfua/m-w-language.png" alt="MWIdioma" style="width:800px"/>
...
<details>
    <summary>A especificação nos diz o seguinte (expanda para ver detalhes):</summary>
    <p></p>
    <p>Uma legenda que acompanha uma figura deve ser marcada com uma etiqueta Caption.</p>
    <p>ISO-14289-1, 7.3</p>
</details>
{{% /alert %}}
...
<details>
    ...
    <p></p>
    <p>No Microsoft Word, a legenda pode ser inserida através do menu de contexto:</p>
    <img src="/words/net/working-with-pdfa-or-pdfua/figure-caption-mw.png" alt="figura-legenda-mw" style="width:800px"/>
    <p>No Acrobat, a legenda pode ser adicionada ou alterada por meio da caixa de diálogo Propriedades do `Object`:</p>
    <img src="/words/net/working-with-pdfa-or-pdfua/figure-caption-acrobat.png" alt="figura-legenda-acrobata" style="width:800px"/>
</details>
{{% /alert %}}
...
<img src="/words/net/working-with-pdfa-or-pdfua/alternate-descriptions-hyperlinks-mw.png" alt="alternativas alternativas-hiperlinks-mw" style="width:800px"/>
...
{{% alert color="secondary" %}}
<details>
    <summary>Neste bloco você pode ver exemplos: como definir o cabeçalho da tabela (expanda para ver detalhes).</summary>
    <p></p>
    <p>O cabeçalho da tabela pode ser configurado no documento Microsoft Word de origem:</p>
    <img src="/words/net/working-with-pdfa-or-pdfua/table-headers-mw.png" alt="cabeçalhos da tabela-mw" style="width:800px"/>
    <p>Ou o PDF de saída:</p>
    <img src="/words/net/working-with-pdfa-or-pdfua/table-headers-acrobat-header-cell.png" alt="cabeçalhos de tabela-célula de cabeçalho do acrobat" style="width:800px"/>
    <p></p>
    <img src="/words/net/working-with-pdfa-or-pdfua/table-headers-acrobat-scope1.png" alt="cabeçalhos da tabela-acrobat-scope1" style="width:800px"/>
    <p></p>
    <img src="/words/net/working-with-pdfa-or-pdfua/table-headers-acrobat-scope2.png" alt="cabeçalhos da tabela-acrobat-scope2" style="width:800px"/>
</details>
{{% /alert %}}
...
|  PDF/A-2a |                                                                |
|  PDF/A-4 |                                                                |
|  PDF/UA-1 |  {{< emoticons/tick >}}<br /> Documento em PDF/UA-1 deverá ter título |
...
<details>
    ...
    <p></p>
    <p>A especificação nos diz o seguinte:</p>
    <p>O fluxo de metadados no dicionário do catálogo do documento deve conter uma entrada dc:title, onde dc é o prefixo recomendado para o esquema de metadados Dublin Core…</p>
    <p>ISO-14289-1, 7.1</p>
</details>
{{% /alert %}}
...
{{% alert color="secondary" %}}
<details>
    <summary>Neste bloco você pode ver exemplos: como definir o título do documento (expanda para ver detalhes).</summary>
    <p></p>
    <p>O título do documento pode ser configurado no documento Microsoft Word de origem:</p>
    <img src="/words/net/working-with-pdfa-or-pdfua/document-title-mw.png" alt="documento-título-mw" style="width:800px"/>
    <p>Ou o PDF de saída:</p>
    <img src="/words/net/working-with-pdfa-or-pdfua/document-title-acrobat.png" alt="documento-título-acrobat" style="width:800px"/>
</details>
{{% /alert %}}
...
<details>
    <summary>A especificação nos diz o seguinte (expanda para ver detalhes):</summary>
    <p></p>
    <p>Um documento em conformidade não deve conter uma referência ao .notdef glyph de qualquer operador que mostre o texto, independentemente do modo de renderização do texto, em qualquer fluxo de conteúdo.</p>
