...
linktitle: FAQ
type: docs
description: "Aspose.Words עבור C++ עונה על השאלות הנפוצות ביותר. למד דף זה כדי לפתור במהירות את הבעיה שלך בשאלות כלליות או בנושאים ספציפיים."
weight: 75
url: /he/cpp/faq/
...
אם לא מצאת את התשובה לשאלתך, תוכל לשאול בפורום התמיכה. לקבלת מידע על אופן הדיווח הנכון על השאלה או הבעיה שלך, עיין ב [תמיכה טכנית](/words/he/cpp/technical-support/) עמוד.

{{% alert color="primary" %}}

שאלות נפוצות מקובצות לפי נושאים לנוחיותך.
...
Aspose.Words עבור C++ לא צריך להתקין כל יישומי צד שלישי או חבילות תוכנה נוספות לעבודה. פשוט להוריד ולהתקין Aspose.Words כמתואר ב ["התקנה"](/words/he/cpp/installation/) מאמר ולהתחיל.
...
לפרטים, ראה [סקירת מוצר](/words/he/cpp/product-overview/) עמוד.
...
אתה יכול לראות את הרשימה המלאה של פורמטים נתמכים על [פורמטים של מסמכים נתמכים](/words/he/cpp/supported-document-formats/) עמוד.
...
לראות את [רישוי ומנוי](/words/he/cpp/licensing/) דף לקבלת מידע נוסף.

{{% alert color="primary" %}}

אתה יכול גם לנסות כמה מהתכונות הפופולריות ביותר Aspose.Words דרך [Aspose.Words אפליקציות מקוונות בחינם](https://products.aspose.app/words).
...
כדי לקנות רישיון Aspose.Words, עליך לעבור אל [רכישה](https://purchase.aspose.com/buy) עמוד, בחר את המוצר "Aspose.Words " ואת סוג הרישיון המתאים לך. לאחר מכן הוסף את הרישיון לעגלת הקניות שלך ופעל לפי הוראות עגלת הקניות.

לאחר הרכישה, הגש בקשה לרישיון כמתואר ב [רישיון שנרכש](/words/cpp/licensing/#purchased-license) סעיף.

פרטים על איך להתקין Aspose.Words ניתן לקרוא על [התקנה](/words/he/cpp/installation/) עמוד.

------

**ש: איך אני יכול לקבל תמיכה?**

השתמש בפורום התמיכה הטכנית בחינם. לפרטים כיצד לדווח כראוי על בעיה ומה צריך לעשות לפני פנייה לפורום, עיין ב [תמיכה טכנית](/words/he/cpp/technical-support/) עמוד.

## עיבוד מסמך

{{% alert color="primary" %}}

תוכל למצוא מידע מפורט יותר על עיבוד ב [עיבוד](/words/he/cpp/rendering/) סעיף תיעוד.

{{% /alert %}}

**ש: מדוע הפריסה והגופנים במסמך הפלט שונים מהמקור?**

ייתכן שהגופן לא יהיה זמין, או שפורמט הגופן נתמך על ידי Microsoft Word אך אינו נתמך על ידי Aspose.Words. Aspose.Words יבצע [החלפת גופן](/words/he/cpp/manipulate-and-substitute-truetype-fonts/).

כדי לבדוק אם הגופן חסר:

- ב Aspose.Words השתמש באזהרות החלפת הגופן (לפרטים, ראה את הקטע "כיצד לזהות שהגופן הוחלף" של [לתפעל ולהחליף TrueType גופנים](/words/he/cpp/manipulate-and-substitute-truetype-fonts/) סעיף).
...
כמה גופני סקריפט מורכבים דורשים עיבוד של תכונות הטיפוגרפיה המתקדמות על מנת להציג אותן כהלכה. טיפוגרפיה מתקדמת מושבתת ב Aspose.Words כברירת מחדל. משתמשים צריכים לאפשר טיפוגרפיה מתקדמת עם [TextShaperFactory](https://reference.aspose.com/words/cpp/aspose.words.layout/layoutoptions/get_textshaperfactory/).
...
תוכל למצוא מידע מפורט יותר על תכנות עם מסמכים ב [תכנות עם מסמכים](/words/he/cpp/programming-with-documents/) סעיף תיעוד.

{{% /alert %}}

**ש: מדוע לא מופיע תוכן המצורף למסמך באותו עמוד?**

תוצאת ההוספה מופיעה בדף נפרד בגלל הבדל בהגדרות [PageSetup](https://reference.aspose.com/words/cpp/aspose.words/pagesetup/) עבור הקטעים שבהם המסמכים מצורפים יחד. בצע הגדרות זהות **PageSetup** עבור הקטעים שבהם המסמכים מצורפים יחד.

## המרת מסמך

{{% alert color="primary" %}}

תוכל למצוא מידע מפורט יותר על המרת מסמך ב [המרת מסמך](/words/he/cpp/convert-a-document/) סעיף תיעוד.
