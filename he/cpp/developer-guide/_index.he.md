...
- [טעינה, שמירה והמרה](/words/he/cpp/loading-saving-and-converting/) - מספק מידע על דרכים שונות לטעון או לשמור מסמכים ותכונות ספציפיות לפורמט שימושיות להמרת מסמך מתבנית אחת לאחרת.
- [עיבוד](/words/he/cpp/rendering/) - מספק מידע על איך להשיג ייצוג עימוד ממסמך בפורמט דף זרימת פריסה.
- [Mail Merge ודיווח](/words/he/cpp/mail-merge-and-reporting/) - מספק מידע על יצירת מסמכים, כגון דוחות, קטלוגים, מלאי וחשבוניות, מתבניות עם שדות Mail Merge.
- [תכנות עם מסמכים](/words/he/cpp/programming-with-documents/) - מספק מידע כיצד ליצור, לשנות ולנהל מסמכים באופן פרוגרמטי, כולל שינוי התוכן והמראה החזותי שלהם.
