...
שים לב שאתה יכול להשוות כל שני מסמכים בתוך [פורמטים של קבצים נתמכים](/words/he/cpp/supported-document-formats/). אתה יכול להשוות אובייקטים של מסמכים ואפילו אתה יכול ליצור אובייקטים אלה מאפס מבלי שיהיה לך פורמט ספציפי.
