...
url: /he/cpp/how-to-set-fill-and-stroke-formatting/
timestamp: 2024-01-27-14-07-04
---

ניתן להגדיר עיצוב מילוי ושבץ עבור סדרות תרשים, נקודות נתונים וסמנים. לשם כך, עליך להשתמש במאפיינים של סוג **ChartFormat** בכיתות **ChartSeries**, **ChartDataPoint** ו - **ChartMarker**, וכן כינויים עבור מאפיינים מסוימים, כגון ForeColor, BackColor, גלוי ושקיפות בכיתה `Stroke`.

דוגמת הקוד הבאה מראה כיצד להגדיר צבע סדרה:
...
דוגמת הקוד הבאה מראה כיצד להגדיר צבע ומשקל קו:
