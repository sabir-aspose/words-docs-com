---
title: יצירת OOXML תרשימים מאפס
second_title: Aspose.Words עבור C++
articleTitle: יצירת OOXML תרשימים מאפס
linktitle: יצירת OOXML תרשימים מאפס
description: "כיצד ליצור תרשימים שונים במסמך באמצעות C++."
type: docs
weight: 10
ai_search_scope: words_cpp
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
ai_search_fast_endpoint: "https://docsearch.api.aspose.cloud/search"
url: /he/cpp/creating-ooxml-charts-from-scratch-using-aspose-words/
timestamp: 2024-01-27-14-07-04
---

## יצירת OOXML תרשימים מאפס באמצעות Aspose.Words

Aspose.Words מספק את שיטת `InsertChart` שהוספה לכיתה `DocumentBuilder`. אז בואו נראה כיצד להכניס תרשים עמודות פשוט למסמך בשיטת `DocumentBuilder->InsertChart`:

### כיצד להוסיף תרשים עמודות

דוגמת הקוד המופיעה להלן מראה כיצד להוסיף תרשים עמודות.
...
### איך InsertScatterChart

דוגמת הקוד המופיעה להלן מראה כיצד להוסיף תרשים פיזור.
...
### כיצד להוסיף תרשים שטח

דוגמת הקוד המופיעה להלן מראה כיצד להוסיף תרשים שטח.
...
### כיצד להוסיף תרשים בועה

דוגמת הקוד המופיעה להלן מראה כיצד להוסיף תרשים בועות.
