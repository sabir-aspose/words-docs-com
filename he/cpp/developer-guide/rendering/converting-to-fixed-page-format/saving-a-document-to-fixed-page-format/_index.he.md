...
- נגן מטאפיל ([MetafileRenderingOptions](https://reference.aspose.com/words/cpp/aspose.words.saving/fixedpagesaveoptions/get_metafilerenderingoptions/)). לפרטים נוספים, ראה [טיפול Windows מטא-קבצים](/words/he/cpp/handling-windows-metafiles/) סעיף.
