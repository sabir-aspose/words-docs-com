...
type: docs
weight: 20
description: "סכם מסמך. Aspose.Words עבור .NET מפשט את סיכום המסמכים באמצעות מודלים OpenAI וגוגל AI בכך שהוא מאפשר לך לציין את אורך הסיכום."
