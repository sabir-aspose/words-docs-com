...
type: docs
weight: 40
description: "בדוק דקדוק מסמך. Aspose.Words עבור .NET מאפשר למשתמשים לבדוק דקדוק ולזהות שגיאות במסמכים באמצעות מודלים OpenAI, גוגל ו Claude."
