...
description: "למד כיצד להחליף שדות עם טקסט C#. להחליף שדות עם נתונים סטטיים באמצעות .NET API."
type: docs
weight: 37
ai_search_scope: words_net
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
ai_search_fast_endpoint: "https://docsearch.api.aspose.cloud/search"
url: /he/net/replace-fields/
...
* הטקסט מוקף בצומת שדה מיוחד - [FieldStart](https://reference.aspose.com/words/net/aspose.words.fields/fieldstart/) ו [FieldEnd](https://reference.aspose.com/words/net/aspose.words.fields/fieldend)
* [FieldSeparator](https://reference.aspose.com/words/net/aspose.words.fields/fieldseparator/) Node מפריד את הטקסט בתוך השדה לתוך קוד השדה ותוצאה שדה
...
מאז **ConvertFieldsToStaticText** השיטה מקבלת שני פרמטרים - [CompositeNode](https://reference.aspose.com/words/net/aspose.words/compositenode/) תכונות ו [FieldType](https://reference.aspose.com/words/net/aspose.words.fields/fieldtype/) בהנחה, ניתן להעביר כל צומת מורכב בשיטה זו. זה מאפשר שדות להיות מומרים לטקסט סטטי רק בחלקים ספציפיים של המסמך.

לדוגמה, אתה יכול להעביר [Document](https://reference.aspose.com/words/net/aspose.words/document/) אובייקט וממיר שדות של הסוג שצוין מן המסמך כולו לטקסט סטטי, או שאתה יכול להעביר את [Body](https://reference.aspose.com/words/net/aspose.words/body/) אובייקט של סעיף וממיר רק את השדות שנמצאו בגוף זה.

{{% alert color="primary" %}}

כאשר עוברים צומת ברמת בלוק כגון [Paragraph](https://reference.aspose.com/words/net/aspose.words/paragraph/), להיות מודע לכך שבמקרים מסוימים, שדות יכולים לעבור על פסקאות מרובות. אם זה קורה, מומלץ להעביר את ההורה של המתחם במקום להימנע מכך.

{{% /alert %}}

The The The [FieldType](https://reference.aspose.com/words/net/aspose.words.fields/fieldtype/) ההארה עברה **ConvertFieldsToStaticText** שיטה מפרטת איזה סוג של שדות יש להמיר לטקסט סטטי. כל סוגי שדה אחרים שנמצאו במסמך יישארו ללא שינוי.
...
ניתן להוריד את קובץ הדגימה של דוגמה זו [Aspose.Words GitHub](https://github.com/aspose-words/Aspose.Words-for-.NET/blob/master/Examples/Data/Linked%20fields.docx).
