...
כחלופה לדיגורי היפנוזה מוקדמת, ניתן לרשום רק דיוני ההפניה הנדרשים "על פי בקשה". כדי להשיג זאת, ליישם את [IHyphenationCallback](https://reference.aspose.com/words/net/aspose.words/ihyphenationcallback/) ממשק ולהשתמש בכתובת סטטית [Callback](https://reference.aspose.com/words/net/aspose.words/hyphenation/callback/).
