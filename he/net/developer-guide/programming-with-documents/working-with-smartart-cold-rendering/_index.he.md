---
title: עבודה עם חכם אמנות מגניבה C#
second_title: Aspose.Words עבור .NET
articleTitle: עבודה עם חכם אמנות Cold Rendering
linktitle: עבודה עם חכם אמנות Cold Rendering
description: "מבוא חכם צורות אמנות באמצעות C#."
type: docs
description: "Aspose.Words עבור .NET מבצעים חכמים אמנות קר רנדרינג, כלומר הוא מניח והופך אובייקטים SmartArt אם הציור החכם מראש הוא חסר או לא נכון באמצעות שימוש C#."
weight: 330
ai_search_scope: words_net
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
ai_search_fast_endpoint: "https://docsearch.api.aspose.cloud/search"
url: /he/net/working-with-smartart-cold-rendering/
...
Microsoft Word יוצר ומציל את הציור מראש יחד עם `SmartArt` אובייקט. ברוב המקרים, הציור מראש ניתן היטב על ידי Aspose.Words אין צורך בפעולות נוספות. עם זאת, אם המסמך נשמר על ידי יישומים אחרים, ציור SmartArt מראש עשוי להיות חסר או לא נכון. במקרה הזה, `SmartArt` יש להניח את האובייקט עצמו ולהפוך אותו לשימוש Aspose.Words. אנחנו קוראים לתהליך הזה `SmartArt` קר רנדרינג
...
* אם ציור מראש מוצג אך אינו נכון, נדרש לבצע הצטננות של SmartArt באופן מפורש על ידי קריאה [UpdateSmartArtDrawing](https://reference.aspose.com/words/net/aspose.words.drawing/shape/updatesmartartdrawing/) שיטה.

דוגמה הקוד הבא מראה כיצד לעדכן רישומים עבור כל הדיאגרמות במסמך:
...
|  ----------------------  |  ------------------------------------------------------------  |  ------------------------------------------------------------  |
|  `List`  |  <ul><li>רשימת בלוקים בסיסית</li><li>עקבו אחרי Hexagons</li><li>רשימת קליעים</li><li>רשימת Box</li><li>רשימת Width</li><li>Horizontal Bullet List</li><li>Groupרשימה</li><li>רשימת בלוקים</li><li>רשימת Chevron</li><li>רשימת החץ</li><li>רשימת ptezoid</li><li>רשימת שולחן</li><li>רשימת הפירמידה</li><li>רשימת מטרות</li></ul> |  <ul><li>רשימה</li><li>ארכיון תגיות: Vertical Bracket list</li><li>רשימת</li><li>רשימה סגורה</li><li>הרשימה הזמנית</li><li>רשימת המעגל</li></ul> |
...
|  `Matrix`  |  <ul><li>מטריקס בסיסי</li><li>תגית: Matrix</li><li>מטריקס</li><li>מעגל מטריקס</li></ul> |  –                                                             |
|  `Pyramid`  |  –                                                             |  <ul><li>המונחים:</li></ul> |
