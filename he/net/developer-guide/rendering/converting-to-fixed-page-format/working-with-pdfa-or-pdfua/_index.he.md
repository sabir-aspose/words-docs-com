...
description: "המרת PDF/A-1, PDF/A-2, PDF/A-4 ו- PDF/UA באמצעות C#. ישנן מספר בעיות בעת המרת מסמכי PDF/A. Aspose.Words עבור .NET פותר אותם."
type: docs
weight: 28
...
<details>
    <summary>הסעיף מספר לנו את הדברים הבאים (הסבר לראות פרטים):</summary>
    <p></p>
    <p>כותרת המלווה דמות תיוג עם תג Caption.</p>
    <p>ISO-14289-1, 7.3</p>
</details>
{{% /alert %}}
...
בנוסף לנקודה הקודמת, Microsoft Word מסמכים גם מאפשרים למשתמשים להוסיף טקסט חלופי להיפר קישורים. Aspose.Words ייצוא טקסט חלופי כזה לפלט PDF.
...
שולחנות ב- PDF/UA-1 מסמכים חייבים להיות ראשיים - עמודה, שורה או שניהם. PDF/A דורש רק סימון שולחן סטנדרטי, שאין לו מגבלות נוספות. שימו לב Aspose.Words יוצר את הסימון הסטנדרטי באופן אוטומטי.
...
{{% alert color="secondary" %}}
<details>
    <summary>בבלוק זה, אתה יכול לראות דוגמאות: כיצד להגדיר את ראש השולחן (לבדוק פרטים).</summary>
    <p></p>
