...
linktitle: שאלות – Aspose.Words עבור .NET
...
אם לא מצאת את התשובה לשאלה שלך, תוכל לשאול בפורום התמיכה. לקבלת מידע על איך לדווח כראוי על השאלה או הבעיה שלך, ראה את השאלה [תמיכה טכנית](/words/he/net/technical-support/) דף.
...
Aspose.Words עבור .NET אין צורך להתקין יישומים של צד שלישי או חבילות תוכנה נוספות לעבודה. פשוט להוריד ולהתקין Aspose.Words כפי שתואר ב [מתקן](/words/he/net/installation/) מאמר והתחל.
...
לפרטים, ראה [סקירה המוצר](/words/he/net/product-overview/) דף ו [פלטפורמות ו Interopיכולת](/words/net/platforms-and-interoperability/) סעיף.
...
אתה יכול לראות את הרשימה המלאה של פורמטים נתמך על [תגיות Document Formats](/words/he/net/supported-document-formats/) דף.
...
ראו את [רישוי ומנוי](/words/he/net/licensing/) דף למידע נוסף

{{% alert color="primary" %}}

ניתן גם לנסות חלק מהפופולרי ביותר Aspose.Words תכונות באמצעות [Aspose.Words חינם באינטרנט Apps](https://products.aspose.app/words).
...
השתמש בפורום תמיכה טכנית חינם. לפרטים על איך לדווח כראוי על בעיה ומה צריך לעשות לפני יצירת קשר עם הפורום, ראה את [תמיכה טכנית](/words/he/net/technical-support/) דף.

## הגשת מסמך

{{% alert color="primary" %}}

אתה יכול למצוא מידע מפורט יותר על ביצוע [Rendering](/words/he/net/rendering/) סעיף תיעוד

{{% /alert %}}

**Q: מדוע הפריסה והפונטים במסמך הפלט שונים מהמקור?**

הגופן לא יכול להיות זמין, או פורמט הגופן נתמך על ידי Microsoft Word אך לא נתמך על ידי Aspose.Words. Aspose.Words יבצעו [Manipulate and Substitute TrueType Fonts](/words/he/net/manipulating-and-substitution-truetype-fonts/).

לבדוק אם הפונט חסר:

* In Aspose.Words השתמש באזהרות החלפת פונטן (לפרטים, ראה את "איך להכיר בכך שהפונט הוחלף" [Manipulate and Substitute TrueType Fonts](/words/he/net/manipulating-and-substitution-truetype-fonts/) מאמר).
...
In In In `APS.NET`, אין גישה לתיקיית המערכת באמון בינוני. משתמשים צריכים לאחסן גופנים בתיקיה שלהם.
...
כמה מגופנים מורכבים דורשים את תכונות Typography מתקדמות להיות מעובד כדי להציג אותם כראוי. היפנוזה מתקדמת זמינה Aspose.Words כברירת מחדל. משתמשים צריכים לאפשר היפנוזה מתקדמת עם [TextShaperFactory](https://reference.aspose.com/words/net/aspose.words.layout/layoutoptions/textshaperfactory/).
...
* בדוק את הנתונים נטען כראוי בטבלאות: להגדיר את [TableName](https://reference.aspose.com/words/net/aspose.words.mailmerging/imailmergedatasource/tablename/) נכון לגבי כל המפתחות העיקריים והיחסים.
* בדוק כי שדות המיזוג נקראים כראוי. השתמש [GetFieldNames](https://reference.aspose.com/words/net/aspose.words.mailmerging/mailmerge/getfieldnames/) שיטה להשיג את כל שמות שדות המיזוג ולהבטיח כי שם שדות המיזוג בתבנית שלך מתאים אחד במקור הנתונים שלך.
...
ניתן למצוא מידע מפורט יותר על תכנות עם מסמכים [תכנות עם מסמכים](/words/he/net/programming-with-documents/) סעיף תיעוד

{{% /alert %}}

**Q: מדוע אין תוכן התואם למסמכים המופיעים באותו דף?**

התוצאה הסופית מופיעה בעמוד נפרד בגלל הבדל [PageSetup](https://reference.aspose.com/words/net/aspose.words/pagesetup/) הגדרות לסעיפים שבהם המסמכים תואמים. לעשות את זה **PageSetup** הגדרות לסעיפים שבהם המסמכים תואמים.

## המרת מסמך

{{% alert color="primary" %}}

אתה יכול למצוא מידע מפורט יותר על המרת מסמך. [המרת מסמך](/words/he/net/convert-a-document/) סעיף תיעוד
...
לקבלת תשובה מפורטת, למד את המאמר [איך לרוץ Aspose.Words פנימה Docker](/words/he/net/how-to-run-aspose-words-in-docker/).
