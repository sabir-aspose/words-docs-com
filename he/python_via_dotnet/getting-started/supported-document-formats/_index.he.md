...
| [`PCL`](https://docs.fileformat.com/page-description-language/pcl/) | שמור את המסמך בפורמט PCL (Printer Control Language) |  | {{< emoticons/tick >}} |  |
...
|  `XamlFlowPack`  | **Beta**<br/>שמור את המסמך בשפת היישום הרחבה (XAML) פורמט החבילה כ מסמך זרימה |  | {{< emoticons/tick >}} |  |
