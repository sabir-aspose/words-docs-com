...
type: docs
description: "Edit Source מסמכים בפורמטים פופולריים רבים, כמו גם להמיר קבצים באופן חופשי מפורמט אחד למשנהו באמצעות שימוש Java."
weight: 30
ai_search_scope: words_java
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
ai_search_fast_endpoint: "https://docsearch.api.aspose.cloud/search"
url: /he/java/supported-document-formats/
...
הטבלה הבאה מציינת את פורמטי קובץ הקלט והפלט הנתמכות על ידי Aspose.Words עבור Java:
...
|  `FlatOpcTemplate`  | Office Open XML WordprocessingML Format (macro-free) מאוחסן בקובץ XML שטוח במקום חבילת ZIP | {{< emoticons/tick >}} | {{< emoticons/tick >}} |  |
...
| [`MOBI`](https://docs.fileformat.com/ebook/mobi/) | MOBI הוא פורמט eBook המשמש את `MobiPocket` קורא ו Amazon Kindle Readers | {{< emoticons/tick >}} |   {{< emoticons/tick >}}  |  |
| [`AZW3`](https://docs.fileformat.com/ebook/azw3/) | AZW3 הוא פורמט eBook המשמש Amazon קוראי קינדל | {{< emoticons/tick >}} |   {{< emoticons/tick >}}  |  |
...
|  `XamlFixed`  | שמור את המסמך בתבנית ה-Extensible Application Markup Language (XAML) כקובץ קבוע |  | {{< emoticons/tick >}} |  |
...
|  `HtmlFixed`  | שמור את המסמך בפורמט HTML באמצעות אלמנטים ממוצבים לחלוטין |  | {{< emoticons/tick >}} |  |
...
| [`PCL`](https://docs.fileformat.com/page-description-language/pcl/) | שמור את המסמך בפורמט PCL (שפת הבקרה של הדפסה) |  | {{< emoticons/tick >}} |  |
| [`EPUB`](https://docs.fileformat.com/ebook/epub/) | פורמט IDPF EPUB |   {{< emoticons/tick >}}  | {{< emoticons/tick >}} |  |
|  `XamlFlow`  | **Beta**<br/>שמור את המסמך בתבנית ברירת המחדל Markup Language (XAML) כ מסמך זרימה |  | {{< emoticons/tick >}} |  |
|  `XamlFlowPack`  | **Beta**<br/>שמור את המסמך בתבנית החבילה של היישום Extensible Application Markup Language (XAML) כקובץ זרימה |  | {{< emoticons/tick >}} |  |
...
| [`JPEG`](https://docs.fileformat.com/image/jpeg/) | דף של המסמך וחוסך אותו כקובץ JPEG |  | {{< emoticons/tick >}} |  |
