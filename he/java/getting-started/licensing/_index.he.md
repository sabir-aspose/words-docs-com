...
בדרך כלל זה מספיק כדי להחיל את הרישיון מודד האויר פעם אחת על תחילת יישום. עם זאת, אם מנגנון הרישוי המדוד לא מצליח לתקשר עם שרתי האספוז למשך 24 שעות, Aspose.Words ייצא ממצב מורשה ויעבור למצב הערכה. כדי להימנע ממקרה כזה, באפשרותך להשתמש בשיטת [IsMeteredLicensed](https://reference.aspose.com/words/java/com.aspose.words/metered/#isMeteredLicensed) כדי לבדוק את מצב הרישיון ולהחיל מחדש את הרישיון המודד במידת הצורך.
