...
على سبيل المثال، عند حفظ مستند بتنسيق DOC أو DOT، استخدم خاصية [Password](https://reference.aspose.com/words/ar/net/aspose.words.saving/docsaveoptions/password/) لفئة [DocSaveOptions](https://reference.aspose.com/words/ar/net/aspose.words.saving/docsaveoptions/).
...
عند حفظ مستند بتنسيق Odt، استخدم خاصية [Password](https://reference.aspose.com/words/ar/net/aspose.words.saving/odtsaveoptions/password/) لفئة [OdtSaveOptions](https://reference.aspose.com/words/ar/net/aspose.words.saving/odtsaveoptions/).
...
يوفر Aspose.Words القدرة على استخدام خاصية [ProgressCallback](https://reference.aspose.com/words/ar/net/aspose.words.saving/saveoptions/progresscallback/) للحصول على إشعارات حول التقدم المحرز في حفظ المستند.
...
يوفر Aspose.Words القدرة على استخدام خاصية [UpdateLastSavedTimeProperty](https://reference.aspose.com/words/ar/net/aspose.words.saving/saveoptions/updatelastsavedtimeproperty/) للحصول على قيمة أو تعيينها لتحديد ما إذا كان سيتم تحديث خاصية [LastSavedTime](https://reference.aspose.com/words/ar/net/aspose.words.properties/builtindocumentproperties/lastsavedtime/) قبل الحفظ.
...
لتحويل HTML أو SVG إلى PDF، ما عليك سوى استدعاء طريقة [Save](https://reference.aspose.com/words/ar/net/aspose.words/document/save/#save/) وتحديد اسم ملف بامتداد ".PDF". إذا كنت تريد تحميل الصور وCSS وما إلى ذلك من مصادر خارجية، فيمكنك استخدام [IResourceSavingCallback](https://reference.aspose.com/words/ar/net/aspose.words.saving/iresourcesavingcallback/).
...
للتحكم في خيارات حفظ الصورة، يتم استخدام فئة **ImageSaveOptions**. على سبيل المثال، يمكنك استخدام خاصية [PixelFormat](https://reference.aspose.com/words/ar/net/aspose.words.saving/imagesaveoptions/pixelformat/) لتعيين تنسيق البكسل للصور التي تم إنشاؤها. يرجى ملاحظة أن تنسيق البكسل للصورة الناتجة قد يختلف عن القيمة المحددة بسبب عمل GDI+.
