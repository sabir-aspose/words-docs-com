...
لاحظ أنه إذا كنت تبحث فقط عن أسماء حقول الدمج في مستند ما، فيمكنك بدلاً من ذلك استخدام طريقة [GetFieldNames](https://reference.aspose.com/words/ar/net/aspose.words.mailmerging/mailmerge/getfieldnames/) المضمنة.
