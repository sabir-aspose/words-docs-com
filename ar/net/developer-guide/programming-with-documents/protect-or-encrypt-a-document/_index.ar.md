...
|  -------------------------------  |  ------------------------------  |  ------------------------------------------------------------  |
|  يقرأ فقط |  "اجعل المستند للقراءة فقط" |  افتح دائمًا للقراءة فقط (ملف → معلومات → حماية المستند)<br /> الميزة البديلة: "كلمة المرور المراد تعديلها" (حفظ باسم → أدوات → خيارات عامة → كلمة المرور) |
