...
يمكنك أيضًا استخدام طريقة [InsertDocument](https://reference.aspose.com/words/ar/net/aspose.words/documentbuilder/insertdocument/#insertdocument/) أو [InsertDocumentInline](https://reference.aspose.com/words/ar/net/aspose.words/documentbuilder/insertdocumentinline/)، التي تشبه إدراج مستند في Microsoft Word، لإدراج مستند كامل في موضع المؤشر الحالي دون أي استيراد سابق.
...
قد تكون لديك حالة استخدام حيث تحتاج إلى تضمين صفحات إضافية من مستند إلى نهاية مستند موجود. للقيام بذلك، تحتاج فقط إلى استدعاء الأسلوب [AppendDocument](https://reference.aspose.com/words/ar/net/aspose.words/document/appenddocument/) لإضافة مستند إلى نهاية مستند آخر.

{{% alert color="primary" %}}

لاحظ أن [AppendChild](https://reference.aspose.com/words/ar/net/aspose.words/compositenode/appendchild/) هي طريقة على مستوى العقدة داخل المستند. على سبيل المثال، يمكنك إنشاء فقرة وتعيين خصائص التنسيق ثم إلحاقها كطفل فرعي بالنص باستخدام طريقة **AppendChild**.
...
عندما تحتاج إلى إدراج قسم أو فقرة أو إلحاقها بقسم أو فقرة أخرى، فإنك تحتاج بشكل أساسي إلى استيراد العقد الخاصة بشجرة عقدة المستند الأولى إلى الشجرة الثانية باستخدام طريقة [ImportNode](https://reference.aspose.com/words/ar/net/aspose.words/nodeimporter/importnode/). بعد استيراد العقد الخاصة بك، تحتاج إلى استخدام طريقة [InsertAfter](https://reference.aspose.com/words/ar/net/aspose.words/compositenode/insertafter/) / [InsertBefore](https://reference.aspose.com/words/ar/net/aspose.words/compositenode/insertbefore/) لإدراج عقدة جديدة بعد/قبل العقدة المرجعية. يتيح لك ذلك تخصيص عملية الإدراج عن طريق استيراد العقد من مستند وإدراجها في مواضع معينة.

يمكنك أيضًا استخدام طريقة [AppendChild](https://reference.aspose.com/words/ar/net/aspose.words/compositenode/appendchild/) لإضافة عقدة محددة جديدة إلى نهاية قائمة العقد التابعة، على سبيل المثال، إذا كنت تريد إلحاق محتوى على مستوى الفقرة بدلاً من مستوى القسم.
...
تقبل كل من طريقتي [InsertDocument](https://reference.aspose.com/words/ar/net/aspose.words/documentbuilder/insertdocument/) و[AppendDocument](https://reference.aspose.com/words/ar/net/aspose.words/document/appenddocument/) [ImportFormatMode](https://reference.aspose.com/words/ar/net/aspose.words/importformatmode/) و[ImportFormatOptions](https://reference.aspose.com/words/ar/net/aspose.words/importformatoptions/) كمعلمات إدخال. يتيح لك **ImportFormatMode** التحكم في كيفية دمج تنسيق المستند عند استيراد محتوى من مستند إلى آخر عن طريق تحديد أوضاع تنسيق مختلفة مثل [UseDestinationStyles](https://reference.aspose.com/words/ar/net/aspose.words/importformatmode/) و[KeepSourceFormatting](https://reference.aspose.com/words/ar/net/aspose.words/importformatmode/) و[KeepDifferentStyles](https://reference.aspose.com/words/ar/net/aspose.words/importformatmode/). يتيح لك **ImportFormatOptions** تحديد خيارات استيراد مختلفة مثل [IgnoreHeaderFooter](https://reference.aspose.com/words/ar/net/aspose.words/importformatoptions/ignoreheaderfooter/)، و[IgnoreTextBoxes](https://reference.aspose.com/words/ar/net/aspose.words/importformatoptions/ignoretextboxes/)، و[KeepSourceNumbering](https://reference.aspose.com/words/ar/net/aspose.words/importformatoptions/keepsourcenumbering/)، و[MergePastedLists](https://reference.aspose.com/words/ar/net/aspose.words/importformatoptions/mergepastedlists/)، و[SmartStyleBehavior](https://reference.aspose.com/words/ar/net/aspose.words/importformatoptions/smartstylebehavior/).

يتيح لك Aspose.Words ضبط تصور المستند الناتج عند إضافة مستندين معًا في عملية إدراج أو إلحاق باستخدام خصائص [Section](https://reference.aspose.com/words/ar/net/aspose.words/section/) و[PageSetup](https://reference.aspose.com/words/ar/net/aspose.words/documentbuilder/pagesetup/). تحتوي الخاصية **PageSetup** على جميع سمات القسم مثل [SectionStart](https://reference.aspose.com/words/ar/net/aspose.words/pagesetup/sectionstart/) و[RestartPageNumbering](https://reference.aspose.com/words/ar/net/aspose.words/pagesetup/restartpagenumbering/) و[PageStartingNumber](https://reference.aspose.com/words/ar/net/aspose.words/pagesetup/pagestartingnumber/) و[Orientation](https://reference.aspose.com/words/ar/net/aspose.words/pagesetup/orientation/) وغيرها. حالة الاستخدام الأكثر شيوعًا هي تعيين خاصية **SectionStart** لتحديد ما إذا كان المحتوى المضاف سيظهر على نفس الصفحة أو سيتم تقسيمه إلى محتوى جديد.
