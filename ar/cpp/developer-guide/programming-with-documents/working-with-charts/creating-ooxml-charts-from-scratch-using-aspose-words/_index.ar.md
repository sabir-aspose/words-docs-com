...
linktitle: إنشاء OOXML الرسوم البيانية من الصفر
description: "كيفية إنشاء مخططات مختلفة في المستند باستخدام C++."
type: docs
weight: 10
...
Aspose.Words يوفر طريقة `InsertChart` التي تمت إضافتها إلى فئة `DocumentBuilder`. لذلك، دعونا نرى كيفية إدراج مخطط عمود بسيط في المستند باستخدام طريقة `DocumentBuilder->InsertChart`:

### كيفية إدراج مخطط العمود

يوضح مثال الكود الموضح أدناه كيفية إدراج مخطط عمود.
...
### كيفية InsertScatterChart

يوضح مثال الكود الموضح أدناه كيفية إدراج مخطط مبعثر.
...
### كيفية إدراج مخطط المنطقة

يوضح مثال الكود الموضح أدناه كيفية إدراج مخطط منطقة.
...
### كيفية إدراج الرسم البياني فقاعة

يوضح مثال الكود الموضح أدناه كيفية إدراج مخطط فقاعي.
