...
type: docs
description: "تحويل المستندات بسهولة من تنسيق إلى آخر باستخدام C++. يمكنك العمل مع جميع التنسيقات الأكثر شيوعا مثل Microsoft Word التنسيقات مثل DOCX أو DOC، OpenDocument التنسيقات مثل ODT أو OTT، وتنسيقات الويب مثل HTML أو XHTML، وتنسيقات النص مثل MarkDown أو TXT، وغيرها."
...
<div class="row">
	<div class="col-md-6">
		<h2>تحويل كلمة إلى PDF</h2>
			<ul>
				<li><a href="/words/cpp/convert-a-document-to-pdf/#converting-doc-or-docx-to-pdf">تحويل DOC إلى PDF</a></li>
				<li><a href="/words/cpp/convert-a-document-to-pdf/#converting-doc-or-docx-to-pdf">تحويل DOCX إلى PDF</a></li>
				<li>وغيرها</li>
			</ul>
		<h2>تحويل الصورة إلى PDF</h2>
			<ul>
				<li><a href="/words/cpp/convert-a-document-to-pdf/#convert-an-image-to-pdf">تحويل JPG إلى PDF</a></li>
				<li><a href="/words/cpp/convert-a-document-to-pdf/#convert-an-image-to-pdf">تحويل TIFF إلى PDF</a></li>
				<li>وغيرها</li>
			</ul>
	...
	<div class="col-md-6">
		<h2>تحويل مستند إلى صورة</h2>
			<ul>
				<li><a href="/words/cpp/convert-a-document-to-an-image/">تحويل DOCX إلى JPG</a></li>
				<li>تحويل DOC إلى PNG</li>
				<li>وغيرها</li>
			</ul>
		<h2>تحويل مستند إلى Markdown</h2>
			<ul>
				<li><a href="/words/cpp/convert-a-document-to-markdown/">تحويل مستند إلى Markdown</a></li>
				<li>تحويل HTML إلى Markdown</li>
				<li>وغيرها</li>
			</ul>
		<h2>تحويل مستند إلى HTML</h2>
			<ul>
				<li><a href="/words/cpp/convert-a-document-to-html-mhtml-or-epub/#convert-a-document">تحويل كلمة إلى HTML</a></li>
		...
		<h2>أمثلة أخرى</h2>
			<ul>
				<li><a href="/words/cpp/convert-a-document-to-mhtml-and-send-it-by-email/">تحويل مستند إلى MHTML وإرساله عبر البريد الإلكتروني</a></li>
