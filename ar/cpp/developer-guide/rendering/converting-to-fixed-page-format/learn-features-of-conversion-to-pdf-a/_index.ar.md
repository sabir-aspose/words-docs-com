...
description: "تحويل إلى PDF/A-1, PDF/A-2, PDF/A-4 و PDF/UA باستخدام C++. اختر أفضل معيار PDF لتحويل مستند باستخدام С ++."
type: docs
weight: 35
...
PDF/A هو ISO-نسخة موحدة من PDF مخصصة للاستخدام في الأرشفة والتخزين طويل الأجل للوثائق الإلكترونية. في الوقت نفسه، PDF/UA هي نسخة أخرى ISO موحدة من PDF مصممة لضمان إمكانية الوصول للأشخاص ذوي الإعاقة الذين يستخدمون التكنولوجيا المساعدة. لتحديد مستوى الامتثال لمعايير PDF، استخدم خاصية [Compliance](https://reference.aspose.com/words/cpp/aspose.words.saving/pdfsaveoptions/get_compliance/). نظرا لظروف التخزين، يجب تضمين PDF/A المستند جميع الخطوط وتعطيل التشفير، بينما يجب تضمين PDF/UA جميع الخطوط فقط.

في هذا القسم، سنلقي نظرة فاحصة على العمل مع المستندات PDF/A أو PDF/UA-1.

## ذات الصلة ISO لمعايير PDF

لمعرفة المزيد حول معايير PDF المختلفة، تحقق مما يلي ISO ق:
