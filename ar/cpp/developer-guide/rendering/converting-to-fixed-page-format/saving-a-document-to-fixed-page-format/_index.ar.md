...
- لاعب ملف التعريف ([MetafileRenderingOptions](https://reference.aspose.com/words/cpp/aspose.words.saving/fixedpagesaveoptions/get_metafilerenderingoptions/)). لمزيد من التفاصيل، راجع [المناولة Windows ملفات التعريف](/words/ar/cpp/handling-windows-metafiles/) المادة.
