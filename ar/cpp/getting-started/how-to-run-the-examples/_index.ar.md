...
- بالنسبة لأمثلة **API Reference**، يعتمد الهيكل على أسماء الفئات، وبالنسبة لأمثلة **Docs**، فإنه يعتمد في الغالب على [المطور جيلد](/words/ar/cpp/developer-guide/) قسم التوثيق.
