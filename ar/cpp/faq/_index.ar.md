...
linktitle: FAQ
type: docs
description: "Aspose.Words ل C++ يجيب على الأسئلة الأكثر شيوعا. تعلم هذه الصفحة لحل مشكلتك بسرعة على الأسئلة العامة أو مواضيع محددة."
weight: 75
url: /ar/cpp/faq/
...
إذا لم تجد إجابة لسؤالك، يمكنك أن تسأل في منتدى الدعم. للحصول على معلومات حول كيفية الإبلاغ عن سؤالك أو مشكلتك بشكل صحيح، راجع [الدعم الفني](/words/ar/cpp/technical-support/) الصفحة.
...
Aspose.Words ل C++ لا تحتاج إلى تثبيت أي تطبيقات طرف ثالث أو حزم برامج إضافية للعمل. مجرد تحميل وتثبيت Aspose.Words كما هو موضح في ["التثبيت"](/words/ar/cpp/installation/) المادة وتبدأ.
...
لمزيد من التفاصيل، راجع [نظرة عامة على المنتج](/words/ar/cpp/product-overview/) الصفحة.
...
يمكنك رؤية القائمة الكاملة للتنسيقات المدعومة على [تنسيقات المستندات المدعومة](/words/ar/cpp/supported-document-formats/) الصفحة.
...
انظر ال [الترخيص والاشتراك](/words/ar/cpp/licensing/) الصفحة لمزيد من المعلومات.
...
بعد الشراء، تقدم بطلب للحصول على الترخيص كما هو موضح في [الرخصة المشتراة](/words/cpp/licensing/#purchased-license) القسم.

تفاصيل حول كيفية تثبيت Aspose.Words يمكن قراءتها على [تركيب](/words/ar/cpp/installation/) الصفحة.

------

**س: كيف يمكنني الحصول على الدعم?**

استخدم منتدى الدعم الفني المجاني. للحصول على تفاصيل حول كيفية الإبلاغ عن مشكلة بشكل صحيح وما يجب القيام به قبل الاتصال بالمنتدى، راجع [الدعم الفني](/words/ar/cpp/technical-support/) الصفحة.

## تقديم وثيقة

{{% alert color="primary" %}}

يمكنك العثور على مزيد من المعلومات التفصيلية حول العرض في [تقديم](/words/ar/cpp/rendering/) قسم التوثيق.

{{% /alert %}}

**س: لماذا يختلف التخطيط والخطوط في مستند الإخراج عن الأصل?**

قد لا يكون الخط متاحا، أو أن تنسيق الخط مدعوم بـ Microsoft Word ولكن غير مدعوم بـ Aspose.Words. Aspose.Words سوف تؤدي [استبدال الخط](/words/ar/cpp/manipulate-and-substitute-truetype-fonts/).

للتحقق مما إذا كان الخط مفقودا:

- في Aspose.Words استخدم تحذيرات استبدال الخط (للحصول على التفاصيل، راجع قسم " كيفية التعرف على استبدال الخط [التلاعب واستبدال TrueType الخطوط](/words/ar/cpp/manipulate-and-substitute-truetype-fonts/) المادة).
...
تتطلب بعض خطوط البرامج النصية المعقدة معالجة ميزات الطباعة المتقدمة لعرضها بشكل صحيح. يتم تعطيل الطباعة المتقدمة في Aspose.Words بشكل افتراضي. يجب على المستخدمين تمكين الطباعة المتقدمة باستخدام [TextShaperFactory](https://reference.aspose.com/words/cpp/aspose.words.layout/layoutoptions/get_textshaperfactory/).
...
يمكنك العثور على مزيد من المعلومات التفصيلية حول البرمجة مع المستندات في [البرمجة مع الوثائق](/words/ar/cpp/programming-with-documents/) قسم التوثيق.

{{% /alert %}}

**س: لماذا لا يظهر المحتوى الملحق بمستند في نفس الصفحة?**

تظهر نتيجة الإلحاق في صفحة منفصلة بسبب اختلاف في إعدادات [PageSetup](https://reference.aspose.com/words/cpp/aspose.words/pagesetup/) للأقسام التي يتم فيها إلحاق المستندات معا. قم بعمل إعدادات **PageSetup** متطابقة للأقسام التي يتم إلحاق المستندات بها معا.

## تحويل مستند

{{% alert color="primary" %}}

يمكنك العثور على مزيد من المعلومات التفصيلية حول تحويل مستند في [تحويل مستند](/words/ar/cpp/convert-a-document/) قسم التوثيق.
