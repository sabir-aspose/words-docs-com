...
type: docs
weight: 30
description: "ترجمة وثيقة. Aspose.Words ل C++ يبسط ترجمة المستندات باستخدام نماذج جوجل AI، مما يسمح لك بتحديد اللغة الهدف."
ai_search_scope: words_cpp
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
url: /ar/cpp/translate-a-document/
...
استخدم طريقة [Translate](https://reference.aspose.com/words/cpp/aspose.words.ai/iaimodeltext/translate/) لترجمة مستنداتك إلى أي لغة ممثلة في تعداد [Language](https://reference.aspose.com/words/cpp/aspose.words.ai/language/). لاحظ أنه إذا كان المستند المصدر يحتوي على عدة لغات، فسيكون النموذج المستند إلى جوجل AI قادرا على ترجمة جميع اللغات المدعومة. إذا لم يتمكن النموذج من التعرف على اللغة في بعض أجزاء النص، فسيتم إرجاع مستند به هذه الأجزاء غير المترجمة ومع ترجمة بقية النص.
...
توفر ترجمة المستندات باستخدام Aspose.Words الوقت وتجعل من السهل دمج وظائف الترجمة في مشاريعك. لمزيد من المعلومات، راجع وثائق [Aspose.Words.AI](https://reference.aspose.com/words/cpp/aspose.words.ai/) API.
