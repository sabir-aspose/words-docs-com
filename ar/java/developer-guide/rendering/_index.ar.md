...
- عرض كائن [Shape](https://reference.aspose.com/words/java/com.aspose.words/shape/) بشكل منفصل عن المستند إلى أي تنسيق صورة أو إلى كائن `Graphics`.
- اعرض أي صفحة من المستند في مكون التأرجح.
- قم بطباعة أو معاينة صفحات المستند باستخدام البنية الأساسية القياسية للطباعة Java.
