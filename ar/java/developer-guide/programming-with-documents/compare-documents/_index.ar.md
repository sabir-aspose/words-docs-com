...
لاحظ أنه يمكنك مقارنة أي وثيقتين داخل [تنسيقات الملفات المدعومة](/words/ar/java/supported-document-formats/). في الأساس، يمكنك مقارنة كائنات المستند وحتى يمكنك إنشاء هذه الكائنات من البداية دون وجود أي تنسيق محدد.
