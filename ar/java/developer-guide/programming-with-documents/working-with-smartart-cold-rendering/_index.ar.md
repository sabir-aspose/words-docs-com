---
title: العمل مع SmartArt التقديم البارد في Java
...
* إذا كان الرسم المعروض مسبقا موجودا ولكنه غير صحيح، فيجب إجراء SmartArt عرض بارد بشكل صريح عن طريق استدعاء طريقة [UpdateSmartArtDrawing](https://reference.aspose.com/words/java/com.aspose.words/shape/#updateSmartArtDrawing).
