...
نظرا لأن القسم عبارة عن عقدة مركبة عادية، يمكن استخدام معالجة العقدة بأكملها API لمعالجة الأقسام: للإضافة والإزالة والعمليات الأخرى على الأقسام. يمكنك قراءة المزيد عن العقد في المقالة [Aspose.Words نموذج كائن المستند (DOM)](/words/ar/java/aspose-words-document-object-model/).
...
- [إدراج المستندات وإلحاقها](/words/ar/java/insert-and-append-documents/)
