---
title: حماية أو تشفير مستند في Java
...
| ------------------------------- | ------------------------------ | ------------------------------------------------------------ |
| للقراءة فقط | "اجعل المستند للقراءة فقط" | افتح دائما للقراءة فقط (ملف-معلومات-حماية المستند)<br />ميزة بديلة: "كلمة المرور لتعديل" (حفظ باسم-أدوات-خيارات عامة-كلمة المرور) |
