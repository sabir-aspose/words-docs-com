...
Aspose.Words يسمح للمستخدمين بالعمل مع المستندات بتنسيقات مختلفة ويوفر مجموعة واسعة من الخيارات لذلك. على سبيل المثال، يمكن للمستخدمين إنشاء مستند من البداية أو تحميل ملف موجود في أي [تنسيق الاستيراد المدعوم](/words/ar/java/supported-document-formats/)، قم بإجراء بعض التغييرات على هذا المستند ثم احفظ النتيجة. عند استيراد مستند بالتنسيق المحدد، يمكن للمستخدم تطبيق خيارات تحميل مختلفة.
