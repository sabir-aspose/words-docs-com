...
تعرف على مزيد من التفاصيل حول الإصدار التجريبي المجاني أو الترخيص المؤقت لـ Aspose.Words لـ Android عبر Java على [صفحة الترخيص والاشتراك](/words/ar/java/licensing/).
...
في Aspose.Words إلى عن على Android عبر Java، يمكن أن يكون الترخيص [جزءا لا يتجزأ من كمورد](/words/ar/java/licensing/)، أو تحميلها من تيار:
