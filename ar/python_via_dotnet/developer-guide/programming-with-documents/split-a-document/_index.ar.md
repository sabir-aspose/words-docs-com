...
يمكنك تحديد المعايير باستخدام تعداد [DocumentSplitCriteria](https://reference.aspose.com/words/python-net/aspose.words.saving/documentsplitcriteria/). لذا يمكنك تقسيم المستند إلى فصول باستخدام أحد المعايير التالية أو دمج أكثر من معيار معًا:
...
عند حفظ الإخراج إلى HTML، يقوم Aspose.Words بحفظ كل فصل على حدة كملف HTML منفصل. ونتيجة لذلك، سيتم تقسيم المستند إلى ملفات HTML متعددة. عند حفظ الإخراج إلى EPUB، يحفظ Aspose.Words النتيجة في ملف EPUB واحد بغض النظر عن قيمة [DocumentSplitCriteria](https://reference.aspose.com/words/python-net/aspose.words.saving/documentsplitcriteria/) التي استخدمتها. لذلك، فإن استخدام [DocumentSplitCriteria](https://reference.aspose.com/words/python-net/aspose.words.saving/documentsplitcriteria/) لمستندات EPUB يؤثر فقط على مظهر محتواها في تطبيقات القارئ: سيتم تقسيم المحتوى إلى فصول ولن يظهر المستند بعد ذلك بشكل مستمر.

{{% alert color="primary" %}}

لا يمكنك تقسيم مستند باستخدام خاصية [document_split_criteria](https://reference.aspose.com/words/python-net/aspose.words.saving/htmlsaveoptions/document_split_criteria/) عند الحفظ بتنسيق MHTML.
...
لتقسيم مستند إلى فصول حسب العناوين، استخدم قيمة [HEADING_PARAGRAPH](https://reference.aspose.com/words/python-net/aspose.words.saving/documentsplitcriteria/#HEADING_PARAGRAPH) لخاصية [document_split_criteria](https://reference.aspose.com/words/python-net/aspose.words.saving/htmlsaveoptions/document_split_criteria/).

إذا كنت بحاجة إلى تقسيم مستند حسب مستوى معين من فقرات العناوين، مثل العناوين 1 و2 و3، فاستخدم أيضًا خاصية [document_split_heading_level](https://reference.aspose.com/words/python-net/aspose.words.saving/htmlsaveoptions/document_split_heading_level/). سيتم تقسيم المخرجات على فقرات منسقة بمستوى العنوان المحدد.
...
يمكّنك Aspose.Words أيضًا من استخدام فواصل الأقسام لتقسيم المستندات وحفظها بتنسيق HTML. لهذا الغرض، استخدم [SECTION_BREAK](https://reference.aspose.com/words/python-net/aspose.words.saving/documentsplitcriteria/#section_break) باعتباره [document_split_criteria](https://reference.aspose.com/words/python-net/aspose.words.saving/htmlsaveoptions/document_split_criteria/):
...
يوضح مثال التعليمات البرمجية التالي كيفية تقسيم مستند إلى أجزاء أصغر عن طريق فواصل المقاطع (دون استخدام خاصية [document_split_criteria](https://reference.aspose.com/words/python-net/aspose.words.saving/htmlsaveoptions/document_split_criteria/)):
...
## التقسيم حسب الصفحات {#splitting-by-pages}

يمكنك أيضًا تقسيم صفحة مستند بصفحة، أو حسب نطاقات الصفحات، أو البدء بأرقام الصفحات المحددة. في مثل هذه الحالة، يمكن لطريقة [extract_pages](https://reference.aspose.com/words/python-net/aspose.words/document/extract_pages/) القيام بهذه المهمة.

يصف هذا القسم العديد من حالات الاستخدام لتقسيم المستندات عن طريق الترحيل إلى صفحات باستخدام فئة [Document](https://reference.aspose.com/words/python-net/aspose.words/document/) وطريقة [extract_pages](https://reference.aspose.com/words/python-net/aspose.words/document/extract_pages/).

{{% alert color="primary" %}}

يمكنك استخدام أي [تنسيقات المستندات المدعومة](/words/ar/python-net/supported-document-formats/).
...
## دمج المستند المقسم مع ملف {#merge-the-split-document-with-another-file} آخر
