...
<details>
    ...
    <ol>
      <li>منظم بقوة. تتداخل عناصر التجميع في أي عدد من المستويات حسب الضرورة لتعكس تنظيم المادة في مقالات وأقسام وأقسام فرعية وما إلى ذلك. في كل مستوى، يجب أن تتكون العناصر الفرعية لعنصر التجميع من عنوان (H)، وفقرة واحدة أو أكثر (P) للمحتوى على ذلك المستوى، وربما عنصر تجميع إضافي واحد أو أكثر للأقسام الفرعية المتداخلة.</li>
...
<details>
    ...
    <img src="/words/python-net/working-with-pdfa-or-pdfua/m-w-heading1-2.png" alt="العنوان 1-2" style="width:800px"/>
...
<details>
    ...
    <img src="/words/python-net/working-with-pdfa-or-pdfua/m-w-decorative-shape.png" alt="MWDecoratedShape" style="width:800px"/>
...
<details>
    ...
    <img src="/words/python-net/working-with-pdfa-or-pdfua/m-w-language.png" alt="لغة ميغاواط" style="width:800px"/>
