...
type: docs
description: "Convierta fácilmente documentos de un formato a otro usando C++. Puede trabajar con todos los formatos más populares, como formatos de Microsoft Word como DOCX o DOC, formatos OpenDocument como ODT o OTT, formatos web como HTML o XHTML, formatos de texto como MarkDown o TXT, y otros."
...
<div class="row">
	<div class="col-md-6">
		...
		<h2>Convertir Imagen a PDF</h2>
			<ul>
				<li><a href="/words/cpp/convert-a-document-to-pdf/#convert-an-image-to-pdf">Convertir JPG a PDF</a></li>
	...
	<div class="col-md-6">
		<h2>Convertir un Documento en una imagen</h2>
			<ul>
				<li><a href="/words/cpp/convert-a-document-to-an-image/">Convertir DOCX a JPG</a></li>
				<li>Convertir DOC a PNG</li>
				<li>y otros</li>
			</ul>
		<h2>Convertir un documento a Markdown</h2>
			<ul>
				<li><a href="/words/cpp/convert-a-document-to-markdown/">Convertir un documento a Markdown</a></li>
				<li>Convertir HTML a Markdown</li>
				<li>y otros</li>
			</ul>
		<h2>Convertir un Documento a HTML</h2>
			<ul>
				<li><a href="/words/cpp/convert-a-document-to-html-mhtml-or-epub/#convert-a-document">Convertir Word a HTML</a></li>
		...
		<h2>Otros Ejemplos</h2>
			<ul>
				<li><a href="/words/cpp/convert-a-document-to-mhtml-and-send-it-by-email/">Convierta un Documento a MHTML y Envíelo por correo electrónico</a></li>
