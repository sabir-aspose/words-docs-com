...
linktitle: La conversión es la característica insignia de Aspose.Words
...
Los escenarios escalables del lado del servidor usan Aspose.Words principalmente debido a su diseño simple y limpio: Aspose.Words admite subprocesos múltiples. los objetos [Document](https://reference.aspose.com/words/cpp/aspose.words/document/) son independientes entre sí, y siempre que solo un subproceso pueda modificar un documento a la vez (un requisito típico para cualquier clase de colección), varios subprocesos pueden procesar cualquier número de documentos al mismo tiempo.
