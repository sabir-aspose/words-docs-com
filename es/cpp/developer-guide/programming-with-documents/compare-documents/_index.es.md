...
Comparar documentos es una característica muy compleja. Hay varias partes de la combinación de contenido que deben analizarse para reconocer todas las diferencias. La razón de esta complejidad se debe al hecho de que Aspose.Words tiene como objetivo obtener los mismos resultados de comparación que el algoritmo de comparación de Microsoft Word.
...
Tenga en cuenta que puede comparar dos documentos cualesquiera dentro del [formatos de archivo admitidos](/words/es/cpp/supported-document-formats/). Puedes comparar objetos de documento e incluso puedes crear esos objetos desde cero sin tener ningún formato específico.
