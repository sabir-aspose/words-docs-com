...
## Aspose.Words por .NET 25.5, 25.6
...
Se ha introducido la capacidad de controlar cómo se exportan los párrafos vacíos a Markdown agregando la enumeración [MarkdownEmptyParagraphExportMode](https://reference.aspose.com/words/net/aspose.words.saving/markdownemptyparagraphexportmode/) y la propiedad [EmptyParagraphExportMode](https://reference.aspose.com/words/net/aspose.words.saving/markdownsaveoptions/emptyparagraphexportmode/).

#### Exporte Documentos de Varias páginas a Formatos de Imagen Rasterizada <sup>25.6</sup>

Se ha introducido la capacidad de exportar documentos de varias páginas a formatos de imagen ráster (como PNG y JPEG) con [customizable layouts](https://reference.aspose.com/words/net/aspose.words.saving/multipagelayout/) (Horizontal, Vertical o Cuadrícula) al ampliar la funcionalidad de exportación de imágenes.

### Renderizado

#### Configuración del Estilo del Gráfico <sup>25.5</sup>

La capacidad de establecer el estilo del gráfico se ha introducido agregando la enumeración [ChartStyle](https://reference.aspose.com/words/net/aspose.words.drawing.charts/chartstyle/) y la propiedad [Style](https://reference.aspose.com/words/net/aspose.words.drawing.charts/chart/style/).
...
Se ha introducido la representación de leyendas para ["Waterfall" charts](https://reference.aspose.com/words/net/aspose.words.drawing.charts/chartseriestype/), lo que aumenta la transparencia de los datos y mejora la interpretabilidad de estos gráficos.
...
Más información sobre [Aspose.Words para .NET 25.5 Notas de la versión](https://releases.aspose.com/words/net/release-notes/2025/aspose-words-for-net-25-5-release-notes/).

Más información sobre [Aspose.Words para .NET 25.6 Notas de la versión](https://releases.aspose.com/words/net/release-notes/2025/aspose-words-for-net-25-6-release-notes/).
...
## Aspose.Words por .NET 24.9, 24.10, 24.11, 24.12
