...
- El tamaño del papel del documento es [PaperSize](https://reference.aspose.com/words/es/net/aspose.words/papersize/).**Letter**.

{{% /alert %}}

## Cargar un documento {#load-a-document}

Para cargar un documento existente en cualquiera de los formatos [LoadFormat](https://reference.aspose.com/words/es/net/aspose.words/loadformat/), pase el nombre del archivo o la secuencia a uno de los constructores de documentos. El formato del documento cargado está determinado automáticamente por su extensión.
