...
También puede especificar el nivel de compresión al guardar usando la propiedad [CompressionLevel](https://reference.aspose.com/words/es/net/aspose.words.saving/xlsxsaveoptions/compressionlevel/).
