...
Tenga en cuenta que si solo busca los nombres de los campos de combinación en un documento, puede utilizar el método [GetFieldNames](https://reference.aspose.com/words/es/net/aspose.words.mailmerging/mailmerge/getfieldnames/) integrado.
