...
La pestaña Tipografía asiática del cuadro de diálogo de propiedades de párrafo en Microsoft Word tiene un grupo de salto de línea. Las opciones de este grupo se pueden configurar utilizando las propiedades [FarEastLineBreakControl](https://reference.aspose.com/words/es/net/aspose.words/paragraphformat/fareastlinebreakcontrol/), [WordWrap](https://reference.aspose.com/words/es/net/aspose.words/paragraphformat/wordwrap/), [HangingPunctuation](https://reference.aspose.com/words/es/net/aspose.words/paragraphformat/hangingpunctuation/) de la clase **ParagraphFormat**.
