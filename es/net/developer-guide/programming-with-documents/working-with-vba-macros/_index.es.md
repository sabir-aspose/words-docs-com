...
- La clase [VBAProject](https://reference.aspose.com/words/es/net/aspose.words.vba/vbaproject/) proporciona acceso a la información del proyecto VBA.
- La clase [VBAModuleCollection](https://reference.aspose.com/words/es/net/aspose.words.vba/vbamodulecollection/) devuelve la colección de módulos del proyecto VBA.
- La clase [VbaModule](https://reference.aspose.com/words/es/net/aspose.words.vba/vbamodule/) proporciona acceso al módulo de proyecto VBA.
- La enumeración [VbaModuleType](https://reference.aspose.com/words/es/net/aspose.words.vba/vbamoduletype/) define los tipos de un modelo en un proyecto VBA. El módulo puede ser un módulo de procedimiento, un módulo de documento, un módulo de clase o un módulo de diseñador.

## Crear un proyecto VBA

Aspose.Words API proporciona la propiedad [VbaProject](https://reference.aspose.com/words/es/net/aspose.words/document/vbaproject/) para obtener o configurar VbaProject en el documento.
...
El siguiente ejemplo de código muestra cómo modificar macros de VBA utilizando la propiedad [SourceCode](https://reference.aspose.com/words/es/net/aspose.words.vba/vbamodule/sourcecode/):
...
El siguiente ejemplo de código muestra cómo clonar el proyecto VBA utilizando la propiedad [Clone](https://reference.aspose.com/words/es/net/aspose.words.vba/vbaproject/clone/) que crea una copia del proyecto existente:
...
El siguiente ejemplo de código muestra cómo clonar el módulo VBA usando la propiedad [Clone](https://reference.aspose.com/words/es/net/aspose.words.vba/vbamodule/clone/) que crea una copia del proyecto existente:
...
Aspose.Words API proporciona la clase [VbaReferenceCollection](https://reference.aspose.com/words/es/net/aspose.words.vba/vbareferencecollection/) para trabajar con referencias de proyectos VBA que representan una colección de referencias de proyectos VBA.
