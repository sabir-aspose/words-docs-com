---
title: Etiquetas de documentos estructurados
...
description: "Incorpore la semántica definida por el cliente, así como su comportamiento y apariencia, en un documento utilizando etiquetas de documento estructuradas (SDT o control de contenido) en Python."
type: docs
weight: 50
...
[StructuredDocumentTag](https://reference.aspose.com/words/python-net/aspose.words.markup/structureddocumenttag/) puede aparecer en un documento en los siguientes lugares:
