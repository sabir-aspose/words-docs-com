...
## Aspose.Words por Python via .NET 25.1, 25.2
...
#### Documento AI Revisión gramatical <sup>25.1</sup>

La capacidad de verificar la gramática del documento proporcionado utilizando modelos generativos OpenAI se ha introducido agregando un nuevo método [check_grammar](https://reference.aspose.com/words/python-net/aspose.words.ai/iaimodeltext/check_grammar/).

#### Resumen Utilizando Modelos De Lenguaje Generativo Antrópico <sup>25.2</sup>

La síntesis de texto utilizando modelos de lenguaje generativo antrópico se ha habilitado al introducir una nueva clase pública [AnthropicAiModel](https://reference.aspose.com/words/python-net/aspose.words.ai/anthropicaimodel/).
