...
- [Comparar documentos](/words/es/python-net/compare-documents/)
- [Clonar un documento](/words/es/python-net/clone-a-document/)
- [Insertar y adjuntar documentos](/words/es/python-net/insert-and-append-documents/)
- [Dividir un documento](/words/es/python-net/split-a-document/)
- [Encontrar y reemplazar](/words/es/python-net/find-and-replace/)
...
- [Extraer contenido entre nodos](/words/es/python-net/how-to-extract-selected-content-between-nodes-in-a-document/)
...
- [Seguimiento de cambios en un documento](/words/es/python-net/track-changes-in-a-document/)
- [Trabajar con formas](/words/es/python-net/working-with-shapes/)
- [Trabajar con forma de grupo en documentos de Word](/words/es/python-net/how-to-add-group-shape-into-a-word-document/)
- [Trabajar con imágenes](/words/es/python-net/working-with-images/)
- [Trabajar con gráficos](/words/es/python-net/working-with-charts/)
