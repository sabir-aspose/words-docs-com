...
|  --------------------------------  |  ------------------------------------------------------------  |
|  *FileLoadException* |  Un archivo PDF no se puede procesar por algún motivo.<br /> {{% alert color="primary" %}}Puede informar el problema al equipo de desarrollo para una investigación detallada utilizando [Apoyo técnico](/words/es/python-net/technical-support/).{{% /alert %}}. |
