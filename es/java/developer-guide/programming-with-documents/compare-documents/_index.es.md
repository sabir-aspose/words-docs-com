...
Tenga en cuenta que puede comparar dos documentos cualesquiera dentro del [formatos de archivo admitidos](/words/es/java/supported-document-formats/). Básicamente, puedes comparar objetos de documentos e incluso puedes crear esos objetos desde cero sin tener ningún formato específico.
