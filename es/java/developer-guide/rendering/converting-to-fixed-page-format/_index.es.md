...
- Un reproductor de metarchivos ([MetafileRenderingOptions](https://reference.aspose.com/words/java/com.aspose.words/fixedpagesaveoptions/). Para obtener más detalles, consulte el [Manejo de Metarchivos Windows](/words/es/java/handling-windows-metafiles/) artículo.
