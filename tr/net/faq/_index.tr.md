...
linktitle: SSS – .NET için Aspose.Words
articleTitle: SSS
linktitle: SSS
type: docs
...
Sorunuzun cevabını bulamadıysanız destek forumunda sorabilirsiniz. Sorunuzu veya sorununuzu doğru bir şekilde nasıl bildireceğinize ilişkin bilgi için [Teknik Destek](/words/tr/net/technical-support/) sayfasına bakın.

{{% alert color="primary" %}}

Sıkça sorulan sorular size kolaylık sağlamak amacıyla konuya göre gruplandırılmıştır.
...
.NET için Aspose.Words'in çalışması için herhangi bir üçüncü taraf uygulamasının veya ek yazılım paketinin yüklenmesine gerek yoktur. Aspose.Words'i [Kurulum](/words/tr/net/installation/) makalesinde açıklandığı şekilde indirip yükleyin ve başlayın.
...
Ayrıntılar için [Ürüne Genel Bakış](/words/tr/net/product-overview/) sayfasına ve [Platformlar ve Interop'in Kullanılabilirliği](/words/net/platforms-and-interoperability/) bölümüne bakın.
...
Desteklenen formatların tam listesini [Desteklenen Belge Formatları](/words/tr/net/supported-document-formats/) sayfasında görebilirsiniz.
...
Daha fazla bilgi için [Lisanslama ve Abonelik](/words/tr/net/licensing/) sayfasına bakın.

{{% alert color="primary" %}}

[Aspose.Words ücretsiz çevrimiçi Uygulamalar](https://products.aspose.app/words) aracılığıyla en popüler Aspose.Words özelliklerinden bazılarını da deneyebilirsiniz.
...
Aspose.Words lisansı satın almak için [Satın almak](https://purchase.aspose.com/buy) sayfasına gitmeniz, "Aspose.Words" ürününü ve size uygun lisans türünü seçmeniz gerekmektedir. Daha sonra lisansı sepetinize ekleyin ve Alışveriş Sepeti talimatlarını takip edin.

Satın aldıktan sonra [Satın Alınan Lisans](/words/net/licensing/#purchased-license) bölümünde açıklandığı gibi lisans başvurusunda bulunun.

Aspose.Words'in nasıl kurulacağına ilişkin ayrıntılar [Kurulum](/words/tr/net/installation/) sayfasında okunabilir.

------

**S: Nasıl destek alabilirim?**

Ücretsiz teknik destek forumunu kullanın. Bir sorunun doğru bir şekilde nasıl bildirileceği ve forumla iletişime geçmeden önce yapılması gerekenler hakkında ayrıntılar için [Teknik Destek](/words/tr/net/technical-support/) sayfasına bakın.

## Belge Oluşturma

{{% alert color="primary" %}}

Oluşturma hakkında daha ayrıntılı bilgiyi [İşleme](/words/tr/net/rendering/) dokümantasyon bölümünde bulabilirsiniz.

{{% /alert %}}

**S: Çıktı belgesindeki düzen ve yazı tipleri neden orijinalden farklı?**

Yazı tipi mevcut olmayabilir veya yazı tipi formatı Microsoft Word tarafından destekleniyor ancak Aspose.Words tarafından desteklenmiyor olabilir. Aspose.Words [TrueType Yazı Tiplerini Değiştirme ve Değiştirme](/words/tr/net/manipulating-and-substitution-truetype-fonts/) gerçekleştirecektir.

Yazı tipinin eksik olup olmadığını kontrol etmek için:

* Aspose.Words'te Yazı Tipi değiştirme uyarılarını kullanın (ayrıntılar için [TrueType Yazı Tiplerini Değiştirme ve Değiştirme](/words/tr/net/manipulating-and-substitution-truetype-fonts/) makalesinin "Yazı Tipinin Değiştirildiği Nasıl Anlaşılır" bölümüne bakın).
...
`APS.NET`'te orta güven seviyesinde sistem yazı tipleri klasörüne erişim yoktur. Kullanıcıların yazı tiplerini kendi klasörlerinde saklaması gerekir.
...
Bazı Unicode karakterler yerine sıklıkla `.notdef` glyph'yi görebiliriz. Bu genellikle bir kutu veya soru glyph'sidir.
...
Dokümanlarla programlama hakkında daha detaylı bilgiyi [Belgelerle Programlama](/words/tr/net/programming-with-documents/) dokümantasyon bölümünde bulabilirsiniz.
...
Bir belgeyi dönüştürme hakkında daha ayrıntılı bilgiyi [Belgeyi Dönüştür](/words/tr/net/convert-a-document/) belgeleri bölümünde bulabilirsiniz.
...
Ayrıntılı bir cevap için [Aspose.Words'i Docker'de Çalıştırma](/words/tr/net/how-to-run-aspose-words-in-docker/) makalesini öğrenin.
