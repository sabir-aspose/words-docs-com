...
description: "C#'teki alanların nasıl kaldırılacağını öğrenin. Alanları programlı olarak .NET API kullanarak kaldırın."
type: docs
weight: 35
...
Bu örneğin örnek dosyasını [Aspose.Words GitHub](https://github.com/aspose-words/Aspose.Words-for-.NET/blob/master/Examples/Data/Various%20fields.docx)'ten indirebilirsiniz.
