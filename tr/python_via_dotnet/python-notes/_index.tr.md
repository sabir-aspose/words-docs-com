---
title: Python ve .NET Versiyon Farkları
second_title: Python via .NET için Aspose.Words
articleTitle: Python ve .NET Versiyon Farkları
linktitle: Python ve .NET Versiyon Farkları
...
* Python kodundan [DocumentVisitor](https://reference.aspose.com/words/python-net/aspose.words/documentvisitor/) uygulaması şu anda mümkün değildir.
...
Aspose.Words DOM'deki tüm belge düğümlerinin temel sınıfı [Node](https://reference.aspose.com/words/python-net/aspose.words/node/) sınıfıdır. Örneğin, [get_child](https://reference.aspose.com/words/python-net/aspose.words/compositenode/get_child/) yöntemi, [Node](https://reference.aspose.com/words/python-net/aspose.words/node/) sınıfının örneğini döndürür, ancak döndürülen düğümü değiştirmeniz gerekiyorsa, çoğu durumda onu somut türe dönüştürmeniz gerekir. Aşağıdaki kod, belgedeki ilk [Run](https://reference.aspose.com/words/python-net/aspose.words/run/)'un yazı tipi renginin nasıl değiştirileceğini gösterir:
...
[clone](https://reference.aspose.com/words/python-net/aspose.words/document/clone/) yöntemi kullanıldığında döküm de gerekli olabilir:
...
C# kodunda yayınlama için `(Paragraph)node`'yi nerede kullanacağınızı fark etmiş olabileceğiniz gibi, Python'de `node.as_paragraph()` yöntemini kullanmanız gerekir. Aspose.Words'un Python sürümünde [Node](https://reference.aspose.com/words/python-net/aspose.words/node/) sınıfı, `as_xxx` yöntemlerinin aşağıdaki bağlantısını sunar:
...
Fark edebileceğiniz gibi [Field](https://reference.aspose.com/words/python-net/aspose.words.fields/field/) nesnesi ayrıca aşağıda listelenen bir dizi `as_xxx` yöntemini de sağlar:
...
[FontSourceBase](https://reference.aspose.com/words/python-net/aspose.words.fonts/fontsourcebase/) sınıfı, aşağıda listelenen `as_xxx` yöntemleri kümesini sağlar:
...
Python dünyasına daha yakın olmak amacıyla, Python via .NET için Aspose.Words'in API üyeleri Pythonic yılan stilini kullanır, ancak çoğu durumda .NET API için Aspose.Words'de bire bir analoga sahiptirler. Bu analogları [xml dosyası](/words/python-net/python-notes/wrapper.zip)'de bulabilirsiniz.
