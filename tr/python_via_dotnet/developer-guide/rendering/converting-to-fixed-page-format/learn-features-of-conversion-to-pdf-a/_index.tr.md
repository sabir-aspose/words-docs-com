...
Bu bölümde çeşitli PDF standartlarındaki belgelerle çalışırken ortaya çıkabilecek ana sorunları ele alacağız ve bunları çözme seçeneklerini açıklayacağız.

## Aspose.Words Hangi PDF Standardını Destekliyor?

Aspose.Words artık kullanıcıların PDF/UA-1'in yanı sıra PDF/A-1, PDF/A-2 ve PDF/A-4 formatlarıyla çalışmasına olanak tanıyor:
...
PDF/A, elektronik belgelerin arşivlenmesinde ve uzun süreli saklanmasında kullanılmak üzere tasarlanmış, ISO standardize edilmiş bir PDF sürümüdür. Aynı zamanda PDF/UA, yardımcı teknoloji kullanan engelli kişiler için erişilebilirlik sağlamak üzere tasarlanmış PDF'nin başka bir ISO standartlaştırılmış sürümüdür. PDF standartlarıyla uyumluluk düzeyini belirlemek için [PdfSaveOptions.compliance](https://reference.aspose.com/words/python-net/aspose.words.saving/pdfsaveoptions/compliance/) özelliğini kullanın. Depolama koşulları nedeniyle, PDF/A belgesinin tüm yazı tiplerini yerleştirmesi ve şifrelemeyi devre dışı bırakması gerekirken, PDF/UA'nın yalnızca tüm yazı tiplerini yerleştirmesi gerekir.
