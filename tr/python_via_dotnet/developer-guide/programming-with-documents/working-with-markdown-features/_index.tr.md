---
title: Markdown Özellikleriyle Çalışmak
second_title: Python via .NET için Aspose.Words
articleTitle: Markdown Özellikleriyle Çalışmak
linktitle: Markdown Özellikleriyle Çalışmak
description: "Python kullanılarak Markdown özellikleri nasıl uygulanır? Tüm özellikler karşılık gelen stiller veya doğrudan biçimlendirme olarak temsil edilir."
type: docs
weight: 420
ai_search_scope: words_python
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
ai_search_fast_endpoint: "https://docsearch.api.aspose.cloud/search"
url: /tr/python-net/working-with-markdown-features/
...
- Kalın ve İtalik, [Font.bold](https://reference.aspose.com/words/python-net/aspose.words/font/bold/) ve [Font.Italic](https://reference.aspose.com/words/python-net/aspose.words/font/italic/) olarak temsil edilir
...
[Markdown'i Document Object Model'ye (DOM) çevir](/words/tr/python-net/translate-markdown-to-document-object-model/) makalesinde açıklanan Markdown'i Aspose.Words Document Object Model'e (DOM) çevirmenin nüansları vardır.
...
## Yatay Cetvelli Markdown Belgesi
...
Aspose.Words API, bir belgeyi Markdown formatında kaydederken ek seçenekleri belirlemek için [MarkdownSaveOptions](https://reference.aspose.com/words/python-net/aspose.words.saving/markdownsaveoptions/) sınıfı sağlar.
...
Aspose.Words API, Markdown belgesine dışa aktarırken tablolardaki içerikleri hizalamak için hizalama yönlerini tanımlayan [TableContentAlignment](https://reference.aspose.com/words/python-net/aspose.words.saving/tablecontentalignment/) numaralandırması sağlar. Aşağıdaki kod örneği, tablonun içindeki içeriğin nasıl hizalanacağını gösterir.
