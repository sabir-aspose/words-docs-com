...
|  **ATX Heading**<br /> `# H1, ## H2, ### H3…` |  `ParagraphFormat.style_name = "Heading N"`, burada (1&le; N &le; 9).<br /> Bu, yerleşik bir stile dönüştürülür ve tam olarak belirtilen modelde olmalıdır (hiçbir sonek veya öneklere izin verilmez).<br /> Aksi takdirde, karşılık gelen stile sahip sıradan bir paragraf olacaktır |
