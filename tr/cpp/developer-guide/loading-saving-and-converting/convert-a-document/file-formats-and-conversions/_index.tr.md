...
linktitle: Dönüşüm Aspose.Words ' Amiral Gemisi Özelliğidir
...
Bu gibi durumlarda, Aspose.Words dönüşümün "yüksek doğruluk" olarak işaretlendiğini ve çıktı belgesinin Microsoft Word üzerinden dönüştürdükten sonraki ile aynı olacağını unutmayın.
...
Ölçeklenebilir sunucu tarafı senaryoları, temel olarak basit ve temiz tasarımı nedeniyle Aspose.Words kullanır – Aspose.Words çoklu iş parçacığını destekler. [Document](https://reference.aspose.com/words/cpp/aspose.words/document/) nesneler birbirinden bağımsızdır ve bir seferde yalnızca bir iş parçacığı bir belgeyi değiştirebildiği sürece (herhangi bir koleksiyon sınıfı için tipik bir gereklilik), birden çok iş parçacığı aynı anda herhangi bir sayıda belgeyi işleyebilir.
