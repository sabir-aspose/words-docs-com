...
articleTitle: 使用连字符
linktitle: 使用连字符
description: "使用连字符可以使用C++实现更紧凑的文本排列。 它提供了先进的算法与断字字典工作，使用OpenOffice字典。"
type: docs
weight: 220
...
作为预先注册连字符字典的替代方法，可以"按请求"仅注册所需的连字符字典。 为此，请实现[IHyphenationCallback](https://reference.aspose.com/words/cpp/aspose.words/ihyphenationcallback/)接口并使用静态回调[Callback](https://reference.aspose.com/words/cpp/aspose.words/hyphenation/get_callback/)。
...
Microsoft Word有复杂的逻辑来选择断点，如果文本是合理的，并且启用了连字符。 简而言之，Microsoft Word可能更喜欢收缩或拉伸空格以避免行断字。 很可能这个逻辑是基于 [Knuth的文章](https://www.eprg.org/G53DOC/pdfs/knuth-plass-breaking.pdf).
