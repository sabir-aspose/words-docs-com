...
linktitle: 从头开始创建OOXML图表
description: "如何使用C++在文档中创建不同的图表。"
type: docs
weight: 10
...
Aspose.Words提供添加到`DocumentBuilder`类中的`InsertChart`方法。 那么，让我们看看如何使用`DocumentBuilder->InsertChart`方法将简单的柱形图插入到文档中:
