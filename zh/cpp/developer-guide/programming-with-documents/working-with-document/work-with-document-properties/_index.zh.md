...
知道有关API和版本号的信息直接写入输出文档非常有用。 例如，将文档转换为PDF时，Aspose.Words用"Aspose.Words"填充"应用程序"字段，用"PDF生产者"字段填充"Aspose.Words对于C++ YY.M.N"，其中*YY.M.N*是用于转换的Aspose.Words的版本。 有关更多详细信息，请参阅 [输出文档中包含的生成器或生产者名称](/words/zh/cpp/generator-or-producer-name-included-in-output-documents/).
