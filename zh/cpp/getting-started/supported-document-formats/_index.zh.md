...
| [`PDF`](https://docs.fileformat.com/pdf/) | 将文档保存为PDF(Adobe Portable[Document](https://reference.aspose.com/words/cpp/class/aspose.words.document))格式 |  |  |  |  |  |  |  |  |
| [`EPS`](https://docs.fileformat.com/page-description-language/eps/) | 封装的Postscript文件格式 |  |  |  |  |  |  |  |  |
| [`XPS`](https://docs.fileformat.com/page-description-language/xps/) | 以XPS（XML纸张规范）格式保存文档。 |  | {{< emoticons/tick >}} |  |
| `XamlFixed` | 以可扩展应用程序标记语言(XAML)包格式保存文档 |  | {{< emoticons/tick >}} |  |
...
| [`MOBI`](https://docs.fileformat.com/ebook/mobi/) | `MobiPocket`阅读器和AmazonKindle阅读器使用的eBook格式 | {{< emoticons/tick >}} | {{< emoticons/tick >}} |  |
| [`AZW3`](https://docs.fileformat.com/ebook/azw3/) | AmazonKindle阅读器使用的eBook格式 | {{< emoticons/tick >}} | {{< emoticons/tick >}} |  |
