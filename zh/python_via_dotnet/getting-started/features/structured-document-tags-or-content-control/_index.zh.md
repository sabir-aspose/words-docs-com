...
articleTitle: 结构化文档标签或内容控制
linktitle: 结构化文档标签或内容控制
...
结构化文档标签（SDT 或内容控制）允许将客户定义的语义及其行为和外观嵌入到文档中。

[StructuredDocumentTag](https://reference.aspose.com/words/python-net/aspose.words.markup/structureddocumenttag/) 可以出现在文档中的以下位置：
...
- 内联级别 – 在内部的内联内容中，作为 [Paragraph](https://reference.aspose.com/words/python-net/aspose.words/paragraph/) 的子级。
- 嵌套在另一个 [StructuredDocumentTag](https://reference.aspose.com/words/python-net/aspose.words.markup/structureddocumenttag/) 中。

Aspose.Words 支持创建以下类型的结构化文档标签：
