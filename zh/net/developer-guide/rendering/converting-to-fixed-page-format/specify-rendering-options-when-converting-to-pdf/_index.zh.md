...
Aspose.Words 还使您能够控制如何将字体嵌入到生成的 PDF 文档中。字体需要嵌入到任何 Adobe PDF 文档中，以确保文档可以在任何机器上正确呈现（请参阅 [使用 TrueType 字体](/words/zh/net/using-truetype-fonts/) 部分中有关字体呈现的更多详细信息）。默认情况下，Aspose.Words 将文档中使用的字体子集嵌入到生成的 PDF 中。在这种情况下，仅将文档中使用的 glyph（字符）保存到 PDF 中。
...
您可以从 [Aspose.Words GitHub](https://github.com/aspose-words/Aspose.Words-for-.NET/blob/master/Examples/Data/Rendering.docx) 下载这些示例的模板文件。
