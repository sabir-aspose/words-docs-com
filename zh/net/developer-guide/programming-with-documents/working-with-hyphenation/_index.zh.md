...
对于拼写检查，OpenOffice 使用 [Hunspell 库](https://hunspell.github.io/)，它是 TeX 连字符算法的推广。该算法允许使用竞争的标准和自定义连字符模式进行自动非标准连字符。 Hunspell 使用 [连字符](https://github.com/hunspell/hyphen) 进行连字。
...
要使用连字符功能，首先需要注册一个连字符字典。以下代码示例演示如何从文件中加载指定语言的连字符字典：
