...
有时用户需要更改字段属性的值。例如，更新 `AUTHOR` 字段的 [AuthorName](https://reference.aspose.com/words/zh/net/aspose.words.fields/fieldauthor/authorname/) 属性或更改 `MERGEFIELD` 字段的 [FieldName](https://reference.aspose.com/words/zh/net/aspose.words.fields/fieldmergefield/fieldname/) 属性。
...
以下代码示例显示了 [DisplayResult](https://reference.aspose.com/words/zh/net/aspose.words.fields/field/displayresult/) 属性的用法：
