...
* 使用[DocumentBuilder](https://reference.aspose.com/words/zh/net/aspose.words/documentbuilder/)
* 使用[FieldBuilder](https://reference.aspose.com/words/zh/net/aspose.words.fields/fieldbuilder/)
...
在 Aspose.Words 中，[InsertField](https://reference.aspose.com/words/zh/net/aspose.words/documentbuilder/insertfield/) 方法用于将新字段插入到文档中。第一个参数接受要插入的字段的完整字段代码。第二个参数是可选的，允许手动设置字段的字段结果。如果未提供此字段，则该字段会自动更新。您可以将 null 或empty 传递给此参数以插入具有空字段值的字段。如果您不确定特定的字段代码语法，请先在 Microsoft Word 中创建字段，然后切换以查看其字段代码。
...
语言标识符是一个国家或地理区域的语言的标准国际数字缩写。使用 Aspose.Words，您可以使用 [LocaleId](https://reference.aspose.com/words/zh/net/aspose.words.fields/field/localeid/) 属性在字段级别指定区域设置，该属性获取或设置字段的区域设置 ID。
...
如果您想像 Microsoft Word 允许的那样插入非类型化/空字段 ({})，您可以使用带有 [FieldType.FieldNone](https://reference.aspose.com/words/zh/net/aspose.words.fields/fieldtype/) 参数的 [InsertField](https://reference.aspose.com/words/zh/net/aspose.words/documentbuilder/insertfield/) 方法。要在 Word 文档中插入字段，可以按"Ctrl + F9"组合键。
...
在 Aspose.Words 中插入字段的另一种方法是 [FieldBuilder](https://reference.aspose.com/words/zh/net/aspose.words.fields/fieldbuilder/) 类。它提供流畅的界面来指定字段开关和参数值作为文本、节点甚至嵌套字段。
...
Word文档中的`MERGEFIELD`字段可以用[FieldMergeField](https://reference.aspose.com/words/zh/net/aspose.words.fields/fieldmergefield/)类来表示。您可以使用 **FieldMergeField** 类执行以下操作：
...
有关更多详细信息，请参阅 [FieldMergeField](https://reference.aspose.com/words/zh/net/aspose.words.fields/fieldmergefield/) 类 API。
...
`ADDRESSBLOCK`字段用于在Word文档中插入mail merge地址块。 Word文档中的`ADDRESSBLOCK`字段可以用[FieldAddressBlock](https://reference.aspose.com/words/zh/net/aspose.words.fields/fieldaddressblock/)类来表示。您可以使用 **FieldAddressBlock** 类执行以下操作：
...
有关更多详细信息，请参阅 [FieldAddressBlock](https://reference.aspose.com/words/zh/net/aspose.words.fields/fieldaddressblock/) 类 API。
...
`ADVANCE` 字段用于将行中的后续文本向左、向右、向上或向下偏移。 Word文档中的`ADVANCE`字段可以用[FieldAdvance](https://reference.aspose.com/words/zh/net/aspose.words.fields/fieldadvance/)类来表示。您可以使用 **FieldAdvance** 类执行以下操作：
...
有关更多详细信息，请参阅 [FieldAdvance](https://reference.aspose.com/words/zh/net/aspose.words.fields/fieldadvance/) 类 API。
...
`ASK` 字段用于提示用户输入要分配给 Word 文档中的书签的文本。 Word文档中的`ASK`字段可以用[FieldAsk](https://reference.aspose.com/words/zh/net/aspose.words.fields/fieldask/)类来表示。您可以使用 **FieldAsk** 类执行以下操作：
...
有关更多详细信息，请参阅 [FieldAsk](https://reference.aspose.com/words/zh/net/aspose.words.fields/fieldask/) 类 API。
...
`AUTHOR` 字段用于指定 `Document` 属性中文档作者的姓名。 Word文档中的`AUTHOR`字段可以用[FieldAuthor](https://reference.aspose.com/words/zh/net/aspose.words.fields/fieldauthor/)类来表示。您可以使用 **FieldAuthor** 类执行以下操作：

- 指定文档作者的姓名

{{% alert color="primary" %}}

有关更多详细信息，请参阅 [FieldAuthor](https://reference.aspose.com/words/zh/net/aspose.words.fields/fieldauthor/) 类 API。
...
`INCLUDETEXT` 字段插入字段代码中指定的文档中包含的文本和图形。您可以插入整个文档或书签引用的文档的一部分。 Word文档中的该字段由INCLUDETEXT表示。您可以使用 [FieldIncludeText](https://reference.aspose.com/words/zh/net/aspose.words.fields/fieldincludetext/) 类执行以下操作：
...
有关更多详细信息，请参阅 [FieldIncludeText](https://reference.aspose.com/words/zh/net/aspose.words.fields/fieldincludetext/) 类 API。
...
有关更多详细信息，请参阅 [FieldToa](https://reference.aspose.com/words/zh/net/aspose.words.fields/fieldtoa/) 类 API。
