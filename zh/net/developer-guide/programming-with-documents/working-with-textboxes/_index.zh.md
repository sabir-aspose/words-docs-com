...
**TextBox** 类提供了 [IsValidLinkTarget](https://reference.aspose.com/words/zh/net/aspose.words.drawing/textbox/isvalidlinktarget/) 方法来检查 **TextBox** 是否可以链接到目标 **Textbox**。
...
有多种方法可以在形状中显示文本。 [TextBox](https://reference.aspose.com/words/zh/net/aspose.words.drawing/shape/textbox/) 可以是序列的头部、中间或尾部。
...
使用 [BreakForwardLink](https://reference.aspose.com/words/zh/net/aspose.words.drawing/textbox/breakforwardlink/) 方法，您可以断开到下一个 **TextBox** 的链接。
