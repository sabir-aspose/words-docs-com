...
由于XML以纯文本格式存储数据，因此存储与平台无关。 因此，数据可以很容易地导出、导入或简单地移动。 XML作为数据源很受欢迎，因为它提供了一种在不同应用程序之间进行通信时保留数据语义含义的方法。
...
您可以从以下位置下载此示例的示例文件 [Aspose.Words GitHub](https://github.com/aspose-words/Aspose.Words-for-.NET/blob/master/Examples/Data/Mail%20merge%20data%20-%20Customers.xml).
