...
articleTitle: 表概述
linktitle: 表概述
description: "使用表及其组件，例如Aspose.Words中的单元格，行，列，用于Java。 如何处理Java中的表。"
type: docs
weight: 10
...
如前所述，该表由**Cell**，**Row**和**Column**等元素组成。 无论文档格式如何，这些都是所有表格通用的概念。
...
Aspose.Words有许多与表相关的类– [Tables](https://reference.aspose.com/words/java/com.aspose.words/table/), [Rows](https://reference.aspose.com/words/java/com.aspose.words/row/), [Cells](https://reference.aspose.com/words/java/com.aspose.words/cell/), 和其他人。
