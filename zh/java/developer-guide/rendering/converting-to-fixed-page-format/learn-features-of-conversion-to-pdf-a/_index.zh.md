...
description: "转换为PDF/A-1, PDF/A-2, PDF/A-4 和PDF/UA使用Java。 选择使用Java转换文档的最佳PDF标准。"
type: docs
weight: 25
...
PDF/A是PDF的ISO-标准化版本，用于电子文档的存档和长期存储。 与此同时，PDF/UA是PDF的另一个ISO标准化版本，旨在确保使用辅助技术的残疾人的无障碍性。 要指定符合PDF标准的级别，请使用[Compliance](https://reference.aspose.com/words/java/com.aspose.words/pdfsaveoptions/#getCompliance)属性。 由于存储条件，PDF/A文档必须嵌入所有字体并禁用加密，而PDF/UA只能嵌入所有字体。
