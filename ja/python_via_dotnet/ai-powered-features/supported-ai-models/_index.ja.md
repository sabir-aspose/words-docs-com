...
モデルインスタンスは、[AiModel](https://reference.aspose.com/words/python-net/aspose.words.ai/aimodel/)クラスの[create](https://reference.aspose.com/words/python-net/aspose.words.ai/aimodel/create/)メソッドを使用して作成できます。 サポートされているモデルタイプの完全なリストは、[AiModelType](https://reference.aspose.com/words/python-net/aspose.words.ai/aimodeltype/)列挙体にリストされています。
...
詳細については、[aspose.words.ai](https://reference.aspose.com/words/python-net/aspose.words.ai/)APIのドキュメントを確認してください。
