---
title: Python と .NET のバージョンの違い
second_title: Python via .NET用Aspose.Words
articleTitle: Python と .NET のバージョンの違い
linktitle: Python と .NET のバージョンの違い
description: "Aspose.Words for Python via .NET は Aspose.Words for .NET のラッパーです。このページでは、これら 2 つの製品の機能と API の違いについて説明します。"
type: docs
weight: 15
ai_search_scope: words_python
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
ai_search_fast_endpoint: "https://docsearch.api.aspose.cloud/search"
url: /ja/python-net/python-notes/
...
* インターフェイスの実装はまだサポートされていないため、[IWarningCallback](https://reference.aspose.com/words/python-net/aspose.words/iwarningcallback/)、[IReplacingCallback](https://reference.aspose.com/words/python-net/aspose.words.replacing/ireplacingcallback/)、[IFieldUpdatingCallback](https://reference.aspose.com/words/python-net/aspose.words.fields/ifieldupdatingcallback/)、[IFieldMergingCallback](https://reference.aspose.com/words/python-net/aspose.words.mailmerging/ifieldmergingcallback/) などのコールバックを使用することはできません。
* 印刷機能は、Python バージョンのバックエンドとして Aspose.Words の .NET Standard 2.0 バージョンが使用されており、この機能も提供していないため、利用できません。
* データ ソースとしてフィールド名とフィールド値の配列を使用する単純な Mail Merge 機能のみが提供されます。
* [DocumentVisitor](https://reference.aspose.com/words/python-net/aspose.words/documentvisitor/) 実装は現在、Python コードからは不可能です。

## Aspose.Words オブジェクトを Python にキャストする
...
Aspose.Words DOM のすべてのドキュメント ノードの基本クラスは [Node](https://reference.aspose.com/words/python-net/aspose.words/node/) クラスです。たとえば、[get_child](https://reference.aspose.com/words/python-net/aspose.words/compositenode/get_child/) メソッドは [Node](https://reference.aspose.com/words/python-net/aspose.words/node/) クラスのインスタンスを返しますが、返されたノードを変更する必要がある場合は、ほとんどの場合、それを具象型にキャストする必要があります。次のコードは、ドキュメント内の最初の [Run](https://reference.aspose.com/words/python-net/aspose.words/run/) のフォントの色を変更する方法を示しています。
...
[clone](https://reference.aspose.com/words/python-net/aspose.words/document/clone/) メソッドを使用する場合は、キャストも必要になる場合があります。
...
お気づきかと思いますが、C# コードではキャストに `(Paragraph)node` を使用しますが、Python では `node.as_paragraph()` メソッドを使用する必要があります。 Python バージョンの Aspose.Words [Node](https://reference.aspose.com/words/python-net/aspose.words/node/) クラスでは、次の `as_xxx` メソッドのリンクが導入されています。
...
お気づきかと思いますが、[Field](https://reference.aspose.com/words/python-net/aspose.words.fields/field/) オブジェクトは、以下に示す `as_xxx` メソッドのセットも提供します。
...
### キャスト オール コントロール
次のコード例は、ActiveX コントロールのプロパティを読み取る方法を示しています。
{{< highlight python >}}
...
[FontSourceBase](https://reference.aspose.com/words/python-net/aspose.words.fonts/fontsourcebase/) クラスは、以下に示す一連の `as_xxx` メソッドを提供します。
...
## API メンバーの命名
Python の世界に近づけるため、Python via .NET の Aspose.Words の API メンバーは Python のスネーク スタイルを使用しますが、ほとんどの場合、.NET API の Aspose.Words に 1 対 1 の類似点があります。これらの類似物は [XMLファイル](/words/python-net/python-notes/wrapper.zip) にあります。
