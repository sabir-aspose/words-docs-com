---
title: SmartArtでのコールドレンダリングの操作Java
...
* プレレンダリングされた描画が存在するが正しくない場合は、[UpdateSmartArtDrawing](https://reference.aspose.com/words/java/com.aspose.words/shape/#updateSmartArtDrawing)メソッドを呼び出してSmartArtコールドレンダリングを明示的に実行する必要があります。
