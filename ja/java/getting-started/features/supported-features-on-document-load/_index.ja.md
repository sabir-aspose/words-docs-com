...
Aspose.Wordsを使用すると、ユーザーはさまざまな形式の文書を操作でき、このための幅広いオプションを提供します。 たとえば、ユーザーは最初から文書を作成したり、既存のファイルを任意の場所にロードしたりできます [サポートされているインポート形式](/words/ja/java/supported-document-formats/)、その文書にいくつかの変更を加えてから、結果を保存します。 選択した形式で文書をインポートするとき、ユーザーはさまざまな読み込みオプションを適用できます。
