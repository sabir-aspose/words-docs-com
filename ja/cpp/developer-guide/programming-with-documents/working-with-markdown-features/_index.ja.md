...
この記事で説明されているMarkdownをAspose.Wordsドキュメントオブジェクトモデル(DOM)に翻訳するニュアンスがあります [Markdownをドキュメントオブジェクトモデル(DOM)に変換する](/words/ja/cpp/translate-markdown-to-document-object-model/).
