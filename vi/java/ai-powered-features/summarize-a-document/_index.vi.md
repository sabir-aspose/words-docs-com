...
Tóm tắt tài liệu là một công cụ có giá trị để xem xét nội dung, hiểu biết nhanh hoặc chuẩn bị tóm tắt. Aspose.Words hỗ trợ tóm tắt tài liệu bằng cách sử dụng các mô hình được hỗ trợ AI, giúp xử lý văn bản dài dễ dàng hơn. Tính năng này, có sẵn trong chức năng AI dựa trên Aspose.Words, tích hợp các mô hình ngôn ngữ tạo nâng cao từ *OpenAI* và *Google*, cũng như *Claude's* mô hình ngôn ngữ tạo nhân học. Danh sách các mô hình được hỗ trợ có sẵn trong bảng liệt kê [AiModelType](https://reference.aspose.com/words/java/com.aspose.words/aimodeltype/).
