---
title: Các Loại Hoạt động Mail Merge Trong Java
second_title: Aspose.Words cho Java
articleTitle: Các Loại Hoạt động Mail Merge
linktitle: Các Loại Hoạt động Mail Merge
type: docs
description: "Thực hiện hai loại hoạt động Mail Merge khác nhau: đơn giản Mail Merge và Mail Merge với các vùng. Đơn giản Mail Merge lặp lại toàn bộ tài liệu trên mỗi bản ghi nguồn dữ liệu, trong khi Mail Merge với các vùng chỉ lặp lại các vùng được chỉ định trên mỗi bản ghi bằng Java."
keywords: "how to execute Mail Merge java, Mail Merge Java, Simple Mail Merge"
weight: 20
ai_search_scope: words_java
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
ai_search_fast_endpoint: "https://docsearch.api.aspose.cloud/search"
url: /vi/java/types-of-mail-merge-operations/
...
Lớp [MailMerge](https://reference.aspose.com/words/java/com.aspose.words/mailmerge/) đại diện cho chức năng Mail Merge. Với các thuộc tính của nó, bạn có thể tùy chỉnh hành vi cần thiết trước khi thực hiện thao tác Mail Merge.
...
Khi mẫu của bạn đã sẵn sàng, bạn có thể bắt đầu thực hiện thao tác Mail Merge đơn giản. Aspose.Words cho phép bạn thực hiện một thao tác Mail Merge đơn giản bằng cách sử dụng [Execute methods](https://reference.aspose.com/words/java/com.aspose.words/mailmerge/#execute-com.aspose.words.IMailMergeDataSource) khác nhau chấp nhận các đối tượng dữ liệu khác nhau làm nguồn dữ liệu.

Ví dụ mã sau đây cho thấy cách thực hiện thao tác Mail Merge đơn giản bằng một trong các phương thức [Execute](https://reference.aspose.com/words/java/com.aspose.words/mailmerge/#execute-java.lang.String---java.lang.Object):
...
Thông tin về vùng Mail Merge có thể được lấy bằng lớp [MailMergeRegionInfo](https://reference.aspose.com/words/java/com.aspose.words/mailmergeregioninfo/).
...
Ví dụ mã sau đây cho thấy cách thực thi Mail Merge với các vùng bằng phương thức [ExecuteWithRegions(DataSet)](https://reference.aspose.com/words/java/com.aspose.words/mailmerge/#executeWithRegions-com.aspose.words.net.System.Data.DataSet):
