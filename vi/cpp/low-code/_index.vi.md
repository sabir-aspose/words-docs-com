...
Aspose.Words cho C++ hỗ trợ Cả Thông thạo và Không Thông thạo APIs, cho phép các nhà phát triển chọn kiểu phù hợp nhất với sở thích mã hóa và nhu cầu dự án của họ. Chúng ta hãy xem xét một số ví dụ để xem hai loại API này khác nhau như thế nào.
...
Để khám phá các tùy chọn nâng cao hơn, bạn luôn có thể kết hợp LowCode APIs với mô hình đối tượng Aspose.Words đầy đủ. Xem thêm Low Code ví dụ trong [API documentation](https://reference.aspose.com/words/cpp/aspose.words.lowcode/).