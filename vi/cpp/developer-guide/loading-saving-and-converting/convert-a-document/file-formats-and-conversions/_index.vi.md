...
linktitle: Chuyển đổi là Aspose.Words' Tính năng Hàng đầu
...
Lưu ý rằng trong những tình huống như vậy, Aspose.Words có chuyển đổi được đánh dấu "độ trung thực cao" và tài liệu đầu ra sẽ giống như sau khi chuyển đổi qua Microsoft Word.
...
Các kịch bản phía máy chủ có thể mở rộng sử dụng Aspose.Words chủ yếu vì thiết kế đơn giản và sạch sẽ-Aspose.Words hỗ trợ đa luồng. [Document](https://reference.aspose.com/words/cpp/aspose.words/document/) các đối tượng độc lập với nhau và miễn là chỉ có một luồng có thể sửa đổi tài liệu tại một thời điểm (một yêu cầu điển hình cho bất kỳ lớp thu thập nào), nhiều luồng có thể xử lý bất kỳ số lượng tài liệu nào cùng một lúc.
