...
linktitle: Định dạng và chuyển đổi tệp
...
Để biết thêm chi tiết về cách tải, chuyển đổi và lưu tài liệu, hãy xem phần [Đang tải, lưu và chuyển đổi](/words/vi/python-net/loading-saving-and-converting/).
...
Lưu ý rằng trong những trường hợp như vậy, Aspose.Words đánh dấu chuyển đổi là "độ trung thực cao" và tài liệu đầu ra sẽ giống như sau khi chuyển đổi qua Microsoft Word.
...
Các kịch bản phía máy chủ có thể mở rộng sử dụng Aspose.Words chủ yếu vì thiết kế đơn giản và rõ ràng của nó – Aspose.Words hỗ trợ đa luồng. Các đối tượng [Document](https://reference.aspose.com/words/python-net/aspose.words/document/) độc lập với nhau và miễn là mỗi lần chỉ có một luồng có thể sửa đổi tài liệu (yêu cầu điển hình cho bất kỳ lớp bộ sưu tập nào), nhiều luồng có thể xử lý bất kỳ số lượng tài liệu nào cùng một lúc.
...
Trong một số trường hợp, khách hàng đã báo cáo với chúng tôi rằng họ không thể tin được tốc độ của Aspose.Words. Họ đã bỏ qua dòng mã đang tải một tài liệu khổng lồ vào trình gỡ lỗi và nó diễn ra tức thời đến mức họ không thể tin rằng tệp đã được tải vào đối tượng [Document](https://reference.aspose.com/words/python-net/aspose.words/document/).
