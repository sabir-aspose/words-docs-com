...
|  Tính năng | Python via .NET |
|  :-  |  :-  |
| Truy cập, tạo và sửa đổi các đoạn văn và văn bản. | {{< emoticons/tick >}} |
| Truy cập, tạo và sửa đổi hình ảnh, hộp văn bản và hình dạng. | {{< emoticons/tick >}} |
| Truy cập, tạo và sửa đổi bảng, hàng và ô. | {{< emoticons/tick >}} |
| Truy cập, tạo và sửa đổi các trường, trường biểu mẫu, siêu liên kết và dấu trang. | {{< emoticons/tick >}} |
| Truy cập, tạo và sửa đổi các phần tài liệu, đầu trang và chân trang. | {{< emoticons/tick >}} |
| Truy cập, tạo và sửa đổi chú thích cuối trang, chú thích cuối trang và nhận xét. | {{< emoticons/tick >}} |
| Truy cập, tạo và sửa đổi XML tùy chỉnh, Thẻ thông minh và Thẻ tài liệu có cấu trúc (Kiểm soát nội dung). | {{< emoticons/tick >}} |
| Truy cập và sửa đổi tất cả các thành phần tài liệu bằng cách sử dụng các lớp và phương thức giống **XmlDocument**. | {{< emoticons/tick >}} |
| Cập nhật kết quả trường `IF`, công thức và các loại trường phổ biến khác. | {{< emoticons/tick >}} |
| Xây dựng lại và cập nhật các trường Mục lục (TOC) giống hệt như Microsoft Word thực hiện. | {{< emoticons/tick >}} |
| Sao chép và di chuyển các thành phần tài liệu giữa các tài liệu. | {{< emoticons/tick >}} |
| Tham gia và chia nhỏ tài liệu. | {{< emoticons/tick >}} |
| Nhận và thiết lập các thuộc tính tài liệu tùy chỉnh và tích hợp. | {{< emoticons/tick >}} |
| Chỉ định bảo vệ tài liệu, mở tài liệu được bảo vệ và mã hóa. | {{< emoticons/tick >}} |
| Tìm và thay thế văn bản, liệt kê nội dung tài liệu. | {{< emoticons/tick >}} |
| Chấp nhận tất cả các sửa đổi trong một tài liệu. | {{< emoticons/tick >}} |
| Bảo toàn hoặc trích xuất các đối tượng OLE và điều khiển ActiveX từ tài liệu. | {{< emoticons/tick >}} |
| Giữ nguyên hoặc xóa macro VBA khỏi tài liệu. Bảo tồn chữ ký số macro VBA. | {{< emoticons/tick >}} |
| Phát hiện và xác minh chữ ký số trong tài liệu. | {{< emoticons/tick >}} |
| Chèn văn bản HTML. | {{< emoticons/tick >}} |
| Trích xuất Macro VBA từ Tài liệu Word. | {{< emoticons/tick >}} |
...
|  Tính năng | Python via .NET |
|  :-  |  :-  |
| Truy cập và sửa đổi tất cả định dạng ký tự bao gồm phông chữ, màu sắc, hiệu ứng, đường viền và bóng. | {{< emoticons/tick >}} |
| Truy cập và sửa đổi tất cả định dạng đoạn văn bao gồm thụt lề, khoảng cách, đường viền và bóng, điểm dừng tab. | {{< emoticons/tick >}} |
| Truy cập và sửa đổi tất cả định dạng danh sách có dấu đầu dòng và đánh số, bao gồm cả cách đánh số và cấp độ. | {{< emoticons/tick >}} |
| Truy cập và sửa đổi định dạng bảng bao gồm căn chỉnh, hướng, đường viền và tô bóng. | {{< emoticons/tick >}} |
| Truy cập và sửa đổi tất cả các thuộc tính của phần bao gồm kích thước giấy, lề và hướng. | {{< emoticons/tick >}} |
| Truy cập, tạo và sửa đổi kiểu tài liệu. | {{< emoticons/tick >}} |
| Truy cập và sửa đổi các đối tượng vẽ bao gồm các thuộc tính vị trí, kích thước, dòng và điền, byte hình ảnh. | {{< emoticons/tick >}} |
