...
|  -------------------------------  |  ------------------------------  |  ------------------------------------------------------------  |
|  Chỉ đọc |  "Đặt tài liệu ở chế độ chỉ đọc" |  Luôn mở chế độ chỉ đọc (Tệp → Thông tin → Bảo vệ tài liệu)<br /> Tính năng thay thế: "Mật khẩu để sửa đổi" (Lưu dưới dạng → Công cụ → Tùy chọn chung → Mật khẩu) |
