...
linktitle: Câu hỏi thường gặp – Aspose.Words cho .NET
...
Nếu bạn chưa tìm thấy câu trả lời cho câu hỏi của mình, bạn có thể hỏi trên diễn đàn hỗ trợ. Để biết thông tin về cách báo cáo chính xác câu hỏi hoặc vấn đề của bạn, hãy xem trang [Hỗ trợ kỹ thuật](/words/vi/net/technical-support/).
...
Aspose.Words cho .NET không cần cài đặt bất kỳ ứng dụng của bên thứ ba hoặc gói phần mềm bổ sung nào để hoạt động. Chỉ cần tải xuống và cài đặt Aspose.Words như được mô tả trong bài viết [Cài đặt](/words/vi/net/installation/) và bắt đầu.
...
Để biết chi tiết, hãy xem trang [Tổng quan về sản phẩm](/words/vi/net/product-overview/) và phần [Nền tảng và khả năng Interoperability](/words/net/platforms-and-interoperability/).
...
Bạn có thể xem danh sách đầy đủ các định dạng được hỗ trợ trên trang [Định dạng tài liệu được hỗ trợ](/words/vi/net/supported-document-formats/).
...
Xem trang [Cấp phép và đăng ký](/words/vi/net/licensing/) để biết thêm thông tin.

{{% alert color="primary" %}}

Bạn cũng có thể thử một số tính năng Aspose.Words phổ biến nhất thông qua [Ứng dụng trực tuyến miễn phí Aspose.Words](https://products.aspose.app/words).
...
Sử dụng diễn đàn hỗ trợ kỹ thuật miễn phí. Để biết chi tiết về cách báo cáo sự cố đúng cách và những việc cần làm trước khi liên hệ với diễn đàn, hãy xem trang [Hỗ trợ kỹ thuật](/words/vi/net/technical-support/).

## Kết xuất một tài liệu

{{% alert color="primary" %}}

Bạn có thể tìm thấy thông tin chi tiết hơn về hiển thị trong phần tài liệu [Kết xuất](/words/vi/net/rendering/).

{{% /alert %}}

**Hỏi: Tại sao bố cục và phông chữ trong tài liệu đầu ra khác với bản gốc?**

Phông chữ có thể không có sẵn hoặc định dạng phông chữ được Microsoft Word hỗ trợ nhưng không được Aspose.Words hỗ trợ. Aspose.Words sẽ thực hiện [Thao tác và thay thế phông chữ TrueType](/words/vi/net/manipulating-and-substitution-truetype-fonts/).

Để kiểm tra xem phông chữ có bị thiếu hay không:

* Trong Aspose.Words, hãy sử dụng cảnh báo thay thế Phông chữ (để biết chi tiết, hãy xem phần "Cách nhận biết phông chữ đã được thay thế" của bài viết [Thao tác và thay thế phông chữ TrueType](/words/vi/net/manipulating-and-substitution-truetype-fonts/)).
...
Một số phông chữ phức tạp yêu cầu phải xử lý các tính năng Kiểu chữ nâng cao để hiển thị chúng một cách chính xác. Kiểu chữ nâng cao bị tắt trong Aspose.Words theo mặc định. Người dùng phải kích hoạt Kiểu chữ nâng cao với [TextShaperFactory](https://reference.aspose.com/words/net/aspose.words.layout/layoutoptions/textshaperfactory/).
...
* Kiểm tra dữ liệu đang được tải đúng cách vào các bảng: đặt [TableName](https://reference.aspose.com/words/net/aspose.words.mailmerging/imailmergedatasource/tablename/) chính xác với tất cả các khóa và mối quan hệ chính được yêu cầu.
* Kiểm tra xem các trường hợp nhất có được đặt tên đúng không. Sử dụng phương pháp [GetFieldNames](https://reference.aspose.com/words/net/aspose.words.mailmerging/mailmerge/getfieldnames/) để lấy tất cả tên trường hợp nhất và đảm bảo rằng tên của trường hợp nhất trong mẫu khớp với tên trong nguồn dữ liệu của bạn.
...
Bạn có thể tìm thêm thông tin chi tiết về lập trình với tài liệu trong phần tài liệu [Lập trình với tài liệu](/words/vi/net/programming-with-documents/).

{{% /alert %}}

**Hỏi: Tại sao nội dung được thêm vào tài liệu không xuất hiện trên cùng một trang?**

Kết quả nối thêm xuất hiện trên một trang riêng do có sự khác biệt trong cài đặt [PageSetup](https://reference.aspose.com/words/net/aspose.words/pagesetup/) cho các phần mà tài liệu được nối cùng nhau. Thực hiện cài đặt **PageSetup** giống hệt nhau cho các phần mà tài liệu được nối với nhau.

## Chuyển đổi một tài liệu

{{% alert color="primary" %}}

Bạn có thể tìm thêm thông tin chi tiết về cách chuyển đổi tài liệu trong phần tài liệu [Chuyển đổi một tài liệu](/words/vi/net/convert-a-document/).
...
Để có câu trả lời chi tiết, hãy tìm hiểu bài viết [Cách chạy Aspose.Words trong Docker](/words/vi/net/how-to-run-aspose-words-in-docker/).
