...
linktitle: 시스템 요구 사항
description: "작업을 시작하기 전에 Aspose.Words 에 대한 C++,운영 체제,플랫폼,프레임워크 및 환경 요구 사항을 충족하여 장치의 활동이 적절하게 고려되었는지 확인합니다."
type: docs
weight: 70
...
<table>
   ...
   <tr>
      ...
      <td><ul>
         <li>Windows 2008 서버(64,86)</li>
         <li>Windows 2012 서버(64,86)</li>
         <li>Windows 2012 R2 서버(64,86)</li>
         <li>Windows 2016 서버(64,86)</li>
         <li>Windows 2019 서버(64,86)</li>
         <li>Windows 2022 서버(64,86)</li>
         <li>Windows Vista (64,86)</li>
         <li>Windows 7 (64,86)</li>
         <li>Windows 8, 8.1 (64,엑스86)</li>
   ...
   <tr>
      <td>마코스</td>
      <td><ul>
         <li>전화:+86-20-86100000: 12.0 또는 나중에</li>
         <li>마코스-암 64: 12.0 또는 나중에</li>
      </ul></td>
   </tr>
</table>
...
<table>
  ...
  <tr>
			<td><ul><li>Clang 3.9.1 또는 나중에</li></ul></td>
			</tr>
</table>
...
1. 글꼴 구성 설치 Ubuntu 또는 Debian</br>
`sudo apt install libfontconfig fontconfig`
2. 글꼴 구성 설치 Fedora 또는 CentOs</br>
...
<table>
  ...
  <tr>
			<td><ul><li>엑스코드 12.5.1 또는 나중에</li><li>Clang (엑스 코드와 함께 기본적으로 제공되는)</li></ul></td>
			</tr>
</table>
...
글꼴 구성 설치 [homebrew](https://brew.sh)</br>
