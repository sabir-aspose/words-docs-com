...
linktitle: 차트 축 속성을 설정하는 방법
description: "차트 축 튜닝을 사용하여 C++."
type: docs
weight: 20
...
그 `AxisBound` 클래스는 축 값의 최소 또는 최대 경계를 나타냅니다. 바인딩은 숫자,날짜-시간 또는 특수"자동"값으로 지정할 수 있습니다.
...
차트 축을 표시하거나 숨기려면 숨김 속성 값을 설정하면 됩니다.
