...
linktitle: 제어 문자 작업
description: "Java에 대한Aspose.Words의 컨트롤 문자 작업 소개."
type: docs
weight: 400
...
[ControlChar](https://reference.aspose.com/words/java/com.aspose.words/controlchar/)클래스는 문서에서 자주 발생하는 제어 문자를 나타내는 상수의 저장소입니다. 동일한 상수의 문자 및 문자열 버전을 모두 제공합니다. 예를 들어 문자열[LineBreak](https://reference.aspose.com/words/java/com.aspose.words/controlchar/#LINE-BREAK)과 문자[LineBreakChar](https://reference.aspose.com/words/java/com.aspose.words/controlchar/#LINE-BREAK_CHAR)은 동일한 값을 갖습니다.
