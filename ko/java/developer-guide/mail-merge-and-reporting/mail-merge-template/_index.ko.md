...
[DocumentBuilder](https://reference.aspose.com/words/java/com.aspose.words/documentbuilder/)클래스를 사용하여Aspose.Words를 사용하여 필요한 병합 템플릿을 만듭니다. 다음을 사용하여 이러한 템플릿에 텍스트,병합 필드 및 줄 바꿈을 포함할 수 있습니다[InsertTextInput](https://reference.aspose.com/words/java/com.aspose.words/documentbuilder/#insertTextInput(java.lang.String,int,java.lang.String,java.lang.String,int)), [InsertField](https://reference.aspose.com/words/java/com.aspose.words/documentbuilder/#insertField(int,boolean)), 그리고[InsertParagraph](https://reference.aspose.com/words/java/com.aspose.words/documentbuilder/#insertParagraph())방법.
...
[텍스트]https://reference.aspose.com/words/java/com.aspose.words/Fieldmergingargs#Text)현재 병합 필드의 문서에 텍스트를 삽입하는 속성입니다. 또한[글꼴]을 사용하여 템플릿 내부의 텍스트 및 단락의 서식을 변경할 수 있습니다](https://reference.aspose.com/words/java/com.aspose.words/font/)및[ParagraphFormat](https://reference.aspose.com/words/java/com.aspose.words/paragraphformat/)클래스를 사용할 수 있습니다. [FieldMergeField](https://reference.aspose.com/words/java/com.aspose.words/fieldmergefield/)클래스에 포함된[TextBefore](https://reference.aspose.com/words/java/com.aspose.words/fieldmergefield/#TextBefore)및[TextAfter](https://reference.aspose.com/words/java/com.aspose.words/fieldmergefield/#TextAfter)속성을 사용하여 병합 필드 앞이나 뒤에 삽입할 텍스트를 처리할 수 있습니다.
...
이 예제의 샘플 파일은 다음에서 다운로드할 수 있습니다 [Aspose.Words GitHub](https://github.com/aspose-words/Aspose.Words-for-Java/blob/master/Examples/Data/Mail%20merge%20destinations%20-%20Fax.docx).

또한`HandleMergeField`클래스의 구현을 확인할 수 있습니다 [Aspose.Words GitHub](https://github.com/aspose-words/Aspose.Words-for-Java/blob/master/Examples/DocsExamples/Java/src/main/java/DocsExamples/Mail_Merge_And_Reporting/WorkingWithFields.java).
