...
description: "Java를 사용하여Mail Merge중에checkbox또는 텍스트 입력 필드를 삽입합니다. 또한Java에서Mail Merge동안 데이터베이스에서 이미지를 삽입합니다."
type: docs
weight: 20
ai_search_scope: words_java
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
ai_search_fast_endpoint: "https://docsearch.api.aspose.cloud/search"
url: /ko/java/insert-checkboxes-text-input-or-images-mail-merge/
...
Mail merge동안 문서에서 이미지Mail Merge필드가 발견되면[FieldMergingCallback](https://reference.aspose.com/words/java/com.aspose.words/mailmerge/#getFieldMergingCallback)이벤트가 발생합니다. 이 이벤트에 응답하여 파일 이름,스트림 또는 이미지 개체를Mail Merge엔진에 반환하여 문서에 삽입할 수 있습니다.
...
이미지 병합 필드를 병합하는 동안[WrapType](https://reference.aspose.com/words/java/com.aspose.words/wraptype/)과 같은 다양한 이미지 속성을 제어해야 할 수도 있습니다.

현재[ImageFieldMergingArgs](https://reference.aspose.com/words/java/com.aspose.words/imagefieldmergingargs/)을 사용하면 이미지 너비 또는 높이 속성 만 각각 설정할 수 있습니다. 이 문제를 극복하기 위해Aspose.Words는[Shape](https://reference.aspose.com/words/java/com.aspose.words/imagefieldmergingargs/#getShape)속성을 제공하여 삽입 된 이미지 또는 다른 모양을 완벽하게 제어 할 수 있습니다.
