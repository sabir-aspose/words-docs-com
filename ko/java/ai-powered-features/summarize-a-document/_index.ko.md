...
문서 요약은 콘텐츠 검토,빠른 통찰력 또는 초록을 준비하는 데 유용한 도구입니다. Aspose.WordsAI전원 모델을 사용하여 문서 요약을 지원하므로 긴 텍스트를 더 쉽게 처리 할 수 있습니다. AI기반Aspose.Words기능에서 사용할 수 있는 이 기능은*OpenAI*및*Google*의 고급 생성 언어 모델과*Claude's*인성 생성 언어 모델을 통합합니다. 지원되는 모델 목록은[AiModelType](https://reference.aspose.com/words/java/com.aspose.words/aimodeltype/)열거형에서 사용할 수 있습니다.
