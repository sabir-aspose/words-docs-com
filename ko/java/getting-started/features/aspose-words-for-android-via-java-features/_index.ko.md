...
| 특징 | Aspose.WordsJava | Aspose.WordsAndroid을 통해Java |
| :- | :- | :- |
| 액세스,생성 및 단락과 텍스트를 수정합니다. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| 액세스,생성 및 이미지,텍스트 상자 및 모양을 수정합니다. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| 테이블,행 및 셀에 액세스,생성 및 수정합니다. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| 액세스,생성 및 필드,양식 필드,하이퍼 링크 및 북마크를 수정합니다. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| 액세스,작성 및 문서 섹션,머리글과 바닥 글을 수정합니다. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| 각주,미주 및 주석에 액세스,생성 및 수정합니다. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| 사용자 정의XML,SmartTags및 구조화된 문서 태그(콘텐츠 컨트롤)에 액세스,생성 및 수정합니다. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| **XmlDocument**과 같은 클래스 및 메서드를 사용하여 모든 문서 요소에 액세스하고 수정합니다. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| 필드 결과`IF`,수식 및 기타 인기 있는 필드 유형을 업데이트합니다. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| Microsoft Word과 정확히 같은 목차(TOC)필드를 다시 작성하고 업데이트합니다. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| 문서 간에 문서 요소를 복사하고 이동합니다. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| 문서 가입 및 분할. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| 기본 제공 및 사용자 지정 문서 속성을 가져와 설정합니다. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| 문서 보호를 지정하고 보호되고 암호화된 문서를 엽니다. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| 텍스트 찾기 및 바꾸기,문서 내용 열거. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| 문서의 모든 개정을 수락합니다. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| 문서에서OLE개체 및 액티브엑스 컨트롤을 보존하거나 추출합니다. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| 문서에서VBA매크로를 유지하거나 제거합니다. VBA매크로 디지털 서명을 유지합니다. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| 문서에서 디지털 서명을 감지합니다. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| HTML텍스트를 삽입합니다. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
...
| 특징 | Aspose.WordsJava | Aspose.WordsAndroid을 통해Java |
| :- | :- | :- |
| 글꼴,색상,효과,테두리 및 음영을 포함한 모든 문자 서식을 액세스하고 수정하십시오. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| 들여 쓰기,간격,테두리 및 음영,탭 중지를 포함한 모든 단락 서식을 액세스하고 수정합니다. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| 액세스 및 번호 매기기 및 수준을 포함한 모든 글 머리 기호 및 번호 매기기 목록 서식을 수정합니다. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| 정렬,방향,테두리 및 음영을 포함한 테이블 서식에 액세스하고 수정합니다. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| 용지 크기,여백 및 방향을 포함한 모든 섹션 속성에 액세스하고 수정합니다. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| 문서 스타일에 액세스,생성 및 수정합니다. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| 위치,크기,선 및 채우기 속성,이미지 바이트를 포함한 도면 객체에 액세스하고 수정합니다. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
