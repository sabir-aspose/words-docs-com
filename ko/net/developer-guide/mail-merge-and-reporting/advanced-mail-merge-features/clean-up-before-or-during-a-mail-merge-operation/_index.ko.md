...
다른 사람이 만든 긴 템플릿을 사용하는 경우Mail Merge작업을 수행하기 전에 해당 템플릿에 이미 있는 모든 병합 필드를 삭제할 수 있습니다. Mail Merge작업을 실행하지 않고 문서에서 모든 병합 필드를 삭제하려는 경우[DeleteFields](https://reference.aspose.com/words/net/aspose.words.mailmerging/mailmerge/deletefields/)방법을 사용할 수 있습니다. 이 메서드는[CleanupOptions](https://reference.aspose.com/words/net/aspose.words.mailmerging/mailmerge/cleanupoptions/)속성의 제거 옵션의 영향을 받지 않으며 이를 실행하면 포함된 필드나 빈 단락이 아닌 병합된 필드만 제거됩니다.
...
[MailMergeCleanupOptions](https://reference.aspose.com/words/net/aspose.words.mailmerging/mailmergecleanupoptions/)열거형과 함께**CleanupOptions**속성을 사용하여 제거 옵션을 설정합니다. 다음 옵션을 선택하여 제거할 항목을 지정합니다(둘 이상을 결합할 수 있음).:
...
별도의 데이터 소스를 사용하여 데이터를 병합하는 경우 제거 옵션은Mail Merge실행 메서드의 마지막 호출에서만 활성화됩니다.
...
이 예제의 샘플 파일은 다음에서 다운로드할 수 있습니다 [Aspose.Words GitHub](https://github.com/aspose-words/Aspose.Words-for-.NET/blob/master/Examples/Data/Table%20with%20fields.docx).
