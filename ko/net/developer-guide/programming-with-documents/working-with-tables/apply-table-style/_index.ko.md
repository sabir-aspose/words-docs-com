...
사용자는 새로운 스타일을 생성하여 스타일 컬렉션에 추가할 수 있습니다. [Add](https://reference.aspose.com/words/net/aspose.words/stylecollection/add/) 방법은 새로운 테이블 스타일을 만드는 데 사용됩니다.
...
Aspose.Words는 또한 표 스타일에 있는 서식을 가져와 직접 서식으로 표의 행과 셀로 확장하는 [ExpandTableStylesToDirectFormatting](https://reference.aspose.com/words/net/aspose.words/document/expandtablestylestodirectformatting/) 방법을 제공합니다. 서식을 표 스타일과 셀 스타일과 결합해 보세요.
