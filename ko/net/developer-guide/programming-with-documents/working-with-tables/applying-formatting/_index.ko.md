...
articleTitle: 테이블 서식 적용
linktitle: 테이블 서식 적용
description: "C#를 사용하여 세부적으로 테이블 형식을 지정합니다. C#를 사용하여 테이블의 모든 부분을 포맷하세요."
type: docs
weight: 70
ai_search_scope: words_net
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
ai_search_fast_endpoint: "https://docsearch.api.aspose.cloud/search"
url: /ko/net/applying-formatting/
timestamp: 2024-01-27-14-07-04
---

표의 각 요소는 서로 다른 서식을 적용할 수 있습니다. 예를 들어, 표 서식은 표 전체에 적용되고, 행 서식은 특정 행에만 적용되며, 셀 서식은 특정 셀에만 적용됩니다.

Aspose.Words는 테이블 형식을 검색하고 적용할 수 있는 풍부한 API를 제공합니다. [Table](https://reference.aspose.com/words/net/aspose.words.tables/table/), [RowFormat](https://reference.aspose.com/words/net/aspose.words.tables/rowformat/) 및 [CellFormat](https://reference.aspose.com/words/net/aspose.words.tables/cellformat/) 노드를 사용하여 형식을 설정할 수 있습니다.
...
테이블에 서식을 적용하려면 [Table](https://reference.aspose.com/words/net/aspose.words.tables/table/), [PreferredWidth](https://reference.aspose.com/words/net/aspose.words.tables/preferredwidth/) 및 [TableCollection](https://reference.aspose.com/words/net/aspose.words.tables/tablecollection/) 클래스를 사용하여 해당 **Table** 노드에서 사용 가능한 속성을 사용할 수 있습니다.

{{% alert color="primary" %}}

테이블 속성을 적용하려면 테이블에 행이 하나 이상 있어야 합니다. 이는 [DocumentBuilder](https://reference.aspose.com/words/net/aspose.words/documentbuilder/)를 사용하여 테이블을 작성할 때 [InsertCell](https://reference.aspose.com/words/net/aspose.words/documentbuilder/insertcell/)에 대한 첫 번째 호출 이후, 첫 번째 행이 테이블에 추가된 이후 또는 노드가 DOM에 직접 삽입될 때 이 형식화를 수행해야 함을 의미합니다.
...
**행 수준** 형식은 [Row](https://reference.aspose.com/words/net/aspose.words.tables/row/), [RowFormat](https://reference.aspose.com/words/net/aspose.words.tables/rowformat/) 및 [RowCollection](https://reference.aspose.com/words/net/aspose.words.tables/rowcollection/) 클래스를 사용하여 제어할 수 있습니다.
...
셀 수준 형식은 [Cell](https://reference.aspose.com/words/net/aspose.words.tables/cell/), [CellFormat](https://reference.aspose.com/words/net/aspose.words.tables/cellformat/) 및 [CellCollection](https://reference.aspose.com/words/net/aspose.words.tables/cellcollection/) 클래스에 의해 제어됩니다.

{{% alert color="primary" %}}

**Cell**는 **Row**의 하위 노드만 될 수 있습니다. 동시에 서식을 적용하려면 **Cell**에 [Paragraph](https://reference.aspose.com/words/net/aspose.words/paragraph/)이 하나 이상 있어야 합니다.
...
- 행 높이 속성 - [Height](https://reference.aspose.com/words/net/aspose.words.tables/rowformat/height/)
- 주어진 행에 대한 높이 규칙 속성 - [HeightRule](https://reference.aspose.com/words/net/aspose.words.tables/rowformat/heightrule/)

동시에 각 행마다 다른 높이를 설정할 수 있으므로 테이블 설정을 광범위하게 제어할 수 있습니다.

{{% alert color="primary" %}}

객체의 높이를 지정하는 규칙 옵션은 [HeightRule](https://reference.aspose.com/words/net/aspose.words/heightrule/) 열거를 사용하여 설정할 수 있습니다.
...
셀 너비는 실제로 DOCX 형식에 대해 계산된 값입니다. 실제 셀 너비는 여러 가지 요소에 따라 달라질 수 있습니다. 예를 들어 페이지 여백이나 기본 표 너비를 변경하면 실제 셀 너비에 영향을 줄 수 있습니다.
...
적절한 기본 너비 유형 및 값은 [PreferredWidth](https://reference.aspose.com/words/net/aspose.words.tables/preferredwidth/) 클래스의 메서드를 사용하여 설정됩니다

* 자동 또는 "선호 너비 없음"을 지정하는 [Auto](https://reference.aspose.com/words/net/aspose.words.tables/preferredwidth/auto/) 방법
* 백분율 너비를 지정하는 [FromPercent](https://reference.aspose.com/words/net/aspose.words.tables/preferredwidth/frompercent/) 방법
* 너비를 포인트 단위로 지정하는 [FromPoints](https://reference.aspose.com/words/net/aspose.words.tables/preferredwidth/frompoints/) 방법
...
Aspose.Words에서 테이블과 셀 너비는 [PreferredWidthType](https://reference.aspose.com/words/net/aspose.words.tables/preferredwidthtype/) 열거형에서 사용할 수 있는 옵션과 함께 [Table.PreferredWidth](https://reference.aspose.com/words/net/aspose.words.tables/table/preferredwidth/) 속성과 [CellFormat.PreferredWidth](https://reference.aspose.com/words/net/aspose.words.tables/cellformat/preferredwidth/) 속성을 사용하여 설정됩니다
...
[Table.PreferredWidth](https://reference.aspose.com/words/net/aspose.words.tables/table/preferredwidth/) 속성을 사용하면 컨테이너(페이지, 텍스트 열 또는 중첩 테이블인 경우 외부 테이블 셀)를 기준으로 기본 너비가 조정됩니다.
...
특정 셀에서 [CellFormat.PreferredWidth](https://reference.aspose.com/words/net/aspose.words.tables/cellformat/preferredwidth/) 속성을 사용하면 기본 너비가 조정됩니다.
...
[Type](https://reference.aspose.com/words/net/aspose.words.tables/preferredwidth/type/) 및 [Value](https://reference.aspose.com/words/net/aspose.words.tables/preferredwidth/value/) 속성을 사용하여 원하는 테이블이나 셀의 기본 너비 세부 정보를 찾을 수 있습니다.
...
[AllowAutoFit](https://reference.aspose.com/words/net/aspose.words.tables/table/allowautofit/) 속성을 사용하면 선택한 기준에 따라 테이블의 셀을 늘리거나 줄일 수 있습니다. 예를 들어, **창에 자동 맞춤** 옵션을 사용하여 테이블을 페이지 너비에 맞추고, **콘텐츠에 자동 맞춤** 옵션을 사용하여 각 셀이 내용에 따라 늘어나거나 줄어들도록 할 수 있습니다.
...
3. 최종 결과는 [CellFormat.Width](https://reference.aspose.com/words/net/aspose.words.tables/cellformat/width/) 속성에 의해 열 너비가 결정되고 사용자가 텍스트를 입력하거나 페이지 크기를 조정할 때 열 크기가 자동으로 조정되지 않는 테이블입니다
...
Aspose.Words를 사용하면 사용자는 [CellFormat](https://reference.aspose.com/words/net/aspose.words.tables/cellformat/)를 포함한 여러 개체를 통해 테이블이나 셀의 너비를 정의할 수 있습니다. [Width](https://reference.aspose.com/words/net/aspose.words.tables/cellformat/width/) 속성은 대부분 이전 버전에서 그대로 유지되지만 셀 너비 설정을 단순화하는 데 여전히 유용합니다.
...
|  주문하다 |  재산 |  설명 |
|  -----  |  ------------------------------------------------------------  |  ------------------------------------------------------------  |
|  1      |  [AllowAutoFit](https://reference.aspose.com/words/net/aspose.words.tables/table/allowautofit/)가 결정됨 |  **AutoFit**가 활성화된 경우:<br>- 테이블은 내용을 수용하기 위해 기본 너비를 넘어 커질 수 있습니다. 일반적으로 기본 너비 아래로 줄어들지 않습니다.<br>- **CellFormat.Width** 값에 대한 모든 변경 사항은 무시되고 대신 셀이 해당 내용에 맞춰집니다 |
|  2      |  **Points** 또는 **Percent** 값을 갖는 [PreferredWidthType](https://reference.aspose.com/words/net/aspose.words.tables/preferredwidthtype/) |  **CellFormat.Width**는 무시됩니다 |
|  3      |  **Auto** 값을 갖는 [PreferredWidthType](https://reference.aspose.com/words/net/aspose.words.tables/preferredwidthtype/) |  **CellFormat.Width**의 값이 복사되어 셀의 기본 너비(포인트)가 됩니다 |
...
Microsoft Word의 "셀 간격" 옵션과 유사하게 테이블 셀 사이에 추가 공간을 얻거나 설정할 수 있습니다. 이는 [AllowCellSpacing](https://reference.aspose.com/words/net/aspose.words.tables/table/allowcellspacing/) 속성을 사용하여 수행할 수 있습니다.

이러한 옵션이 문서의 실제 테이블에 어떻게 적용되는지에 대한 예는 아래 그림에서 볼 수 있습니다.

<img src="/words/net/applying-formatting/applying-formatting-10.png" alt="서식-간격-셀 사이-aspose-단어-net" style="width:500px"/>
...
테두리와 음영은 [Table.SetBorder](https://reference.aspose.com/words/net/aspose.words.tables/table/setborder/), [Table.SetBorders](https://reference.aspose.com/words/net/aspose.words.tables/table/setborders/) 및 [Table.SetShading](https://reference.aspose.com/words/net/aspose.words.tables/table/setshading/)을 사용하여 전체 테이블에 적용하거나 [CellFormat.Borders](https://reference.aspose.com/words/net/aspose.words.tables/cellformat/borders/) 및 [CellFormat.Shading](https://reference.aspose.com/words/net/aspose.words.tables/cellformat/shading/)을 사용하여 특정 셀에만 적용할 수 있습니다. 또한 [RowFormat.Borders](https://reference.aspose.com/words/net/aspose.words.tables/rowformat/borders/)를 사용하여 행 테두리를 설정할 수 있지만 이 방식으로 음영 처리를 적용할 수는 없습니다.
