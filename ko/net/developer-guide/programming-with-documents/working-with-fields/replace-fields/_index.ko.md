...
description: "C#에서 필드를 텍스트로 바꾸는 방법을 알아보세요. .NET API을 사용하여 필드를 정적 데이터로 바꿉니다."
type: docs
weight: 37
ai_search_scope: words_net
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
ai_search_fast_endpoint: "https://docsearch.api.aspose.cloud/search"
url: /ko/net/replace-fields/
...
* 텍스트는 특수 필드 노드([FieldStart](https://reference.aspose.com/words/net/aspose.words.fields/fieldstart/) 및 [FieldEnd](https://reference.aspose.com/words/net/aspose.words.fields/fieldend))로 둘러싸여 있습니다
* [FieldSeparator](https://reference.aspose.com/words/net/aspose.words.fields/fieldseparator/) 노드는 필드 내의 텍스트를 필드 코드와 필드 결과로 분리합니다
...
**ConvertFieldsToStaticText** 메서드는 [CompositeNode](https://reference.aspose.com/words/net/aspose.words/compositenode/) 속성과 [FieldType](https://reference.aspose.com/words/net/aspose.words.fields/fieldtype/) 열거라는 두 가지 매개 변수를 허용하므로 모든 복합 노드를 이 메서드에 전달할 수 있습니다. 이를 통해 문서의 특정 부분에서만 필드를 정적 텍스트로 변환할 수 있습니다.

예를 들어 [Document](https://reference.aspose.com/words/net/aspose.words/document/) 객체를 전달하고 전체 문서에서 지정된 유형의 필드를 정적 텍스트로 변환하거나, 섹션의 [Body](https://reference.aspose.com/words/net/aspose.words/body/) 객체를 전달하고 해당 본문에 있는 필드만 변환할 수 있습니다.

{{% alert color="primary" %}}

[Paragraph](https://reference.aspose.com/words/net/aspose.words/paragraph/)와 같은 블록 수준 노드를 전달할 때 어떤 경우에는 필드가 여러 단락에 걸쳐 있을 수 있다는 점에 유의하세요. 이런 일이 발생하면 이를 방지하기 위해 대신 합성의 부모를 전달하는 것이 좋습니다.

{{% /alert %}}

**ConvertFieldsToStaticText** 메서드에 전달된 [FieldType](https://reference.aspose.com/words/net/aspose.words.fields/fieldtype/) 열거형은 정적 텍스트로 변환해야 하는 필드 유형을 지정합니다. 문서에 있는 다른 필드 유형은 변경되지 않습니다.
...
[Aspose.Words GitHub](https://github.com/aspose-words/Aspose.Words-for-.NET/blob/master/Examples/Data/Linked%20fields.docx)에서 이 예제의 샘플 파일을 다운로드할 수 있습니다.
