---
title: Python에서 Office 추가 기능 사용
...
때로는 코드를 실행하여 문서를 수정하는 인터페이스 컨트롤에 대한 액세스 권한을 부여하고 싶을 수도 있습니다. Aspose.Words API는 Office 추가 기능을 나타내기 위해 XML 어휘를 확장하는 요소와 속성을 사용자 정의하기 위한 다양한 클래스를 부여하는 [webextensions](https://reference.aspose.com/words/python-net/aspose.words.webextensions/) 모듈을 제공합니다.
...
Aspose.Words는 [WebExtension](https://reference.aspose.com/words/python-net/aspose.words.webextensions/webextension/) 및 [TaskPane](https://reference.aspose.com/words/python-net/aspose.words.webextensions/taskpane/) 클래스를 사용하여 작업 창 유형의 웹 확장을 추가하는 기능을 제공하고 창 및 확장 속성을 사용자 지정할 수도 있습니다.
...
작업창 추가 기능 목록을 보려면 [web_extension_task_panes](https://reference.aspose.com/words/python-net/aspose.words/document/web_extension_task_panes/) 속성을 사용하세요.
