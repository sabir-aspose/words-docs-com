...
linktitle: 지원되는 기능
description: "Aspose.Words for Python via .NET는 단순한 문서 변환 및 수정에서부터 체계적이고 시각적으로 매력적인 문서 생성 또는 보고 자동화에 이르기까지 광범위한 기능을 사용자에게 제공합니다."
type: docs
weight: 30
...
|  :-  |  :-  |  :-  |
| `Microsoft Word - DOC` | 가장 빠르고 완벽한 DOC 형식 구현을 찾을 수 있습니다. | {{< emoticons/tick >}} |
| `WordprocessingML - DOCX and XML` | Aspose.Words는 OOXML, Flat OPC 및 Word 2003 XML을 완벽하게 지원합니다. | {{< emoticons/tick >}} |
| `Rich Text Format - RTF` | 다양한 애플리케이션과 상호 작용할 수 있도록 RTF 형식을 포괄적으로 지원합니다. | {{< emoticons/tick >}} |
| `HTML, XHTML and MHTML` | 상호 운용성을 더욱 높이기 위해 HTML/XHTML을 로드하고 저장합니다. MHTML로 저장도 가능합니다. | {{< emoticons/tick >}} |
| `OpenDocument - ODT` | Aspose.Words는 `OpenDocument` 텍스트(.odt) 형식으로 문서를 로드하고 저장할 수 있습니다. | {{< emoticons/tick >}} |
| `Adobe Portable Document Format - PDF` | 어떤 문서든 높은 충실도로 PDF로 변환하세요. PDF/A가 지원됩니다. | {{< emoticons/tick >}} |
| `XML Paper Specification - XPS` | 어떤 문서든 높은 충실도로 XPS로 변환하세요. | {{< emoticons/tick >}} |
| `Plain Text - TXT` | 일반 텍스트 형식으로 저장하여 쉽게 텍스트를 추출할 수 있습니다. | {{< emoticons/tick >}} |
| `Digital Publishing EPUB` | EPUB는 eBook에 널리 사용되는 형식입니다. Aspose.Words의 모든 문서를 IDPF EPUB 형식으로 변환할 수 있습니다. | {{< emoticons/tick >}} |
...
| 문서에서 OLE 개체와 ActiveX 컨트롤을 유지하거나 추출합니다. | {{< emoticons/tick >}} |
