...
type: docs
description: "Pas verschillende opties voor opschonen en verwijderen toe, zoals het verwijderen van samenvoegvelden voordat u een Mail Merge - bewerking uitvoert of het verwijderen van ongebruikte gebieden tijdens een Mail Merge - bewerking met Java."
keywords: "cleanup options Mail Merge c#"
weight: 10
ai_search_scope: words_java
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
ai_search_fast_endpoint: "https://docsearch.api.aspose.cloud/search"
url: /nl/java/clean-up-before-or-during-mail-merge/
...
Gebruik de Eigenschap **CleanupOptions** samen met de [MailMergeCleanupOptions](https://reference.aspose.com/words/java/com.aspose.words/mailmergecleanupoptions/) opsomming om de optie Verwijderen in te stellen. Geef op welke items u wilt verwijderen door de volgende opties te kiezen (u kunt er meer dan één combineren):
...
U kunt het voorbeeldbestand van dit voorbeeld downloaden van [Aspose.Words GitHub](https://github.com/aspose-words/Aspose.Words-for-Java/blob/master/Examples/Data/Table%20with%20fields.docx).

{{% /alert %}}

### Ongebruikte Gebieden Verwijderen

In eerdere versies van Aspose.Words werden lege Mail Merge - regio ' s automatisch uit het document verwijderd tijdens de Mail Merge - bewerking. Bij de laatste versie van Aspose.words blijven er standaard lege Mail Merge - regio ' s over na de Mail Merge - bewerking. U kunt echter de optie **RemoveUnusedRegions** gebruiken om de ongebruikte Mail Merge regio ' s te verwijderen tijdens de Mail Merge bewerking. U kunt bijvoorbeeld een document samenvoegen met een lege gegevensbron die geen gegevenstabellen bevat die leiden tot ongebruikte gebieden in het document.
...
U kunt het voorbeeldbestand van dit voorbeeld downloaden van [Aspose.Words GitHub](https://github.com/aspose-words/Aspose.Words-for-Java/blob/master/Examples/Data/Mail%20merge%20destination%20-%20Northwind%20suppliers.docx).
