---
title: Geavanceerde Mail Merge functies in Java
second_title: Aspose.Words voor Java
articleTitle: Geavanceerde Mail Merge Functies
linktitle: Geavanceerde Mail Merge Functies
type: docs
description: "Aspose.Words voor Java biedt een aantal geavanceerde Mail Merge - functies waarmee u verdere Mail Merge - aanpassingen kunt uitvoeren. Bijvoorbeeld informatie verkrijgen over sjabloonstructuur, regels instellen, opschonen na een Mail Merge - bewerking en andere."
keywords: "use advanced Mail Merge features java, Mail Merge java"
weight: 50
ai_search_scope: words_java
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
url: /nl/java/advanced-mail-merge-features/
...
U kunt het veld [Next](https://reference.aspose.com/words/java/com.aspose.words/fieldnext/) implementeren om de volgende gegevensrecord samen te voegen in het huidige resulterende samengevoegde document, in plaats van een nieuw samengevoegde document te starten. Het wordt gebruikt om meerdere records in één document weer te geven.

### Implementeer NextIf en SkipIf velden om twee uitdrukkingen te vergelijken

U kunt het veld [NextIf](https://reference.aspose.com/words/java/com.aspose.words/fieldnextif/) of het veld [SkipIf](https://reference.aspose.com/words/java/com.aspose.words/fieldskipif/) gebruiken als u twee uitdrukkingen ([right](https://reference.aspose.com/words/java/com.aspose.words/fieldif/#getRightExpression) en [left](https://reference.aspose.com/words/java/com.aspose.words/fieldif/#getLeftExpression) uitdrukkingen) met een bepaalde [operator](https://reference.aspose.com/words/java/com.aspose.words/fieldskipif/#getComparisonOperator) wilt vergelijken.
...
Met Aspose.Words kunt u automatisch namen van velden in uw gegevensbron en namen van Mail Merge velden in de sjabloon toewijzen met behulp van de eigenschap [MappedDataFields](https://reference.aspose.com/words/java/com.aspose.words/mailmerge/#getMappedDataFields). Als u bijvoorbeeld een veldnaam met de naam "achternaam" in uw sjabloon hebt en in uw gegevensbron de veldnaam "achternaam" of een andere variant zoals "Last_Name" of "LastName", wordt het veld in de gegevensbron automatisch toegewezen aan het overeenkomstige toegewezen veld. Als een samenvoegsjabloon met veel gegevensbronnen moet worden samengevoegd, is het niet nodig om de velden opnieuw in de sjabloon in te voeren om overeen te komen met de veldnamen in de database.

Het volgende codevoorbeeld toont hoe u een toegewezen veld kunt toevoegen met de methode [Add](https://reference.aspose.com/words/java/com.aspose.words/mappeddatafieldcollection/#add-java.lang.String-java.lang.String) wanneer een samenvoegveld in een sjabloon en een gegevensveld in een gegevensbron verschillende namen hebben:
