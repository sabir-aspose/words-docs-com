...
description: "Omzetten naar PDF/A-1, PDF/A-2, PDF/A-4 en PDF/UA met behulp van C#. Er zijn een paar problemen bij het omzetten naar PDF / A documenten, en Aspose.Words voor .NET Lost ze op."
type: docs
weight: 28
url: /nl/net/working-with-pdfa-or-pdfua/
...
Volg het codevoorbeeld om te updaten `TOC` velden Aspose.Words Document Object Model (DOM):
...
{{% alert color="secondary" %}}
<details>
    <summary>In dit blok kun je voorbeelden zien: hoe de tabelkop in te stellen (uitbreiden om details te zien).</summary>
    <p></p>
...
{{% alert color="secondary" %}}
<details>
    <summary>In dit blok zie je voorbeelden: hoe de documenttitel in te stellen (uitbreiden om details te zien).</summary>
    <p></p>
