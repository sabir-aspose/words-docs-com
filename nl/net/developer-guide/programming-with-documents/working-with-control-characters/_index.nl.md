...
description: "Inleiding tot het werken met controle karakters in Aspose.Words voor .NET."
type: docs
weight: 400
ai_search_scope: words_net
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
ai_search_fast_endpoint: "https://docsearch.api.aspose.cloud/search"
url: /nl/net/working-with-control-characters/
...
De [ControlChar](https://reference.aspose.com/words/net/aspose.words/controlchar/) klasse is een repository voor de constanten die controletekens vertegenwoordigen die vaak voorkomen in documenten. Het biedt zowel char en string versies van dezelfde constanten. Bijvoorbeeld, tekenreeks [LineBreak](https://reference.aspose.com/words/net/aspose.words/controlchar/linebreak/) en char [LineBreakChar](https://reference.aspose.com/words/net/aspose.words/controlchar/linebreakchar) heeft dezelfde waarde.

Het volgende voorbeeld van code laat zien hoe je tekens moet gebruiken:
