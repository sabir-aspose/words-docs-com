...
articleTitle: Systeemvereisten
linktitle: Systeemvereisten
description: "Voordat u begint te werken met Aspose.Words voor C++, moet u ervoor zorgen dat u voldoet aan de vereisten voor het besturingssysteem, het platform, de frameworks en de omgeving, zodat de activiteiten op uw apparaten correct worden verantwoord."
type: docs
weight: 70
ai_search_scope: words_cpp
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
ai_search_fast_endpoint: "https://docsearch.api.aspose.cloud/search"
url: /nl/cpp/system-requirements/
...
<table>
  ...
  <tr>
			<td><ul><li>Clang 3.9.1 of hoger</li></ul></td>
			</tr>
</table>
...
1. Fontconfig installeren op Ubuntu of Debian</br>
`sudo apt install libfontconfig fontconfig`
2. Fontconfig installeren op Fedora of CentOs</br>
...
<table>
  ...
  <tr>
			<td><ul><li>Xcode 12.5.1 of hoger</li><li>Clang en libc++ (die standaard worden geleverd met Xcode)</li></ul></td>
			</tr>
</table>
...
Fontconfig installeren op macOS met [homebrew](https://brew.sh)</br>
