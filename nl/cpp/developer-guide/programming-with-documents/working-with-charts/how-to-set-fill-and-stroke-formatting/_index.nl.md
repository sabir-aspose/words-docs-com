...
url: /nl/cpp/how-to-set-fill-and-stroke-formatting/
timestamp: 2024-01-27-14-07-04
---

Vul-en lijnopmaak kan worden ingesteld voor grafiekreeksen, gegevenspunten en markeringen. Hiervoor moet u de eigenschappen van het **ChartFormat** - type in de klassen **ChartSeries**, **ChartDataPoint** en **ChartMarker** gebruiken, evenals aliassen voor sommige eigenschappen, zoals ForeColor, BackColor, zichtbaar en transparantie in de klasse `Stroke`.

Het volgende codevoorbeeld laat zien hoe de kleur van de serie moet worden ingesteld:
...
Het volgende codevoorbeeld laat zien hoe u lijnkleur en gewicht instelt:
