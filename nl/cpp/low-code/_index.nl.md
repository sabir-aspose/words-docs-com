...
Aspose.Words voor C++ ondersteunt zowel vloeiend als niet-vloeiend APIs, waardoor ontwikkelaars de stijl kunnen kiezen die het beste past bij hun coderingsvoorkeuren en projectbehoeften. Laten we eens kijken naar enkele voorbeelden om te zien hoe deze twee soorten API verschillen.
...
Om meer geavanceerde opties te verkennen, kunt u LowCode APIs altijd combineren met het volledige Aspose.Words objectmodel. Zie meer Low Code voorbeelden in de [API documentation](https://reference.aspose.com/words/cpp/aspose.words.lowcode/).