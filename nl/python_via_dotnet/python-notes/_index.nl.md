---
title: Python en .NET Versieverschillen
second_title: Aspose.Words voor Python via .NET
articleTitle: Python en .NET Versieverschillen
linktitle: Python en .NET Versieverschillen
description: "Aspose.Words voor Python via .NET is een verpakking van Aspose.Words voor .NET, deze pagina beschrijft de verschillen in functies en API van deze twee producten."
type: docs
weight: 15
ai_search_scope: words_python
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
ai_search_fast_endpoint: "https://docsearch.api.aspose.cloud/search"
url: /nl/python-net/python-notes/
...
* [DocumentVisitor](https://reference.aspose.com/words/python-net/aspose.words/documentvisitor/) uitvoering is momenteel niet mogelijk van de Python code.
...
Basisklasse voor alle documentnodes in Aspose.Words DOM is [Node](https://reference.aspose.com/words/python-net/aspose.words/node/) Klasse. Bijvoorbeeld [get_child](https://reference.aspose.com/words/python-net/aspose.words/compositenode/get_child/) methode geeft terug en instantie van [Node](https://reference.aspose.com/words/python-net/aspose.words/node/) klasse, maar als je de terugkeerknoop moet wijzigen, moet je het in de meeste gevallen op beton gieten. De volgende code laat zien hoe je de lettertypekleur van de eerste moet veranderen [Run](https://reference.aspose.com/words/python-net/aspose.words/run/) in het document:
...
Casting kan ook nodig zijn wanneer [clone](https://reference.aspose.com/words/python-net/aspose.words/document/clone/) de methode wordt gebruikt:
...
Zoals je zou kunnen merken waar in C# code die u zou gebruiken `(Paragraph)node` voor gietgieten, in Python u moet gebruiken `node.as_paragraph()` methode. In de Python versie van Aspose.Words [Node](https://reference.aspose.com/words/python-net/aspose.words/node/) klasse introduceert de volgende koppeling van `as_xxx` methoden:
...
Zoals je zou kunnen merken [Field](https://reference.aspose.com/words/python-net/aspose.words.fields/field/) object biedt ook set van `as_xxx` methoden, die hieronder zijn opgesomd:
...
[FontSourceBase](https://reference.aspose.com/words/python-net/aspose.words.fonts/fontsourcebase/) klasse biedt set van `as_xxx` methoden, die hieronder zijn opgesomd:
...
## API Ledennaam
Om dichter bij Python wereld, API leden van Aspose.Words voor Python via .NET gebruikt python slang stijl, maar in de meeste gevallen hebben ze één tot één analoge in Aspose.Words voor .NET API. U kunt deze analoge vinden in de [xml-bestand](/words/python-net/python-notes/wrapper.zip).
